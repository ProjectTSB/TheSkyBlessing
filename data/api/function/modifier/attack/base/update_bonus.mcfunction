...
# 差分にする
    scoreboard players operation $Diff Temporary = $BonusAttack Global
...
# 適用
    ...
    execute store result storage api: Argument.Amount double 0.01 run scoreboard players get $BonusAttack Global
