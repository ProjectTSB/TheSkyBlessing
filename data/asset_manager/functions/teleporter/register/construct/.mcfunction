...
# 状態を item_display に反映させる
    execute as @e[type=item_display,tag=Teleporter,distance=..0.01,limit=1] run function asset_manager:teleporter/common/update_display_state with storage asset:teleporter {}
