...
# スペクテイターだろうがダメージを食らうようにする
    execute if entity @s[gamemode=!creative,tag=!DevPrivilege] positioned ~0.3 ~0.0 ~0.3 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing positioned ~-.6 ~0.0 ~0.6 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing positioned ~0.3 ~0.9 ~0.3 positioned ~0.3 ~0.0 ~0.3 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing positioned ~-.6 ~0.0 ~0.6 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing positioned ~0.3 ~0.9 ~0.3 positioned ~0.3 ~0.0 ~0.3 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing positioned ~-.6 ~0.0 ~0.6 unless predicate lib:in_lava/include_flowing positioned ~0.0 ~0.0 ~-.6 unless predicate lib:in_lava/include_flowing run tag @s add NotInLava
