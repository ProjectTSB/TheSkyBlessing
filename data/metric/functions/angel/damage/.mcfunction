...
execute store result storage metric: Args.MobID int 1 run scoreboard players get @e[type=#lib:living,type=!player,tag=Enemy.Boss,distance=..100,limit=1] MobID
