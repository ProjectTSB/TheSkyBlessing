...
# 最新のものかチェックし、最新じゃなければ取得
    ...
    execute if score $NotLatestData Temporary matches 1 run tp 0-0-0-0-0 @s
    execute if score $NotLatestData Temporary matches 1 run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].DataCache.Rotation.Data set from entity 0-0-0-0-0 Rotation
# outputのstorageに移す
