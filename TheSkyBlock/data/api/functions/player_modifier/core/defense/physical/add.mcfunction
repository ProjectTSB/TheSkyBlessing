#> api:player_modifier/core/defense/physical/add
#
#
#
# @within function api:player_modifier/defense/physical/add
...
# 追加する
    ...
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Defense.Physical[-1].Amount set from storage api: Argument.Amount
