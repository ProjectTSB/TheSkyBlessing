#> api:player_modifier/core/defense/physical/remove
#
#
#
# @within function api:player_modifier/defense/physical/remove
...
# 新しい配列を戻す
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Defense.Physical set from storage api: NewModifiers
# リセット
