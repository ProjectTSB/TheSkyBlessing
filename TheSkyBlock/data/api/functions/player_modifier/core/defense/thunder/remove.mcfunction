#> api:player_modifier/core/defense/thunder/remove
#
#
#
# @within function api:player_modifier/defense/thunder/remove
...
# 新しい配列を戻す
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Defense.Thunder set from storage api: NewModifiers
# リセット
