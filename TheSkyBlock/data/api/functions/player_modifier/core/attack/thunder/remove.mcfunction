#> api:player_modifier/core/attack/thunder/remove
#
#
#
# @within function api:player_modifier/attack/thunder/remove
...
# 新しい配列を戻す
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Attack.Thunder set from storage api: NewModifiers
# リセット
