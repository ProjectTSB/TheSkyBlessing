#> api:player_modifier/core/attack/physical/remove
#
#
#
# @within function api:player_modifier/attack/physical/remove
...
# 新しい配列を戻す
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Attack.Physical set from storage api: NewModifiers
# リセット
