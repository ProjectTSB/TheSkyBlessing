...
scoreboard players operation $Return.Number Arguments += $Return.Number Arguments
execute if score $bit Temporary matches 1 run scoreboard players add $Return.Number Arguments 1
