...
# 25m落下チェック
    ...
    execute unless entity @s[tag=SlowFalling] if score @s Elytra matches 1.. run scoreboard players reset $FallDistance Temporary
...
# リセット
    ...
    execute if score @s Elytra matches 1.. run scoreboard players reset @s Elytra