...
# 処理
    execute as @a[scores={GodMessagePhase=40}] run function player_manager:god/change_believe/unbelieve
    execute as @a[scores={GodMessagePhase=140}] run function player_manager:god/change_believe/believe
    scoreboard players reset @a[scores={GodMessagePhase=140}] GodMessagePhase
