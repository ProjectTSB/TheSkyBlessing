...
# 途中退出時
    execute as @a[scores={GodMessagePhase=0..}] if score @s InArea matches 1 unless score @s InSubArea matches 10..14 run scoreboard players reset @s GodMessagePhase
