#> player_manager:keep_lost_item/give_part/falling_item
#
...
# 残ってたら繰り返す
    execute if data storage lib: Array[0] run function player_manager:keep_lost_item/give_part/falling_item