...
# 名前を取得し、TextComponentに加工して適用
    data modify storage player_manager:keep_lost_item Name set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Name
    ...
    execute in overworld run data modify storage player_manager:keep_lost_item Chests[-1].tag.display.Name set from block 10000 0 10000 Items[0].tag.display.Name
    data remove storage player_manager:keep_lost_item Name