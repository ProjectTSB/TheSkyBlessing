...
# 挿入用チェストがまだ残っていたらループ
    execute if entity @e[tag=LostItemChest,distance=..1,x=2927,y=184,z=-1273,limit=1] run schedule function player_manager:keep_lost_item/give_all/minecart_to_chest_check 1t