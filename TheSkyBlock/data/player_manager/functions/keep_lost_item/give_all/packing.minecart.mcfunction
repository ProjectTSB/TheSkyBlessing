...
# ループ処理
    ...
    execute if score $i Temporary < $27 Const if data storage player_manager:keep_lost_item Chests[-1] run function player_manager:keep_lost_item/give_all/packing.minecart