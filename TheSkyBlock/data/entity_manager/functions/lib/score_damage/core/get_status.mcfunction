#> entity_manager:lib/score_damage/core/get_status
#
# 計算に必要なMobの情報を取得する
#
...
# EPFが未設定または-1以下の時Protectionを参照
    execute unless score $EPF Temporary matches 0.. run function entity_manager:lib/score_damage/core/get_default_epf
# 耐性エフェクト
