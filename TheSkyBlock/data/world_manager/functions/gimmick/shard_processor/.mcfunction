...
# データが存在しない( = ShardProcessorが消失している)ときの処理
    execute unless data storage world_manager:gimmick FrameData run summon glow_item_frame -34.0 21.5 -13.5 {Tags:["ShardProcessor","Object","Uninterferable"],Facing:5b,Invulnerable:1b,Invisible:1b}
# 額縁が存在するときの処理
