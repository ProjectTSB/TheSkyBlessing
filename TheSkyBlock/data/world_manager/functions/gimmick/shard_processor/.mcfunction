...
# データが存在しない( = ShardProcessorが消失している)ときの処理
    execute unless data storage world_manager:gimmick FrameData run kill @e[type=item,nbt={Item:{id:"minecraft:glow_item_frame"}},distance=..1,x=-34.0,y=21.5,z=-13.5]
