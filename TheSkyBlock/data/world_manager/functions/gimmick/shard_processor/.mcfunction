...
# データが存在しない( = ShardProcessorが消失している)ときの処理
    ...
    execute unless data storage world_manager:gimmick FrameData run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invisible:1b,Tags:["ShardProcessorModel","Object","Uninterferable"],DisabledSlots:4144959,Rotation:[-90f,0f],ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:20113}}]}
# 額縁が存在するときの処理
