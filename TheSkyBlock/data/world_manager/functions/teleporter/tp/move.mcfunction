#> world_manager:teleporter/tp/move
#
#
#
# @within function world_manager:teleporter/tp/

# TP先へ移動
    data modify entity @s Pos set from storage world_manager:teleporter TargetPos
...
# プレイヤーを飛ばす
    ...
    execute positioned as @s run function world_manager:teleporter/vfx/teleport/to
# 汎用entityを戻す
    tp @s 0.0 0.0 0.0