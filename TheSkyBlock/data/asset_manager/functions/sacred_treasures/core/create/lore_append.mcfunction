#> asset_manager:sacred_treasures/core/create/lore_append
#
# Loreを追加する
#
# @input
...
execute if data storage asset:sacred_treasure Lore[0] run function asset_manager:sacred_treasures/core/create/lore_append