#> asset_manager:sacred_treasure/core/create/set_god
#
# 使用できる神を設定します
#
...
# 生成
    loot replace block 10000 0 10000 container.8 loot asset_manager:sacred_treasure/core/generate_lore/god
# リセット
