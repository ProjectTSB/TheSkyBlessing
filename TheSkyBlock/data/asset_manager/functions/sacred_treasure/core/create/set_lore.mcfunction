...
# 2? 攻撃情報
    execute if data storage asset:sacred_treasure AttackInfo run function asset_manager:sacred_treasure/core/create/set_attack_info
# 3? 必要MP
    execute if data storage asset:sacred_treasure MPRequire run loot replace block 10000 0 10000 container.3 loot asset_manager:sacred_treasure/core/generate_lore/mp_require
# 4 消費MP
    loot replace block 10000 0 10000 container.4 loot asset_manager:sacred_treasure/core/generate_lore/mp_cost
# 5? 消費アイテム
    execute if data storage asset:sacred_treasure CostText run loot replace block 10000 0 10000 container.5 loot asset_manager:sacred_treasure/core/generate_lore/cost_item
# 6? クールタイム
