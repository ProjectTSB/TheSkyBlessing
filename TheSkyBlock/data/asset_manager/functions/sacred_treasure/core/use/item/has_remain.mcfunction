...
# アイテム更新処理
    ...
    execute if score $Remain Temporary matches 1.. run function asset_manager:sacred_treasure/core/use/item/update
# 破壊処理
    execute if score $Remain Temporary matches ..0 run function asset_manager:sacred_treasure/core/use/item/break
# リセット
