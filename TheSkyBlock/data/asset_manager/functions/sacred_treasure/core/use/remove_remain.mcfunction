...
# Name更新処理
    ...
    execute if score $Remain Temporary matches 1.. run loot replace block 10000 0 10000 container.0 loot asset_manager:sacred_treasure/core/get_name/has_remain
