...
# autoの場合のエラーメッセージ
    execute unless data storage asset:sacred_treasure Items.auto run tellraw @a [{"storage":"global:debug","nbt":"Prefix.ERROR"},{"text":"autoはこのトリガーでは実行できません","color":"white"}]
