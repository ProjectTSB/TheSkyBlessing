...
#
# 各slotについて前のアイテムデータと一致していない場合、その値のスコアボードを0に設定します
#
...
# mainhand
    ...
    execute unless score @s UUID.Mainhand = $Temp Temporary run scoreboard players set @s Sneak.Mainhand 0
...
# offhand
    ...
    execute unless score $Temp Temporary matches -2147483648..2147483647 run scoreboard players set $Temp Temporary -1
    execute unless score @s UUID.Offhand = $Temp Temporary run scoreboard players set @s Sneak.Offhand 0
...
# head
    ...
    execute unless score $Temp Temporary matches -2147483648..2147483647 run scoreboard players set $Temp Temporary -1
    execute unless score @s UUID.Head = $Temp Temporary run scoreboard players set @s Sneak.Head 0
...
# chest
    ...
    execute unless score $Temp Temporary matches -2147483648..2147483647 run scoreboard players set $Temp Temporary -1
    execute unless score @s UUID.Chest = $Temp Temporary run scoreboard players set @s Sneak.Chest 0
...
# legs
    ...
    execute unless score $Temp Temporary matches -2147483648..2147483647 run scoreboard players set $Temp Temporary -1
    execute unless score @s UUID.Legs = $Temp Temporary run scoreboard players set @s Sneak.Legs 0
...
# feet
    ...
    execute unless score $Temp Temporary matches -2147483648..2147483647 run scoreboard players set $Temp Temporary -1
    execute unless score @s UUID.Feet = $Temp Temporary run scoreboard players set @s Sneak.Feet 0
