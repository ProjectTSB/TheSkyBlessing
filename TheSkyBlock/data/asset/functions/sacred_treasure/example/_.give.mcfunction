...
data modify storage asset:sacred_treasure Name set value '{"text":"ジェットブーツ","color":"green"}'
...
data modify storage asset:sacred_treasure RemainingCount set value 600
data modify storage asset:sacred_treasure Slot set value "feet"
data modify storage asset:sacred_treasure Trigger set value "keepSneak1s"
