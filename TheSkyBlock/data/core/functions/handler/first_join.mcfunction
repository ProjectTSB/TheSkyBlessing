...
# 補正値初期化
    ...
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers set value {Heal:1d,Attack:{Base:1d,Physical:1d,Magic:1d,None:1d,dire:1d,Water:1d,Thunder:1d},Dedense:{Base:1d,Physical:1d,Magic:1d,None:1d,dire:1d,Water:1d,Thunder:1d},MPRegenAmount:1d}
