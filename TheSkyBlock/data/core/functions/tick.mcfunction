...
# Mobデータ初期化部
    execute as @e[type=#lib:living,type=!player,tag=!AlreadyInitMob] run function mob_manager:find_attacking_entity/set_flag
...
# リセット
    execute if entity @a[scores={AttackedEntity=0..}] run function mob_manager:find_attacking_entity/reset
