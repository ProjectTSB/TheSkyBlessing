...
# 体力
    execute if entity @s[type=!player] run function api:mob/apply_to_forward_target/with_non-idempotent.m {CB:"api:damage/core/get_status/get_health",Key:"api:damage/core/get_status/",IsForwardedOnly:false}
# ダメージを取得
