...
# ダメージの補正
    ...
    execute if data storage api: Argument{BypassModifier:false} if score $Metric Temporary matches ..99 run function metric:damage.m {Condition:"Resist"}
    execute if data storage api: Argument{BypassModifier:false} if score $Metric Temporary matches 100 run function metric:damage.m {Condition:"Normal"}
    execute if data storage api: Argument{BypassModifier:false} if score $Metric Temporary matches 101.. run function metric:damage.m {Condition:"Weak"}
    ...
    execute if data storage api: Argument{BypassModifier: true} run function metric:damage.m {Condition:"Bypass"}
