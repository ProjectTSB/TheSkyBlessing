...
# セッション開く
    function api:array/session/open
...
# CompareResult = Array.map(v => v.id === CompareTarget)
    ...
    function api:array/compare_single
# 該当エンチャントのデータを取得する
