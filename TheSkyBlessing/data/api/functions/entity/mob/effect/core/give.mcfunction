...
# デフォルト値
    ...
    execute unless data storage asset:effect DisplayStack run data modify storage asset:effect DisplayStack set value true
...
# リセット
    ...
    data remove storage asset:effect DisplayStack
