...
execute if data storage api: Argument.Listener store result storage api: Args.TriggerIndex int 1 run function player_manager:trigger/register/m with storage api: Argument

data modify storage api: Args.Label set from storage api: Argument.Label
execute if data storage api: Argument.Listener run function api:button/core/create_text_component.m with storage api: Args
execute unless data storage api: Argument.Listener run function api:button/core/create_disable_text_component.m with storage api: Args
