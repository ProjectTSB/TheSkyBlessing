...
# ヒールされた側にイベントを追加する
    ...
    execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ArtifactEvents.ReceiveHeal[-1].Amount.Base double 0.01 run data get storage api: Argument.Fluctuation 100
