...
# Global変数に代入
    ...
    execute unless score $Difficulty Temporary matches 0 if score $Difficulty Temporary matches ..2 unless score $Difficulty Global = $Difficulty Temporary run scoreboard players operation $Difficulty Global = $Difficulty Temporary
# ゲーム難易度の変更
