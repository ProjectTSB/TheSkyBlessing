...
# shrink
    execute if data storage world_manager:nexus_loader {NeedsShrink6:true} run function world_manager:nexus_loader/load/tree/shrink.m {Depth:6,ParentDepth:4,Path:"Registry[-3].N[-4].N[-4].N[-4].N[-4].N[-4].N[-4]"}
