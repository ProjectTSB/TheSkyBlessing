...
# fetch
    execute store result storage world_manager:nexus_loader IsLoaded byte 1 run function world_manager:nexus_loader/load/fetch.m {TargetPath:"Registry[-3].N[-4].N[-4].N[-4].N[-4].N[-4].N[-4]"}
# ロードに成功したら消す
