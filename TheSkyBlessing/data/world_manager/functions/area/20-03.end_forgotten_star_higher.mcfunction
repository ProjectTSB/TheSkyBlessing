...
# ダメージ (スペクテイターだろうがダメージを食らうようにする)
    execute if entity @s[gamemode=!creative,tag=!DevPrivilege] unless score @s LavaDamageCooldown matches 1.. positioned ~0.3 ~0.0 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~0.3 ~0.0 ~-.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~0.0 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~0.0 ~-.3 unless predicate lib:is_in_lava/include_flowing positioned ~0.3 ~0.9 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~0.3 ~0.9 ~-.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~0.9 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~0.9 ~-.3 unless predicate lib:is_in_lava/include_flowing positioned ~0.3 ~1.8 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~0.3 ~1.8 ~-.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~1.8 ~0.3 unless predicate lib:is_in_lava/include_flowing positioned ~-.3 ~1.8 ~-.3 unless predicate lib:is_in_lava/include_flowing run function api:damage/
