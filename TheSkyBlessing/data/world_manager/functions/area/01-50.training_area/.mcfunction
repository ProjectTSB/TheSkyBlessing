...
# 座標チェックを行い、その場にタグ付きの人形がいなければ召喚してタグを与える
    ...
    # 魔法耐性人形
        execute rotated 180 0 positioned 2698 105 -465 if loaded ~ ~ ~ unless entity @e[type=skeleton,scores={MobID=441},distance=..128] run function world_manager:area/01-50.training_area/summon/magical_dummy
