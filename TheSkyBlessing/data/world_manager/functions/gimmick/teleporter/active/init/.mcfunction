...
# 星を召喚する
    execute if data storage world_manager:gimmick Teleporters[1] anchored eyes positioned ^ ^ ^ run function world_manager:gimmick/teleporter/active/init/star/foreach
# テレポート先が無いならメッセージ
