#> world_manager:gimmick/return_to_overworld_portal/main
#
#
#
# @within function world_manager:gimmick/return_to_overworld_portal/tick
...
# 中に入った人を飛ばす
    execute as @a[gamemode=!spectator,tag=!Death,distance=..2] run function world_manager:gimmick/return_to_overworld_portal/return_to_overworld
