...
execute if data storage global {GameVersion:"v1.0.4"} run function core:migration/v1.0.5/
execute if data storage global {GameVersion:"v1.0.5"} run function core:migration/v1.0.6/
