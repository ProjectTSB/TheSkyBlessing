...
# チェック
    execute if data storage player_manager:god Difficulty.LockCount as @a[scores={Believe5=1..}] run function player_manager:god/change_difficulty/confirm/listener/on_click
# 減算
    execute if data storage player_manager:god Difficulty.LockCount run function player_manager:god/change_difficulty/confirm/listener/tick
# リセット&ループ
