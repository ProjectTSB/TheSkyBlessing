...
tellraw @s {"text":"","color":"white","extra":[{"text":"攻略進捗: "},{"storage":"api:","nbt":"Return.Purified"},{"text":"\u0002","font":"space"},{"text":"/","color":"gray"},{"text":"\u0002","font":"space"},{"storage":"api:","nbt":"Return.TotalIslands"},{"text":" ("},{"storage":"player_manager:show_progress","nbt":"Progress"},{"text":"%)"}]}
