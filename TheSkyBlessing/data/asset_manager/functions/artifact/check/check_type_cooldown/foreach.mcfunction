#> asset_manager:artifact/check/check_type_cooldown/foreach
#
#
#
# @within function
...
# @within function
#   asset_manager:artifact/check/check_type_cooldown/foreach
#   asset_manager:artifact/check/check_type_cooldown/check_duration.m
...
# 要素がまだあるなら再帰
    execute if data storage asset:artifact CopiedItem[0] run function asset_manager:artifact/check/check_type_cooldown/foreach
