...
# 条件を満たしてなかったらtag削除
    # 信仰による制限
        execute unless data storage asset:artifact DisabledCheckFlag{Believe:true} run function asset_manager:artifact/check/check_believe
    ...
    # SpecialCooldownによる制限
        execute unless data storage asset:artifact DisabledCheckFlag{SpecialCooldown:true} run function asset_manager:artifact/check/check_special_cooldown
    ...
    # MP必要量による制限
        ...
        tag @s[tag=CheckFailed] remove CheckFailed
    # TypeCooldownによる制限
        execute unless data storage asset:artifact DisabledCheckFlag{TypeCooldown:true} run function asset_manager:artifact/check/check_type_cooldown/
        execute if entity @s[tag=CheckFailed] run tag @s remove CanUsed
        tag @s[tag=CheckFailed] remove CheckFailed
    # SecondaryTypeCooldownによる制限
        execute unless data storage asset:artifact DisabledCheckFlag{SecondaryTypeCooldown:true} run function asset_manager:artifact/check/check_second_type_cooldown/
        execute if entity @s[tag=CheckFailed] run tag @s remove CanUsed
        tag @s[tag=CheckFailed] remove CheckFailed
    # LocalCooldownによる制限
