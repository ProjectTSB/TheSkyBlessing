...
# mainhand の場合はタグを付与する
    execute if data storage asset:artifact {TargetDefaultSlot:"mainhand"} if data storage asset:artifact Event{Type:"vanilla_melee"} run tag @s remove ShouldVanillaAttack
