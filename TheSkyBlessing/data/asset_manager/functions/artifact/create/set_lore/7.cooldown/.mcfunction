...
# 各クールダウンの文章を生成する
    ...
    execute if data storage asset:artifact SecondTypeCooldown{Type:"shortRange"} run function asset_manager:artifact/create/set_lore/7.cooldown/make_duration.m {CooldownPath:"storage asset:artifact SecondTypeCooldown.Duration",IconPath:"storage global Icon.Cooldown.Type.ShortRange"}
    execute if data storage asset:artifact SecondTypeCooldown{Type: "longRange"} run function asset_manager:artifact/create/set_lore/7.cooldown/make_duration.m {CooldownPath:"storage asset:artifact SecondTypeCooldown.Duration",IconPath:"storage global Icon.Cooldown.Type.LongRange"}
    execute if data storage asset:artifact SecondTypeCooldown{Type:    "summon"} run function asset_manager:artifact/create/set_lore/7.cooldown/make_duration.m {CooldownPath:"storage asset:artifact SecondTypeCooldown.Duration",IconPath:"storage global Icon.Cooldown.Type.Summon"}
    execute if data storage asset:artifact SecondTypeCooldown{Type:      "heal"} run function asset_manager:artifact/create/set_lore/7.cooldown/make_duration.m {CooldownPath:"storage asset:artifact SecondTypeCooldown.Duration",IconPath:"storage global Icon.Cooldown.Type.Heal"}
