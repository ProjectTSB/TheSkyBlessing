#> asset_manager:artifact/give/validate/modifier
# @within function
...
# loop
    ...
    execute if data storage asset:artifact CopiedModifiers[0] run function asset_manager:artifact/give/validate/modifier
