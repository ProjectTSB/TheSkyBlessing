#> asset_manager:artifact/triggers/sneak_5s/use
#
#
#
# @within function asset_manager:artifact/triggers/sneak_5s/
...
# 神器を呼び出し
    function asset_manager:artifact/triggers/sneak_5s/sneak_5s.m with storage asset:context
