...
# asset:artifact Temp.PreviousDifferentEquipments[].Equipment.SetEffectID -> asset:artifact Temp.List[]._
    ...
    data modify storage lib: Array append from storage asset:artifact Temp.PreviousDifferentEquipments[].Equipment.SetEffectID
    data modify storage lib: Array append from storage asset:artifact Temp.CurrentDifferentEquipments[].Equipment.SetEffectID
