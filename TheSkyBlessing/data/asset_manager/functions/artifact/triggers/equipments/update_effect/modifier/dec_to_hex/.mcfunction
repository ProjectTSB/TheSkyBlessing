#> asset_manager:artifact/triggers/equipments/update_effect/modifier/dec_to_hex/
...
# 4096の位
    ...
    function asset_manager:artifact/triggers/equipments/update_effect/modifier/dec_to_hex/digit
...
# 結合
    function asset_manager:artifact/triggers/equipments/update_effect/modifier/dec_to_hex/concat.m with storage asset:artifact Hexadecimal
# リセット
