...
# Modifierに値を追加
    execute if data storage asset:artifact Temp.New[-1].Equipment.Modifiers[0] run data modify storage asset:artifact Temp.New[-1].Equipment.Modifiers[].ID set from storage asset:artifact Temp.New[-1].ID
    # execute if data storage asset:artifact Temp.New[-1].Equipment.Modifiers[0] run data modify storage asset:artifact Temp.New[-1].Equipment.Modifiers[].Slot set from storage asset:artifact Temp.New[-1].Slot
    data modify storage asset:artifact Temp.ModifierStack append from storage asset:artifact Temp.New[-1].Equipment.Modifiers[]
# Modifierのスタック処理
