#> asset_manager:artifact/triggers/equipments/update_attribute/remove/process
...
# カスタムModifierで処理
    ...
    function asset_manager:artifact/triggers/equipments/update_attribute/remove/custom.m with storage asset:artifact Modifier
# バニラでModifierで処理
    ...
    execute unless score $CustomModifier Temporary matches 1 run function asset_manager:artifact/triggers/equipments/update_attribute/remove/generic.m with storage asset:artifact Modifier
