...
# ループ
    execute if data storage asset:artifact Temp.PreviousDifferentEquipments[0] run function asset_manager:artifact/triggers/equipments/update_attribute/remove/foreach
