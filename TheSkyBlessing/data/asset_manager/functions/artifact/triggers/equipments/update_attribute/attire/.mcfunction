...
# asset:artifact Temp.Old[].Equipment.SetEffectID -> asset:artifact Temp.List[]._
    data modify storage asset:artifact Temp.List set value []
    data modify storage asset:artifact Temp.Target append from storage asset:artifact Temp.Old[].Equipment.SetEffectID
    data modify storage asset:artifact Temp.Target append from storage asset:artifact Temp.New[].Equipment.SetEffectID
