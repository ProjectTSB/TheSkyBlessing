...
# asset:artifact Temp.Old[].Equip.SetID -> asset:artifact Temp.List[]._
    data modify storage asset:artifact Temp.List set value []
    data modify storage asset:artifact Temp.Target append from storage asset:artifact Temp.Old[].Equip.SetID
    data modify storage asset:artifact Temp.Target append from storage asset:artifact Temp.New[].Equip.SetID
