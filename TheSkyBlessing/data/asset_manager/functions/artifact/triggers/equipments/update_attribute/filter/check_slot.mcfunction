...
# 要素を削除し、残っていたら再帰する
    ...
    execute if data storage asset:artifact Temp.BelieveFilteredItems[0] run function asset_manager:artifact/triggers/equipments/update_attribute/filter/check_slot
