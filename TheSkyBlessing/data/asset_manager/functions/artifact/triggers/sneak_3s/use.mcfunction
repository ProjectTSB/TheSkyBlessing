#> asset_manager:artifact/triggers/sneak_3s/use
#
#
#
# @within function asset_manager:artifact/triggers/sneak_3s/
...
# 神器を呼び出し
    function asset_manager:artifact/triggers/sneak_3s/sneak_3s.m with storage asset:context
