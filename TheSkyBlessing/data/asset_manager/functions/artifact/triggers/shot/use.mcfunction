#> asset_manager:artifact/triggers/shot/use
#
#
#
# @within function asset_manager:artifact/triggers/shot/
...
# 神器を呼び出し
    function asset_manager:artifact/triggers/shot/shot.m with storage asset:context
