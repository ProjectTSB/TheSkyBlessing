#> asset_manager:artifact/triggers/sneak_4s/use
#
#
#
# @within function asset_manager:artifact/triggers/sneak_4s/
...
# 神器を呼び出し
    function asset_manager:artifact/triggers/sneak_4s/sneak_4s.m with storage asset:context
