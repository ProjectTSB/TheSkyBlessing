...
# 装備のModifierを取得
    ...
    execute if score $WrongSlot Temporary matches 0 if data storage asset:artifact NewItems[-1].tag.TSB.Modifiers[0] run function asset_manager:artifact/triggers/equip/modifier/foreach
