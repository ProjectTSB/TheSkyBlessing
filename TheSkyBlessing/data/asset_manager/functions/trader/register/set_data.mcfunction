...
# Default位置
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].DefaultTraderPos set from storage asset:trader Pos
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].DefaultTraderRotation set from storage asset:trader Rotation
# そのまま適用するやつ
