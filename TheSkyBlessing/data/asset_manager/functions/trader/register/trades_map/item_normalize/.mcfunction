...
# 神器
    execute unless data storage asset:trader Item.PresetItem unless data storage asset:trader Item.id run function asset_manager:trader/register/trades_map/item_normalize/from_artifact
# プリセットデータ
