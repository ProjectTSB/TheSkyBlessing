#> asset_manager:mob/triggers/kill/call_super_methods/
#
#
#
# @within function
#   asset_manager:mob/triggers/kill/attempt_call
#   asset:mob/super.kill
...
# すべての継承元のkill呼び出し
    execute if data storage asset:mob CopiedExtends[-1][0] run function asset_manager:mob/triggers/kill/call_super_methods/foreach
