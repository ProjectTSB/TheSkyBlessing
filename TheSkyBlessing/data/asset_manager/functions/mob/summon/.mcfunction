...
# @within function
#   api:mob/core/summon
#   asset_manager:mob/summon/call_super_methods/foreach
...
# super.summon呼び出し
    execute unless data storage asset:mob {Implement:true} run function asset_manager:mob/summon/call_super_methods/
