#> asset_manager:spawner/register/process_spawn_potentials/from_int_list/for_each
#
#
#
...
# 要素がまだあったら再帰する
    ...
    execute if data storage asset:spawner SpawnPotentials[-1] run function asset_manager:spawner/register/process_spawn_potentials/from_int_list/for_each