#> asset_manager:spawner/spawn/nearby_entities/get.m
#
...
# キャッシュに存在しない場合、素直に distance から取得する
    execute unless data storage asset:spawner NearbyEntitiesCache.$(MobID) run function asset_manager:spawner/spawn/nearby_entities/get_from_selector.m with storage asset:spawner Args
