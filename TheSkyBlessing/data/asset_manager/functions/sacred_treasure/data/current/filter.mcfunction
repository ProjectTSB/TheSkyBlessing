...
# 一致してたら追加
    execute if score $nonIDEquals Temporary matches 0 run data modify storage asset:sacred_treasure Item append from storage asset:sacred_treasure HotbarItems[-1]
# リセット
