...
# 取得
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"mainhand"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.mainhand
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"offhand"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.offhand
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"feet"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.feet
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"legs"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.legs
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"chest"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.chest
    execute if data storage asset:sacred_treasure {TargetDefaultSlot:"head"} run data modify storage asset:sacred_treasure Item append from storage asset:context Items.head
