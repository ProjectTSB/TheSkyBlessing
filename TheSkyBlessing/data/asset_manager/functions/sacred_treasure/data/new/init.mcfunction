...
# 非TSBアイテムのNullCheck
    execute unless data storage asset:context New.Items.mainhand.tag.TSB run data modify storage asset:context New.Items.mainhand.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.offhand.tag.TSB run data modify storage asset:context New.Items.offhand.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.feet.tag.TSB run data modify storage asset:context New.Items.feet.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.legs.tag.TSB run data modify storage asset:context New.Items.legs.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.chest.tag.TSB run data modify storage asset:context New.Items.chest.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.head.tag.TSB run data modify storage asset:context New.Items.head.tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[0].tag.TSB run data modify storage asset:context New.Items.hotbar[0].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[1].tag.TSB run data modify storage asset:context New.Items.hotbar[1].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[2].tag.TSB run data modify storage asset:context New.Items.hotbar[2].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[3].tag.TSB run data modify storage asset:context New.Items.hotbar[3].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[4].tag.TSB run data modify storage asset:context New.Items.hotbar[4].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[5].tag.TSB run data modify storage asset:context New.Items.hotbar[5].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[6].tag.TSB run data modify storage asset:context New.Items.hotbar[6].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[7].tag.TSB run data modify storage asset:context New.Items.hotbar[7].tag.TSB.ID set value {ID:-2,UUID:-2}
    execute unless data storage asset:context New.Items.hotbar[8].tag.TSB run data modify storage asset:context New.Items.hotbar[8].tag.TSB.ID set value {ID:-2,UUID:-2}
# id
