...
# トリガー
    ...
    execute if data storage asset:sacred_treasure {Trigger:"usingItem"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem1s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "1秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem2s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "2秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem3s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "3秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem4s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "4秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem5s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "5秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"usingItem10s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "10秒間右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "0秒以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem1s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "1秒間以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem2s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "2秒間以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem3s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "3秒間以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem4s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "4秒間以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem5s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "5秒間以上右クリック"
    execute if data storage asset:sacred_treasure {Trigger:"keepUsingItem10s"} run data modify storage asset:sacred_treasure Temp.Trigger.B set value "10秒間以上右クリック"
