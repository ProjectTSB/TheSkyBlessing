...
# 出力
    ...
    title @s actionbar [{"storage":"asset:sacred_treasure","nbt":"MainBarMessage[]","separator":"","interpret":true},{"storage":"asset:sacred_treasure","nbt":"LCDMessages[]","separator":"","interpret":true}]
# 元に戻す
