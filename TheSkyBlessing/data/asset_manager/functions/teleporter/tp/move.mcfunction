#> asset_manager:teleporter/tp/move
#
#
#
# @within function asset_manager:teleporter/tp/
...
# VFX
    execute positioned as @s run function asset_manager:teleporter/vfx/teleport/to
# 盲目を消す
