#> asset_manager:teleporter/vfx/teleporter/
#
#
#
# @within function asset_manager:teleporter/tick

execute as @a[distance=..5] run function asset_manager:teleporter/vfx/teleporter/nearby_player
