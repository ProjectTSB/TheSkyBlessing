#> asset_manager:teleporter/tick/vfx/teleporter/deactive/
#
#
#
# @within function asset_manager:teleporter/tick/vfx/teleporter/

execute as @a[distance=..5] run function asset_manager:teleporter/tick/vfx/teleporter/deactive/nearby_player
