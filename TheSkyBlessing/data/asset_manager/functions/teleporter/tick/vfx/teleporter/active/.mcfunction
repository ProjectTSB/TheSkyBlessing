#> asset_manager:teleporter/tick/vfx/teleporter/active/
#
#
#
# @within function asset_manager:teleporter/tick/vfx/teleporter/

execute as @a[distance=..5] run function asset_manager:teleporter/tick/vfx/teleporter/active/nearby_player
