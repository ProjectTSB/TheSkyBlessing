...
# 居ない場合の再帰
    execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Temp.TargetPos positioned ^ ^ ^0.05 if entity @s[distance=..1.6] run return run function asset_manager:teleporter/tick/tp/find/recursive
# 探査が終了しているのでリセット
    kill @s
