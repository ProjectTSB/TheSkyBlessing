...
# テレポート先の座標を取得
    ...
    data modify storage asset:teleporter TargetPos set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TPStarData.TPTargetPos
# 値をプレイヤーストレージに代入
    execute as @a[tag=this,distance=..1.7,limit=1] run function oh_my_dat:please
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Temp.TPTargetPos set from storage asset:teleporter TPTargetPos
# リセット
