...
execute as @e[type=marker,tag=Teleporter,tag=TeleporterVisibleDeactivate] at @s if entity @p[distance=..50] positioned ~ ~0.05 ~ run function asset_manager:teleporter/tick/vfx/teleporter/deactive