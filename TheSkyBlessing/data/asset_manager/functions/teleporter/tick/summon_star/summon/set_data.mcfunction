...
# 座標データ
    ...
    data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TPStarData.TargetPos.Dimension set from storage asset:teleporter TargetTeleporter.Dimension
# 有効化されているならタグ付与
...
# 色データ
    ...
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:overworld" } run data modify entity @s item.tag.display.color set value 24576
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:the_nether"} run data modify entity @s item.tag.display.color set value 6291456
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:the_end"   } run data modify entity @s item.tag.display.color set value 6291552
...
# EntityStorage に点滅用に色を保存しておく
    ...
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:overworld" } run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TPStarData.ColorPart set value [0,96,0]
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:the_nether"} run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TPStarData.ColorPart set value [96,0,0]
    execute if data storage asset:teleporter TargetTeleporter.Data{ActivationState:"Activate"} if data storage asset:teleporter {IsOtherDimension: true} if data storage asset:teleporter TargetTeleporter{Dimension:"minecraft:the_end"   } run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TPStarData.ColorPart set value [96,0,96]
