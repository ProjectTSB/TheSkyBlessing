...
# グループIDから対象TP先を取得する
    ...
    execute if data storage asset:teleporter Args.TargetGroupID run function asset_manager:teleporter/tick/star_init/get_teleporters_from_group_id.m with storage asset:teleporter Args
