...
# 色データ
    execute if data storage asset:teleporter TargetTeleporter.Data{Color:"white"} run data modify entity @s item.tag.display.color set value 16777215
    execute if data storage asset:teleporter TargetTeleporter.Data{Color:"aqua"} run data modify entity @s item.tag.display.color set value 53706
# 初期化タグ削除
