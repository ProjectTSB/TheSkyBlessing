...
# 神器
    execute unless data storage asset:container Item.PresetItem unless data storage asset:container Item.id run function asset_manager:container/register/construct/set_items/item_normalize/from_artifact
# プリセットデータ
