...
#
#
# @within function asset_manager:effect/events/re-given/call
...
# super.tick呼び出し
    execute if data storage asset:context id run function asset_manager:effect/events/re-given/call
