...
# XYZ各軸のベクトル成分の位置のブロックを見て、合致しなければ軸方向の向きを反転
    $execute at @s positioned 0.0 0.0 0.0 positioned ^ ^ ^-1 positioned ~ 0.0 0.0 positioned ^ ^ ^0.5 facing 0.0 0.0 0.0 positioned as @s positioned ^ ^ ^$(Speed) rotated as @s positioned ^ ^ ^$(Speed) $(Conditions) anchored feet facing ^ ^ ^-1 positioned ^ ^ ^$(Speed) facing entity @s feet positioned as @s run tp @s ~ ~ ~ facing ^ ^ ^$(Speed)
