...
# 死亡メッセージが設定されていたら保存する
    ...
    execute if data storage api: Argument.DeathMessage run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].LatestAttackInfo.DeathMessage set from storage api: Argument.DeathMessage
# リセット
