...
# 死亡メッセージが設定されていたらEntityStorageに保存
    execute if data storage lib: Argument.DeathMessage if entity @s[type=player,tag=!Uninterferable,tag=!Death] run function lib:damage/core/save_death_message
