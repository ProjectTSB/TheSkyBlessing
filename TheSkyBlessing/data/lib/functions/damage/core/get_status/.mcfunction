...
# 体力
    ...
    execute if entity @s[type=player] store result score $Health Temporary run data get storage api: Health 10000
    execute if entity @s[type=!player] store result score $Health Temporary run data get entity @s AbsorptionAmount 10000
# 防御考慮
