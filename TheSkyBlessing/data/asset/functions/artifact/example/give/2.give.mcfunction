...
data modify storage asset:artifact Equip.SetEffectID set value 65535
data modify storage asset:artifact Equip.Modifiers set value [{Type:"max_health",Amount:4d,Operation:"add"}]
