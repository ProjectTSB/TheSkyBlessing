...
# 紐づけ用スコア
    scoreboard players operation @s AttackedEntity = @a[tag=TargetEntity,limit=1] UserID
    scoreboard players operation @a[tag=TargetEntity,limit=1] AttackedEntity = @a[tag=TargetEntity,limit=1] UserID