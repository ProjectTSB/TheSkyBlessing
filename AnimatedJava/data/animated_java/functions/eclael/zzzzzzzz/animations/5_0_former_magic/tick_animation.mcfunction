...
execute if score @s aj.eclael.animation.5_0_former_magic.local_anim_time matches 90.. run function animated_java:eclael/zzzzzzzz/animations/5_0_former_magic/end