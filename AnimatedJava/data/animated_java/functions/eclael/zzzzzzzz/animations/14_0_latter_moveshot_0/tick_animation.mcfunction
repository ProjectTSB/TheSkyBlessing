...
execute if score @s aj.eclael.animation.14_0_latter_moveshot_0.local_anim_time matches 75.. run function animated_java:eclael/zzzzzzzz/animations/14_0_latter_moveshot_0/end