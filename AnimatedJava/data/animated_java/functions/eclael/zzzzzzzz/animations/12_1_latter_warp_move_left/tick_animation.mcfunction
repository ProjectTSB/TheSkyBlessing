...
execute if score @s aj.eclael.animation.12_1_latter_warp_move_left.local_anim_time matches 25.. run function animated_java:eclael/zzzzzzzz/animations/12_1_latter_warp_move_left/end