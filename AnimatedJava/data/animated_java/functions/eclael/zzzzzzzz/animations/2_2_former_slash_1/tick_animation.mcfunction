...
execute if score @s aj.eclael.animation.2_2_former_slash_1.local_anim_time matches 15.. run function animated_java:eclael/zzzzzzzz/animations/2_2_former_slash_1/end