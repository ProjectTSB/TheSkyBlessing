...
scoreboard players set @s aj.eclael.animation.18_2_latter_attack_moveslash_near_hard_0.loop_mode 2
...
tag @s add aj.eclael.animation.18_2_latter_attack_moveslash_near_hard_0