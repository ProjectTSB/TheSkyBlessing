...
execute if score @s aj.eclael.animation.2_1_former_slash_0.local_anim_time matches 20.. run function animated_java:eclael/zzzzzzzz/animations/2_1_former_slash_0/end