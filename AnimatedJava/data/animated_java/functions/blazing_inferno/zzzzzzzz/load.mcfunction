...
scoreboard players set $aj.blazing_inferno.animation.intro aj.id 0
scoreboard players set $aj.blazing_inferno.animation.neurtal aj.id 1
...
scoreboard players set aj.blazing_inferno.export_version aj.i -1375229234
