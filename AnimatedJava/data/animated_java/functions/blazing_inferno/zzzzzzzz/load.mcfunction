...
scoreboard objectives add aj.blazing_inferno.animation.dash_chage.local_anim_time dummy
...
scoreboard objectives add aj.blazing_inferno.animation.dash_chage.loop_mode dummy
...
scoreboard players set $aj.blazing_inferno.animation.dash_chage aj.id 4
...
scoreboard players set aj.blazing_inferno.export_version aj.i 467744443
