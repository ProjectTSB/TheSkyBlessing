...
scoreboard objectives add aj.blazing_inferno.animation.damage.local_anim_time dummy
...
scoreboard objectives add aj.blazing_inferno.animation.damage.loop_mode dummy
...
scoreboard players set $aj.blazing_inferno.animation.dash_end aj.id 7
scoreboard players set $aj.blazing_inferno.animation.damage aj.id 8
scoreboard players set $aj.blazing_inferno.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.blazing_inferno.export_version aj.i -1119171054
