...
scoreboard objectives add aj.blazing_inferno.animation.burst.local_anim_time dummy
...
scoreboard objectives add aj.blazing_inferno.animation.rush_loop.local_anim_time dummy
...
scoreboard objectives add aj.blazing_inferno.animation.burst.loop_mode dummy
...
scoreboard objectives add aj.blazing_inferno.animation.rush_loop.loop_mode dummy
...
scoreboard players set $aj.blazing_inferno.animation.burst aj.id 2
scoreboard players set $aj.blazing_inferno.animation.right1_active aj.id 3
scoreboard players set $aj.blazing_inferno.animation.left1_active aj.id 4
scoreboard players set $aj.blazing_inferno.animation.dash_windup aj.id 5
scoreboard players set $aj.blazing_inferno.animation.dash_charge aj.id 6
scoreboard players set $aj.blazing_inferno.animation.dash_active aj.id 7
scoreboard players set $aj.blazing_inferno.animation.rush_loop aj.id 8
scoreboard players set $aj.blazing_inferno.animation.dash_end aj.id 9
scoreboard players set $aj.blazing_inferno.animation.death_loop aj.id 10
scoreboard players set $aj.blazing_inferno.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.blazing_inferno.export_version aj.i -284516415
