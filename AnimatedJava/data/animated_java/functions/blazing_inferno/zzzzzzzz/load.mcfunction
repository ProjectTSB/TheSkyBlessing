...
scoreboard objectives add aj.blazing_inferno.animation.attack1_windup.local_anim_time dummy
scoreboard objectives add aj.blazing_inferno.animation.attack1_active.local_anim_time dummy
...
scoreboard objectives add aj.blazing_inferno.animation.heavy_windup.local_anim_time dummy
scoreboard objectives add aj.blazing_inferno.animation.neurtal.loop_mode dummy
scoreboard objectives add aj.blazing_inferno.animation.attack1_windup.loop_mode dummy
scoreboard objectives add aj.blazing_inferno.animation.attack1_active.loop_mode dummy
...
scoreboard objectives add aj.blazing_inferno.animation.heavy_windup.loop_mode dummy
scoreboard players set $aj.blazing_inferno.animation.neurtal aj.id 0
scoreboard players set $aj.blazing_inferno.animation.attack1_windup aj.id 1
scoreboard players set $aj.blazing_inferno.animation.attack1_active aj.id 2
scoreboard players set $aj.blazing_inferno.animation.dash_windup aj.id 3
scoreboard players set $aj.blazing_inferno.animation.dash_active aj.id 4
scoreboard players set $aj.blazing_inferno.animation.heavy_windup aj.id 5
scoreboard players set $aj.blazing_inferno.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.blazing_inferno.export_version aj.i -64649662
