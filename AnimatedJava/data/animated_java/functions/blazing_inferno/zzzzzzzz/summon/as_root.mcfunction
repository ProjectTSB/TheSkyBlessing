...
execute if score #animation aj.i = $aj.blazing_inferno.animation.triple_punch aj.id run function animated_java:blazing_inferno/zzzzzzzz/animations/triple_punch/apply_frame_as_root
execute if score #animation aj.i = $aj.blazing_inferno.animation.triple_punch aj.id run scoreboard players operation @s aj.blazing_inferno.animation.triple_punch.local_anim_time = #frame aj.i
