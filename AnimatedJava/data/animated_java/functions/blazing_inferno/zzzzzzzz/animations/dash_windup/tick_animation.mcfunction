...
execute if score @s aj.blazing_inferno.animation.dash_windup.local_anim_time matches 15.. run function animated_java:blazing_inferno/zzzzzzzz/animations/dash_windup/end