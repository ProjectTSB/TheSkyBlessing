...
execute if score @s aj.blazing_inferno.animation.right1_active.local_anim_time matches 10.. run function animated_java:blazing_inferno/zzzzzzzz/animations/right1_active/end