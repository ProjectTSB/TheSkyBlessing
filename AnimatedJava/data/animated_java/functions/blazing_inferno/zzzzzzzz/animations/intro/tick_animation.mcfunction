...
execute if score @s aj.blazing_inferno.animation.intro.local_anim_time matches 40.. run function animated_java:blazing_inferno/zzzzzzzz/animations/intro/end