...
execute if score #variant aj.i = $aj.tultaria.variant.default aj.id run function animated_java:tultaria/zzzzzzzz/apply_variant/default/as_root
...
execute if score #animation aj.i = $aj.tultaria.animation.wing_off aj.id run function animated_java:tultaria/zzzzzzzz/animations/wing_off/apply_frame_as_root
execute if score #animation aj.i = $aj.tultaria.animation.wing_off aj.id run scoreboard players operation @s aj.tultaria.animation.wing_off.local_anim_time = #frame aj.i
