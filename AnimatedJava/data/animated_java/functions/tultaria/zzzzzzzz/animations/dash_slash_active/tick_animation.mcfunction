...
execute if score @s aj.tultaria.animation.dash_slash_active.local_anim_time matches 80.. run function animated_java:tultaria/zzzzzzzz/animations/dash_slash_active/end