...
execute if score @s aj.tultaria.animation.staff_swing_1.local_anim_time matches 45.. run function animated_java:tultaria/zzzzzzzz/animations/staff_swing_1/end