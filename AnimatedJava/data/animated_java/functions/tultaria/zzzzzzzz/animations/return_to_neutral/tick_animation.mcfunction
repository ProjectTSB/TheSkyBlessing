...
execute if score @s aj.tultaria.animation.return_to_neutral.local_anim_time matches 26.. run function animated_java:tultaria/zzzzzzzz/animations/return_to_neutral/end