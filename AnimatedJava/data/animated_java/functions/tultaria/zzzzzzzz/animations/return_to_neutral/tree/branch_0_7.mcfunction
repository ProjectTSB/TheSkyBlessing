...
execute if score @s aj.anim_time matches 5 run function animated_java:tultaria/zzzzzzzz/animations/return_to_neutral/tree/leaf_5
execute if score @s aj.anim_time matches 6 run function animated_java:tultaria/zzzzzzzz/animations/return_to_neutral/tree/leaf_6
execute if score @s aj.anim_time matches 7 run function animated_java:tultaria/zzzzzzzz/animations/return_to_neutral/tree/leaf_7