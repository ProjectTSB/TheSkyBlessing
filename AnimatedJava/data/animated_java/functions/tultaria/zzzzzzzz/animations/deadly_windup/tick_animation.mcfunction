...
execute if score @s aj.tultaria.animation.deadly_windup.local_anim_time matches 45.. run function animated_java:tultaria/zzzzzzzz/animations/deadly_windup/end