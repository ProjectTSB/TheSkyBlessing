...
scoreboard players set $aj.tultaria.animation.dash_stab_active aj.id 5
scoreboard players set $aj.tultaria.animation.dash_stab_end aj.id 6
scoreboard players set $aj.tultaria.animation.return_to_neutral aj.id 7
scoreboard players set $aj.tultaria.animation.deadly_windup aj.id 8
scoreboard players set $aj.tultaria.animation.deadly_loop aj.id 9
scoreboard players set $aj.tultaria.animation.deadly_rod_spin aj.id 10
...
scoreboard players set aj.tultaria.export_version aj.i -909274309
