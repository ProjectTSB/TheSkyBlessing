...
scoreboard objectives add aj.tultaria.animation.new.local_anim_time dummy
...
scoreboard objectives add aj.tultaria.animation.new.loop_mode dummy
...
scoreboard players set $aj.tultaria.animation.return_to_neutral aj.id 3
scoreboard players set $aj.tultaria.animation.new aj.id 4
...
scoreboard players set aj.tultaria.export_version aj.i 1821835794
