...
scoreboard players set $aj.tultaria.animation.dash_slash_windup aj.id 2
scoreboard players set $aj.tultaria.animation.dash_slash_active aj.id 3
scoreboard players set $aj.tultaria.animation.dash_stab_windup aj.id 4
scoreboard players set $aj.tultaria.animation.dash_stab_windup_fast aj.id 5
scoreboard players set $aj.tultaria.animation.dash_stab_active aj.id 6
scoreboard players set $aj.tultaria.animation.dash_stab_end aj.id 7
scoreboard players set $aj.tultaria.animation.return_to_neutral aj.id 8
scoreboard players set $aj.tultaria.animation.deadly_windup aj.id 9
scoreboard players set $aj.tultaria.animation.deadly_loop aj.id 10
scoreboard players set $aj.tultaria.animation.deadly_rod_spin aj.id 11
...
scoreboard players set aj.tultaria.export_version aj.i 937814867
