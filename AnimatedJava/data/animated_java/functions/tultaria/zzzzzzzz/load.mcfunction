...
scoreboard objectives add aj.tultaria.animation.staff_1.local_anim_time dummy
...
scoreboard objectives add aj.tultaria.animation.staff_1.loop_mode dummy
...
scoreboard players set $aj.tultaria.animation.staff_1 aj.id 1
...
scoreboard players set aj.tultaria.export_version aj.i -663420461
