...
scoreboard objectives add aj.haruclaire.animation.00_01_start.local_anim_time dummy
...
scoreboard objectives add aj.haruclaire.animation.13_01_sword_warp_start.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.13_02_sword_warp_slash_normal.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.13_03_sword_warp_slash_upper.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.13_04_sword_warp_slash_finish.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.14_01_sword_laser_shot_0.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.14_02_sword_laser_slash.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.15_03_sword_laser_shot_1.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.15_04_sword_laser_shot_2.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.15_05_sword_laser_slash_finish.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.16_01_sword_charge_charge_0.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.16_02_sword_charge_slash_0.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.16_03_sword_charge_slash_1.local_anim_time dummy
scoreboard objectives add aj.haruclaire.animation.16_04_sword_charge_charge_1.local_anim_time dummy
...
scoreboard objectives add aj.haruclaire.animation.13_01_sword_warp_start.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.13_02_sword_warp_slash_normal.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.13_03_sword_warp_slash_upper.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.13_04_sword_warp_slash_finish.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.14_01_sword_laser_shot_0.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.14_02_sword_laser_slash.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.15_03_sword_laser_shot_1.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.15_04_sword_laser_shot_2.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.15_05_sword_laser_slash_finish.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.16_01_sword_charge_charge_0.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.16_02_sword_charge_slash_0.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.16_03_sword_charge_slash_1.loop_mode dummy
scoreboard objectives add aj.haruclaire.animation.16_04_sword_charge_charge_1.loop_mode dummy
...
scoreboard players set $aj.haruclaire.animation.01_02_rod_idle_rare aj.id 2
scoreboard players set $aj.haruclaire.animation.02_01_rod_attack_move aj.id 3
scoreboard players set $aj.haruclaire.animation.02_02_rod_attack_attack aj.id 4
scoreboard players set $aj.haruclaire.animation.03_01_rod_turara_lockon aj.id 5
scoreboard players set $aj.haruclaire.animation.03_02_rod_turara_attack aj.id 6
scoreboard players set $aj.haruclaire.animation.04_01_rod_laser_pre aj.id 7
scoreboard players set $aj.haruclaire.animation.04_02_rod_laser_shot aj.id 8
scoreboard players set $aj.haruclaire.animation.05_01_rod_set_magic aj.id 9
scoreboard players set $aj.haruclaire.animation.06_01_rod_shot_magic aj.id 10
scoreboard players set $aj.haruclaire.animation.07_01_rod_shot_move_right aj.id 11
scoreboard players set $aj.haruclaire.animation.07_02_rod_shot_move_left aj.id 12
scoreboard players set $aj.haruclaire.animation.08_01_rod_teleport aj.id 13
scoreboard players set $aj.haruclaire.animation.09_01_rod_to_sword aj.id 14
scoreboard players set $aj.haruclaire.animation.10_01_sword_idle aj.id 15
scoreboard players set $aj.haruclaire.animation.10_02_sword_idle_rare aj.id 16
scoreboard players set $aj.haruclaire.animation.11_01_sword_damage_1 aj.id 17
scoreboard players set $aj.haruclaire.animation.11_01_sword_damage_2 aj.id 18
scoreboard players set $aj.haruclaire.animation.11_01_sword_damage_3 aj.id 19
scoreboard players set $aj.haruclaire.animation.12_01_sword_slash_move aj.id 20
scoreboard players set $aj.haruclaire.animation.12_02_sword_slash_move_to_slash aj.id 21
scoreboard players set $aj.haruclaire.animation.12_03_sword_slash_upper aj.id 22
scoreboard players set $aj.haruclaire.animation.12_04_sword_slash_lower aj.id 23
scoreboard players set $aj.haruclaire.animation.12_05_sword_slash_spin aj.id 24
scoreboard players set $aj.haruclaire.animation.13_01_sword_warp_start aj.id 25
scoreboard players set $aj.haruclaire.animation.13_02_sword_warp_slash_normal aj.id 26
scoreboard players set $aj.haruclaire.animation.13_03_sword_warp_slash_upper aj.id 27
scoreboard players set $aj.haruclaire.animation.13_04_sword_warp_slash_finish aj.id 28
scoreboard players set $aj.haruclaire.animation.14_01_sword_laser_shot_0 aj.id 29
scoreboard players set $aj.haruclaire.animation.14_02_sword_laser_slash aj.id 30
scoreboard players set $aj.haruclaire.animation.15_03_sword_laser_shot_1 aj.id 31
scoreboard players set $aj.haruclaire.animation.15_04_sword_laser_shot_2 aj.id 32
scoreboard players set $aj.haruclaire.animation.15_05_sword_laser_slash_finish aj.id 33
scoreboard players set $aj.haruclaire.animation.16_01_sword_charge_charge_0 aj.id 34
scoreboard players set $aj.haruclaire.animation.16_02_sword_charge_slash_0 aj.id 35
scoreboard players set $aj.haruclaire.animation.16_03_sword_charge_slash_1 aj.id 36
scoreboard players set $aj.haruclaire.animation.16_04_sword_charge_charge_1 aj.id 37
scoreboard players set $aj.haruclaire.animation.16_05_sword_charge_counter aj.id 38
scoreboard players set $aj.haruclaire.animation.16_06_sword_charge_counter_short aj.id 39
scoreboard players set $aj.haruclaire.animation.17_01_sword_rain_start aj.id 40
scoreboard players set $aj.haruclaire.animation.17_02_sword_rain_shot_0 aj.id 41
...
scoreboard players set aj.haruclaire.export_version aj.i -542279741
