...
execute if score @s aj.haruclaire.animation.03_02_rod_turara_attack.local_anim_time matches 45.. run function animated_java:haruclaire/zzzzzzzz/animations/03_02_rod_turara_attack/end