...
scoreboard players set @s aj.haruclaire.animation.15_05_sword_laser_slash_finish.loop_mode 2
...
tag @s add aj.haruclaire.animation.15_05_sword_laser_slash_finish