...
execute if score @s aj.haruclaire.animation.15_05_sword_laser_slash_finish.local_anim_time matches 66.. run function animated_java:haruclaire/zzzzzzzz/animations/15_05_sword_laser_slash_finish/end