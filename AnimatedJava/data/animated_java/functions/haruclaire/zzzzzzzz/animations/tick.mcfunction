...
execute if entity @s[tag=aj.haruclaire.animation.11_01_sword_shot_move_right] run function animated_java:haruclaire/zzzzzzzz/animations/11_01_sword_shot_move_right/tick