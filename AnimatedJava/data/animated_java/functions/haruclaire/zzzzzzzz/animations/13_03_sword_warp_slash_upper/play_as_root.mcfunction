...
scoreboard players set @s aj.haruclaire.animation.13_03_sword_warp_slash_upper.loop_mode 2
...
tag @s add aj.haruclaire.animation.13_03_sword_warp_slash_upper