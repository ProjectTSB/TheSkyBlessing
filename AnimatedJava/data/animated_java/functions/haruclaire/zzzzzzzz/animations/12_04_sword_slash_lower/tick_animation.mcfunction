...
execute if score @s aj.haruclaire.animation.12_04_sword_slash_lower.local_anim_time matches 26.. run function animated_java:haruclaire/zzzzzzzz/animations/12_04_sword_slash_lower/end