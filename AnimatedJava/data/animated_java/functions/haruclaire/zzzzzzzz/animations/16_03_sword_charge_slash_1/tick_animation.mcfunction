...
execute if score @s aj.haruclaire.animation.16_03_sword_charge_slash_1.local_anim_time matches 14.. run function animated_java:haruclaire/zzzzzzzz/animations/16_03_sword_charge_slash_1/end