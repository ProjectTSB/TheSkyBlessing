execute if score @s aj.anim_time matches 0..7 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/branch_0_7
execute if score @s aj.anim_time matches 8..15 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/branch_8_15
execute if score @s aj.anim_time matches 16..23 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/branch_16_23
execute if score @s aj.anim_time matches 24..31 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/branch_24_31
