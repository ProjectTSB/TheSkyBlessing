execute if score @s aj.anim_time matches 48 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/leaf_48
execute if score @s aj.anim_time matches 49 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/leaf_49
execute if score @s aj.anim_time matches 50 run function animated_java:haruclaire/zzzzzzzz/animations/07_02_rod_shot_move_left/tree/leaf_50
