#> asset:effect/0016.knockback_resistance_buff/register
#
#
#
# @within function asset:effect/0016.knockback_resistance_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 16
# 名前
    data modify storage asset:effect Name set value '{"text":"ノックバック耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"ノックバック耐性が0.05増加する"}'
