#> asset:effect/0002.attack_physical_buff/register
#
#
#
# @within function asset:effect/0002.attack_physical_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 2
# 名前
    data modify storage asset:effect Name set value '{"text":"物理攻撃力上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵に与える物理ダメージが5%増加する"}'
