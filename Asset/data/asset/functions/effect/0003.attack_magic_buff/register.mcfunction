#> asset:effect/0003.attack_magic_buff/register
#
#
#
# @within function asset:effect/0003.attack_magic_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 3
# 名前
