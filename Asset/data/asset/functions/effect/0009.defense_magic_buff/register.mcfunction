#> asset:effect/0009.defense_magic_buff/register
#
#
#
# @within function asset:effect/0009.defense_magic_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 9
# 名前
    data modify storage asset:effect Name set value '{"text":"魔法耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵から受ける魔法ダメージが5%減少する"}'
