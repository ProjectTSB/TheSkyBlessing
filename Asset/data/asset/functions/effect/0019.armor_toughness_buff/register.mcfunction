#> asset:effect/0019.armor_toughness_buff/register
#
#
#
# @within function asset:effect/0019.armor_toughness_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 19
# 名前
    data modify storage asset:effect Name set value '{"text":"防具強度増加"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"防具強度が1増加する"}'
