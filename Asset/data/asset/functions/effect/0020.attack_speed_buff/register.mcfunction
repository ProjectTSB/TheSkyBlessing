#> asset:effect/0020.attack_speed_buff/register
#
#
#
# @within function asset:effect/0020.attack_speed_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 20
# 名前
    data modify storage asset:effect Name set value '{"text":"攻撃速度増加"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"攻撃速度が1増加する"}'
