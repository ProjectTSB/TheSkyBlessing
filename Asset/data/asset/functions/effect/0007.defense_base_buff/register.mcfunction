#> asset:effect/0007.defense_base_buff/register
#
#
#
# @within function asset:effect/0007.defense_base_buff/_/register
...
# 名前
    data modify storage asset:effect Name set value '{"text":"耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵から受けるダメージが5%減少する"}'
