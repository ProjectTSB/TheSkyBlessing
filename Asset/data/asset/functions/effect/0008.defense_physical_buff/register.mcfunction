#> asset:effect/0008.defense_physical_buff/register
#
#
#
# @within function asset:effect/0008.defense_physical_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 8
# 名前
    data modify storage asset:effect Name set value '{"text":"物理耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵から受ける物理ダメージが5%減少する"}'
