#> asset:effect/0017.movement_speed_buff/register
#
#
#
# @within function asset:effect/0017.movement_speed_buff/_/register
...
# 名前
    data modify storage asset:effect Name set value '{"text":"移動速度上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"移動速度が0.05増加する"}'
