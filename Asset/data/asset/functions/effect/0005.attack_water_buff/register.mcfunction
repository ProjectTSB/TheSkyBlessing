#> asset:effect/0005.attack_water_buff/register
#
#
#
# @within function asset:effect/0005.attack_water_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 5
# 名前
    data modify storage asset:effect Name set value '{"text":"水属性攻撃力上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵に与える水属性ダメージが5%増加する"}'
