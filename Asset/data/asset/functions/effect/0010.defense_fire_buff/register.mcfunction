#> asset:effect/0010.defense_fire_buff/register
#
#
#
# @within function asset:effect/0010.defense_fire_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 10
# 名前
    data modify storage asset:effect Name set value '{"text":"火属性耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵から受ける火属性ダメージが5%減少する"}'
