#> asset:effect/0018.armor_buff/register
#
#
#
# @within function asset:effect/0018.armor_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 18
# 名前
    data modify storage asset:effect Name set value '{"text":"防御力増加"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"防具値が1増加する"}'
