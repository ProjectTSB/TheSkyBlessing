#> asset:effect/0004.attack_fire_buff/register
#
#
#
# @within function asset:effect/0004.attack_fire_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 4
# 名前
    data modify storage asset:effect Name set value '{"text":"火属性攻撃力上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵に与える火属性ダメージが5%増加する"}'
