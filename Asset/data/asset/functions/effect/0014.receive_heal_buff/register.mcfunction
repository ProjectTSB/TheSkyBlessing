#> asset:effect/0014.receive_heal_buff/register
#
#
#
# @within function asset:effect/0014.receive_heal_buff/_/register
...
# 名前
    data modify storage asset:effect Name set value '{"text":"被回復量上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"自分が受ける回復量が5%増加する"}'
