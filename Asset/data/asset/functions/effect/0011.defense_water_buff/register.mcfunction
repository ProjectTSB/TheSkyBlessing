#> asset:effect/0011.defense_water_buff/register
#
#
#
# @within function asset:effect/0011.defense_water_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 11
# 名前
    data modify storage asset:effect Name set value '{"text":"水属性耐性上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵から受ける水属性ダメージが5%減少する"}'
