#> asset:effect/0006.attack_thunder_buff/register
#
#
#
# @within function asset:effect/0006.attack_thunder_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 6
# 名前
    data modify storage asset:effect Name set value '{"text":"雷属性攻撃力上昇"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"敵に与える雷属性ダメージが5%増加する"}'
