#> asset:effect/0015.max_health_buff/register
#
#
#
# @within function asset:effect/0015.max_health_buff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 15
# 名前
