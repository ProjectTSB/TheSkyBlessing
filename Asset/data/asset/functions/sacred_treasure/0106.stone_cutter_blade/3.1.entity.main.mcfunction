#> asset:sacred_treasure/0106.stone_cutter_blade/3.1.entity.main
#
# 攻撃先のエンティティに対する処理
#
# @within function asset:sacred_treasure/0106.stone_cutter_blade/3.main
...
# 補正
    execute as @a[tag=this,distance=..150] run function lib:damage/modifier
# 実行
    function lib:damage/
# 開放
