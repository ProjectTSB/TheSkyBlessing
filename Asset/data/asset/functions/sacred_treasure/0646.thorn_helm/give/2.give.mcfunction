#> asset:sacred_treasure/0646.thorn_helm/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0646.thorn_helm/give/1.trigger
