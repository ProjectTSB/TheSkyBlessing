#> asset:sacred_treasure/0183.answer_to_the_ultimate_question_of_life_the_universe_and_everything/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0183.answer_to_the_ultimate_question_of_life_the_universe_and_everything/trigger/2.check_condition
