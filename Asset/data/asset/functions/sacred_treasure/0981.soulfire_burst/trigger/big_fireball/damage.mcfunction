#> asset:sacred_treasure/0981.soulfire_burst/trigger/big_fireball/damage
#
#
#
# @within function asset:sacred_treasure/0981.soulfire_burst/trigger/big_fireball/hit
