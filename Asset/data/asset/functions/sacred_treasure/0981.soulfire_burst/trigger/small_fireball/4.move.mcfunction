#> asset:sacred_treasure/0981.soulfire_burst/trigger/small_fireball/4.move
#
#
#
# @within function
...
# モブに接触
    execute positioned ~-0.5 ~-0.5 ~-0.5 at @e[tag=Enemy,tag=!Uninterferable,dx=0,sort=nearest,limit=1] run function asset:sacred_treasure/0981.soulfire_burst/trigger/small_fireball/hit

# 再帰
    execute if entity @s[scores={R9.MoveTimesPerTick=1..,R9.Range=1..}] at @s run function asset:sacred_treasure/0981.soulfire_burst/trigger/small_fireball/4.move