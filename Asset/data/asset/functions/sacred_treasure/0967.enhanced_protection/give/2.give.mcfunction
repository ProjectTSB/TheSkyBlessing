#> asset:sacred_treasure/0967.enhanced_protection/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0967.enhanced_protection/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 967
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "shield"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"エンハンスド・プロテクション","color":"blue"}'
# 神器の説明文 (TextComponentString[]){
    data modify storage asset:sacred_treasure Lore set value ['{"text":"未知の金属が使用された盾"}','{"text":"...を更に強化したものと思われる"}','{"text":"構えている間攻撃を55%軽減するが"}','{"text":"攻撃力及び移動速度が低下する"}']
