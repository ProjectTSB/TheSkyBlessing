...
# 32マスまで再起
    execute if score $397_Count Temporary matches ..31 if score $397_Stat Temporary matches 0 positioned ~ ~1 ~ run function asset:sacred_treasure/0397.floor_sublimation_wing/2.1.check_block