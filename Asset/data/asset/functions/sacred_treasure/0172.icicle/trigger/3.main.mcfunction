...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0172.icicle/trigger/2.check_condition
...
# スケジュール開始
    schedule function asset:sacred_treasure/0172.icicle/trigger/laser/schedule 1t replace