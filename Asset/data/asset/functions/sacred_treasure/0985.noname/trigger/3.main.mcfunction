...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0985.noname/trigger/2.check_condition
...
# スケジュールで実行させる
    schedule function asset:sacred_treasure/0985.noname/trigger/schedule_loop 1t replace