...
# 非収束ビーム
    ...
    # ダメージ設定
        execute if score $Spread Temporary matches 2.. run data modify storage lib: Argument.Damage set value 120f
...
# 完全収束ビーム
    ...
    # ダメージ設定
        execute if score $Spread Temporary matches ..1 run data modify storage lib: Argument.Damage set value 24f
