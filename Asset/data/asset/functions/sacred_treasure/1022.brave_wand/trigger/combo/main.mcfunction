...
# フィニッシュのバースト処理
    # バースト1 射程4
        ...
        execute if score @s SE.Burst matches 6 anchored eyes positioned ^ ^ ^ run function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack3_search
    # バースト2 射程5
        scoreboard players set @s[scores={SE.Burst=4}] SE.Range 5
        execute if score @s SE.Burst matches 4 anchored eyes positioned ^ ^ ^ run function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack3_search
    # バースト3 射程6
        scoreboard players set @s[scores={SE.Burst=2}] SE.Range 6
        execute if score @s SE.Burst matches 2 anchored eyes positioned ^ ^ ^ run function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack3_search
