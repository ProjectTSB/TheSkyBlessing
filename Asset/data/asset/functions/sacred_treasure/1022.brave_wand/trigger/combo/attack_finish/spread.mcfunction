#> asset:sacred_treasure/1022.brave_wand/trigger/combo/attack_finish/spread
#
# 波動フィニッシュ: 拡散して飛ばす部分
#
# @within function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack_finish/search
...
# 前方に拡散
    ...
    # マーカーの位置で実行
        execute at @e[type=marker,tag=SpreadMarker,limit=1] run function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack_finish/effect
    # リセット
