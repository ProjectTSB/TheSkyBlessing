...
# ちょっとデカめのヒット判定
    execute positioned ~-0.8 ~-0.8 ~-0.8 as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,dx=0.5,dy=0.5,dz=0.5] run function asset:sacred_treasure/1022.brave_wand/trigger/combo/attack_finish/damage
