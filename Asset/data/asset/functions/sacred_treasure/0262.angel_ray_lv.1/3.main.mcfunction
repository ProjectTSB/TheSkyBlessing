...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0262.angel_ray_lv.1/2.check_condition
...
# レイ処理
    # 処理
        execute positioned ~ ~1.4 ~ as @e[type=area_effect_cloud,tag=Init,distance=..0.01] run function asset:sacred_treasure/0262.angel_ray_lv.1/ray
    # 次tick以降用にschedule予約
        schedule function asset:sacred_treasure/0262.angel_ray_lv.1/recursive 1t
# 効果処理
    function asset:sacred_treasure/0262.angel_ray_lv.1/effect/
# リセット
