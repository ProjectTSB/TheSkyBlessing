...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"魔導士が普段身に着けている靴","color":"gray"}]','[{"text":"魔法耐性+5% 魔法攻撃+5%","color":"dark_purple"}]','[{"text":"MP回復量+5%","color":"green"}]','[{"text":"物理耐性","color":"dark_green"},{"text":"-5% ","color":"dark_red"},{"text":"物理攻撃","color":"dark_green"},{"text":"-5%","color":"dark_red"}]']
