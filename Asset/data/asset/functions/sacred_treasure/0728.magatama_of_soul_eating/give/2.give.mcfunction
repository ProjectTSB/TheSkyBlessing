#> asset:sacred_treasure/0728.magatama_of_soul_eating/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0728.magatama_of_soul_eating/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 728
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"魂喰らいの勾玉","color":"dark_aqua"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"不気味な暗い青緑色をした勾玉","color":"gray","italic":"true"}','{"text":"見つめると魂が吸われているような感覚がする。","color":"gray","italic":"true"}','{"text":"発動時、体力を最大体力の値に応じて回復する。","color":"white"}','{"text":"多く持つほど回復量が増加する。","color":"white"}']
