#> asset:sacred_treasure/0640.spirit_garment/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0640.spirit_garment/trigger/2.check_condition
...
# 最大体力+8
    attribute @s generic.max_health modifier add 00000001-0000-0001-0000-028000000004 "MaxHealth" 8 add