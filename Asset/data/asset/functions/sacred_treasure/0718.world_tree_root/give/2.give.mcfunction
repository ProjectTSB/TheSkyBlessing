...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"世界を見据える大樹に祝福を。","color":"white","italic":"true"}]','[{"text":"根治へと到らせる世界樹の根。","color":"white","italic":"true"}]','[{"text":"最大体力+5 ","color":"light_purple"},{"text":"MP回復量+10%","color":"green"}]','[{"text":"移動速度+5% ","color":"white"},{"text":"攻撃-5%","color":"dark_red"}]']
