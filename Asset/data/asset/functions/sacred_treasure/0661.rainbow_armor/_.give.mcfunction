...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"属","color":"#E60012"},{"text":"性","color":"#F39800"},{"text":"耐","color":"#FFF100"},{"text":"性","color":"#009944"},{"text":"+","color":"#0068B7"},{"text":"2","color":"#1D2088"},{"text":"%","color":"#920783"}]','[{"text":"一","color":"#E60012"},{"text":"式","color":"#F39800"},{"text":"装","color":"#FFF100"},{"text":"備","color":"#009944"},{"text":"時","color":"#0068B7"},{"text":"、","color":"#1D2088"},{"text":"追","color":"#920783"},{"text":"加","color":"#E60012"},{"text":"で","color":"#F39800"},{"text":"属","color":"#FFF100"},{"text":"性","color":"#009944"},{"text":"耐","color":"#0068B7"},{"text":"性","color":"#1D2088"},{"text":"+","color":"#920783"},{"text":"2","color":"#E60012"},{"text":"%","color":"#F39800"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:16773376},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:7,Operation:0,UUID:[I;1,1,661,5],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,1,661,5],Slot:"chest"}]}
