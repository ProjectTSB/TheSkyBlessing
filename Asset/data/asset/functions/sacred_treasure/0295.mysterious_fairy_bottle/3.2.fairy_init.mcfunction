...
# 万が一仕様変更でunivrsalAngerがfalseになったとき用
    execute at @s run summon snowball ~ ~-1 ~ {Owner:[I;0,0,0,0],Motion:[0.0,1.0,0.0],Tags:["ChuzFairySnowball","ChuzFairySnowball"],Item:{id:"minecraft:pink_stained_glass",Count:1b}}
