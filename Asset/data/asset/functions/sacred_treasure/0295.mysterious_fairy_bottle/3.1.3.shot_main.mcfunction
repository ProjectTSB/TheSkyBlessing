...
# 移動とパーティクル
    tp @s ^ ^ ^0.5
    particle minecraft:dust 1 0.5 0.5 0.5 ~ ~0.5 ~ 0 0 0 0 1 force @a[distance=..30]
    particle minecraft:dust 1 0.5 0.8 0.5 ~ ~0.5 ~ 0 0 0 0 1 force @a[distance=..30]
...
# モブに接触
    ...
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#lib:living,type=!player,tag=!HurtEntity,dx=0] at @s run function asset:sacred_treasure/0295.mysterious_fairy_bottle/3.1.4.shot_hit