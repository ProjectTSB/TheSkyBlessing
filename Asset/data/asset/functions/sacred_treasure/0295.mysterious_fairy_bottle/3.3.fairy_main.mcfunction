...
# パーティクル
    particle minecraft:crit ~ ~0.5 ~ 0 0 0 0 1
    particle minecraft:dust 1 0.5 0.5 0.75 ~ ~0.5 ~ 0.1 0.1 0.1 0 1
    particle minecraft:dust 1 0.5 0.8 0.75 ~ ~0.5 ~ 0.1 0.1 0.1 0 1
