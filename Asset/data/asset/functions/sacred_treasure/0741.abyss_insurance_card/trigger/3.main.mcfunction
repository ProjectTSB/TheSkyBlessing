#> asset:sacred_treasure/0741.abyss_insurance_card/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0741.abyss_insurance_card/trigger/2.check_condition
