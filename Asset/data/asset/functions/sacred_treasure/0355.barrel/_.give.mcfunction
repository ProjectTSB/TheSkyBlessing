#> asset:sacred_treasure/0355.barrel/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 攻撃に関する情報 (オプション)
    data modify storage asset:sacred_treasure AttackInfo set value {Damage:20,AttackType:[Physical],ElementType:[None],BypassResist:0b}
# MP消費量 (int)
