...
# 樽の落下
    tp ~ ~-0.5 ~
# エンティティに当たる
    execute positioned ~-0.5 ~1.8 ~-0.5 if entity @e[type=#lib:living,type=!player,tag=!Uninterferable,dx=0,dy=0.02,dz=0] run function asset:sacred_treasure/0355.barrel/barrel/hit
# 地面に当たる
