...
#declare tag Hit
#declare score_holder $blocks_above_me
...
# ここから先は神器側の効果の処理を書く
    ...
    execute if predicate lib:weather/is_raining run data modify storage lib: Argument.Damage set value 40.0f
    execute if predicate lib:weather/is_thundering run data modify storage lib: Argument.Damage set value 50.0f
    ...
    execute if predicate lib:weather/is_sunny as @e[type=!minecraft:player,tag=Hit,distance=..10] at @s run particle dust 0.941 1 0.11 0.5 ~ ~2 ~ 0.02 5 0.02 0 150 force @a
    execute if predicate lib:weather/is_raining as @e[type=!minecraft:player,tag=Hit,distance=..10] at @s run particle dust 1 0.69 0.11 0.5 ~ ~2 ~ 0.02 5 0.02 0 150 force @a
    execute if predicate lib:weather/is_thundering as @e[type=!minecraft:player,tag=Hit,distance=..10] at @s run particle dust 1 0.176 0.176 0.5 ~ ~2 ~ 0.02 5 0.02 0 150 force @a
