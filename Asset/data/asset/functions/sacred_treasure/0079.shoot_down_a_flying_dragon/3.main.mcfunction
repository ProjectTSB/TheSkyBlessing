...
# ここから先は神器側の効果の処理を書く
    ...
    execute if score $Weather Temporary matches 3 as @e[type=!minecraft:player,tag=Hit,distance=..10] at @s run particle dust 0.929 0.137 1 0.5 ~ ~2 ~ 0.02 5 0.02 0 150 force @a
