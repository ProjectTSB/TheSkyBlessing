#> asset:sacred_treasure/0079.shoot_down_a_flying_dragon/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0079.shoot_down_a_flying_dragon/trigger/2.check_condition
...
# ここから先は神器側の効果の処理を書く
    ...
    # ダメージを設定
        ...
        # AttackStrengthに従ってダメージを設定
            execute if score $AttackStrength Temporary matches 0 run data modify storage lib: Argument.Damage set value 145.0f
