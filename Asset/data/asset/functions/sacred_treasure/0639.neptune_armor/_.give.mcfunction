#> asset:sacred_treasure/0639.neptune_armor/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"水ダメージ量+10％ ","color":"aqua"}]','[{"text":"物理耐性+5％ ","color":"dark_green"},{"text":"魔法耐性+5％ ","color":"dark_purple"},{"text":"水耐性+10％ ","color":"aqua"}]','[{"text":"フルセット時、追加で水ダメージ量+10％ ","color":"aqua"}]','{"text":"嘗テ海ノ神ト呼バレシ者ノ兜","color":"dark_blue"}','{"text":"其ノ総テヲ身ニ纏イシ時嘗テノ姿ヲ現ス","color":"dark_blue"}']
