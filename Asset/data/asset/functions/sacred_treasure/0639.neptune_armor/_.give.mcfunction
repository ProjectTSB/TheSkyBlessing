...
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"海神ノ鎧","color":"dark_blue"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"嘗テ海ノ神ト呼バレシ者ノ鎧","color":"dark_blue"}','[{"text":"水耐性10％ ","color":"blue"},{"text":"雷耐性+5%","color":"gold"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:6591},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:4,Operation:0,UUID:[I;1,1,624,6],Slot:"head"}]}
