...
# フルセットでかつ雨/雷雨、水に触れているならtick発動
    execute as @a[tag=HS.Complete] at @s unless predicate lib:weather/is_sunny unless block ~ ~ ~ water run function asset:sacred_treasure/0639.neptune_armor/5.player_tick
