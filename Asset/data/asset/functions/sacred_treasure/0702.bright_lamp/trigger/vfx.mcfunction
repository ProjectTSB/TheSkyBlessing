#> asset:sacred_treasure/0702.bright_lamp/trigger/vfx
#
#
#
# @within function
#   asset:sacred_treasure/0702.bright_lamp/trigger/3.main
#   asset:sacred_treasure/0702.bright_lamp/trigger/vfx
...
# 一周するまで再帰
    execute if score $RecursiveLimit Temporary matches ..17 rotated ~20 ~ run function asset:sacred_treasure/0702.bright_lamp/trigger/vfx