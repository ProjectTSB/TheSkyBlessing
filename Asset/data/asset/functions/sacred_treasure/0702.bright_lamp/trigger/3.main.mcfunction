...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0702.bright_lamp/trigger/2.check_condition
...
# 演出
    ...
    execute positioned ~ ~1 ~ run function asset:sacred_treasure/0702.bright_lamp/trigger/vfx
