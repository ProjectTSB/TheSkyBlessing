#> asset:sacred_treasure/0212.anti_materiel_rifle/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0212.anti_materiel_rifle/give/1.trigger
...
# 攻撃に関する情報 -攻撃範囲 (literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.AttackRange set value 80
# MP必要量 (int) (オプション)
