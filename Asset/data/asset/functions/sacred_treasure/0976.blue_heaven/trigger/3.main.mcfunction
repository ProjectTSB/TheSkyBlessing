...
# 攻撃
    execute if entity @s[scores={R4.Combo=0}] run function asset:sacred_treasure/0976.blue_heaven/trigger/combo/slash1
    execute if entity @s[scores={R4.Combo=1}] run function asset:sacred_treasure/0976.blue_heaven/trigger/combo/slash2
...
# スケジュール開始
    schedule function asset:sacred_treasure/0976.blue_heaven/trigger/slash_entity/1.tick 1t replace
