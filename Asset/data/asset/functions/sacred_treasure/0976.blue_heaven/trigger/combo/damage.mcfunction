#> asset:sacred_treasure/0976.blue_heaven/trigger/combo/damage
#
# 攻撃判定に入った敵にダメージを与える
#
# @within function asset:sacred_treasure/0976.blue_heaven/trigger/combo/**
...
# 引数の設定
    #ダメージブレのための処理
        ...
        # 最低ダメージ設定
            scoreboard players add $RandomDamage Temporary 260
    #ダメージセット
