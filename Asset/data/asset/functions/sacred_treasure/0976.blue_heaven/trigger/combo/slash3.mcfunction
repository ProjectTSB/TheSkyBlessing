...
# 斬撃
    ...
    execute if entity @s[y_rotation=67.5..114.9] run summon armor_stand ~ ~-0.3 ~ {Rotation:[0F,0F],Tags:["R4.SlashSweep","R4.SlashFinish","R4.SlashInit"],Marker:0b,NoGravity:1b,Invisible:1b,ShowArms:1b,Small:0b,Pose:{RightArm:[0.1f,145.0f,0.1f]},DisabledSlots:4144959}
    execute if entity @s[y_rotation=115..157.4] run summon armor_stand ~ ~-0.3 ~ {Rotation:[45F,0F],Tags:["R4.SlashSweep","R4.SlashFinish","R4.SlashInit"],Marker:0b,NoGravity:1b,Invisible:1b,ShowArms:1b,Small:0b,Pose:{RightArm:[0.1f,145.0f,0.1f]},DisabledSlots:4144959}
    execute if entity @s[y_rotation=157.5..-157.4] run summon armor_stand ~ ~-0.3 ~ {Rotation:[90F,0F],Tags:["R4.SlashSweep","R4.SlashFinish","R4.SlashInit"],Marker:0b,NoGravity:1b,Invisible:1b,ShowArms:1b,Small:0b,Pose:{RightArm:[0.1f,145.0f,0.1f]},DisabledSlots:4144959}
