#> asset:sacred_treasure/0264.heal_lv.5/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0264.heal_lv.5/2.check_condition
...
# 回復
    data modify storage lib: Argument.Heal set value 11.6f
