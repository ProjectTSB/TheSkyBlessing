...
# 単体にダメージ。実行者がヒットしたモブになる。
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..4,sort=nearest,limit=1] at @s run function asset:sacred_treasure/0981.soufire_shoot/trigger/small_fireball/damage
