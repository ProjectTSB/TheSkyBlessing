#> asset:sacred_treasure/0629.ice_armor/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:7274495},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:6,Operation:0,UUID:[I;1,1,625,5],Slot:"chest"}]}
