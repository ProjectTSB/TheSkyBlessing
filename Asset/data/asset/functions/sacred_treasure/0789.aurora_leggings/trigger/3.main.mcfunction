...
# 演出
    execute unless data storage asset:context id.all{head:787,chest:788,legs:789,feet:790} rotated ~ 0 positioned ~ ~0.5 ~ run function asset:sacred_treasure/0789.aurora_leggings/trigger/4.vfx
