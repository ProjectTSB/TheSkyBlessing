...
#> Val
# @private
#declare score_holder $BlessingAddCount
...
# 加算回数
    scoreboard players add $BlessingAddCount Global 1
# 固定加算
    ...
    execute if score $BlessingAddCount Global matches 11.. run scoreboard players add $MaxMP Global 2
    execute if score $BlessingAddCount Global matches 21.. run scoreboard players add $MaxMP Global 2
    execute if score $BlessingAddCount Global matches 31.. run scoreboard players add $MaxMP Global 2
    execute if score $BlessingAddCount Global matches 41.. run scoreboard players add $MaxMP Global 2
