...
# 装備を外した時のメイン処理
#
# @within function asset:sacred_treasure/0632.elec_helm/dis_equip/
...
# 一式効果削除
    execute if entity @s[tag=HL.FullSet] run function asset:sacred_treasure/0633.elec_armor/5.fullset_disequip
