#> asset:sacred_treasure/0600.xtal/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0600.xtal/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 600
# 神器のベースアイテム
...
# MP消費量 (int)
    data modify storage asset:sacred_treasure MPCost set value 16
# MP必要量 (int) (オプション)
