#> asset:sacred_treasure/0637.kamui/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 637
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:netherite_chestplate"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"神衣","color":"yellow"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"美しきものがその美しさを維持するのを求められ"}','{"text":"面白きものは面白きものとして"}','{"text":"あり続けることを求められるように"}','{"text":"神というのは常に神であることを求められる存在である。"}','{"text":"それらのものが身につける衣服もまた"}','{"text":"求められる格好というものがある。"}','{"text":"この衣服に袖を通すということは"}','{"text":"すなわち神になるということなのだ。"}']
