...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0652.prominence_leggings/2.check_condition
...
# 演出
    ...
    particle lava ~ ~0.4 ~ 0.4 0.2 0.4 0 10 normal @a
    particle flame ~ ~0.4 ~ 0.4 0.2 0.4 0 10 normal @a
