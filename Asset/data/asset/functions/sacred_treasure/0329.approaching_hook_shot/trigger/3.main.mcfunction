#> asset:sacred_treasure/0329.approaching_hook_shot/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0329.approaching_hook_shot/trigger/2.check_condition
