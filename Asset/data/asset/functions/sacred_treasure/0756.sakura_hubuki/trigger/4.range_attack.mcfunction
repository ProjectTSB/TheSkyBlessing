...
# ダメージ
    execute at @e[type=#lib:living,type=!player,tag=Victim,tag=!Friend,distance=..6] as @e[type=#lib:living,type=!player,tag=!Victim,tag=!Uninterferable,tag=!Object,distance=..3] at @s run function lib:damage/
