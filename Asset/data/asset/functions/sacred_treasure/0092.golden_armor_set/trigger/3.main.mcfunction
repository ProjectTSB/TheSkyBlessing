#> asset:sacred_treasure/0092.golden_armor_set/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0092.golden_armor_set/trigger/2.check_condition
...
# 装備返却処理
    execute if data storage asset:context {Inventory:[{Slot:103b}]} run summon item ~ ~ ~ {Motion:[0.0,0.1,0.0],Item:{id:"minecraft:golden_helmet",Count:1b,tag:{display:{Name:'{"text":"簡易金防具","italic":false}'},RepairCost:9999,Enchantments:[{}]}}}
    execute if data storage asset:context {Inventory:[{Slot:102b}]} run summon item ~ ~ ~ {Motion:[0.0,0.1,0.0],Item:{id:"minecraft:golden_chestplate",Count:1b,tag:{display:{Name:'{"text":"簡易金防具","italic":false}'},RepairCost:9999,Enchantments:[{}]}}}
    execute if data storage asset:context {Inventory:[{Slot:101b}]} run summon item ~ ~ ~ {Motion:[0.0,0.1,0.0],Item:{id:"minecraft:golden_leggings",Count:1b,tag:{display:{Name:'{"text":"簡易金防具","italic":false}'},RepairCost:9999,Enchantments:[{}]}}}
