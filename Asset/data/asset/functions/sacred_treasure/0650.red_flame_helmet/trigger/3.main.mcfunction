#> asset:sacred_treasure/0650.red_flame_helmet/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0650.red_flame_helmet/trigger/2.check_condition
...
# 防御力
    attribute @s generic.armor modifier add 00000001-0000-0001-0000-028a00000006 "1-1-650-6" 4 add
    attribute @s generic.armor_toughness modifier add 00000001-0000-0001-0000-028a00000006 "1-1-650-6" 5 add
