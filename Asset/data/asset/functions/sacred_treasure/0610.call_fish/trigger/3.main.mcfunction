...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0610.call_fish/trigger/2.check_condition
...
# 再帰先へ飛ばす
    execute as @e[type=cod,tag=GY.Fish,limit=1] run function asset:sacred_treasure/0610.call_fish/trigger/3.1.tick