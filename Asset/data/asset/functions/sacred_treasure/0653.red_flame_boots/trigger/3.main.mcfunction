#> asset:sacred_treasure/0653.red_flame_boots/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0653.red_flame_boots/trigger/2.check_condition
...
# 防御力
    attribute @s generic.armor modifier add 00000001-0000-0001-0000-028d00000003 "1-1-653-6" 4 add
    attribute @s generic.armor_toughness modifier add 00000001-0000-0001-0000-028d00000003 "1-1-653-6" 5 add
