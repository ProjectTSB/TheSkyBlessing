...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"「その者は凍りついた心を抱えて彷徨っていた。","color":"gray","italic":"true"}]','[{"text":" しかし心を覆う白霜はその心すら砕こうとした。」","color":"gray","italic":"true"}]','[{"text":"水耐性+10% 水攻撃+10% ","color":"aqua"}]','[{"text":"MP回復量+8% ","color":"green"},{"text":"被回復量-15%","color":"dark_red"}]','[{"text":"白雪で身を覆った時","color":"#ABF4FF"}]','[{"text":"水攻撃+25% ","color":"aqua"},{"text":"MP回復量+8% ","color":"green"},{"text":"被回復量-15%","color":"dark_red"}]']
