...
# ここから先は神器側の効果の処理を書く
    ...
    # スーパードラゴン召喚
        summon horse ~ ~0.1 ~ {Health:0.1f,CustomName:'[{"text":"スーパードラゴン","color":"aqua"}]',CustomNameVisible:1b,Tame:1b,Variant:0,SaddleItem:{id:"minecraft:saddle",Count:1b,tag:{}},DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:8b,Amplifier:18b,Duration:999999,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:0.1d},{Name:"horse.jump_strength",Base:2.0d},{Name:"generic.movement_speed",Base:1.0d}],Tags:["Friend"]}