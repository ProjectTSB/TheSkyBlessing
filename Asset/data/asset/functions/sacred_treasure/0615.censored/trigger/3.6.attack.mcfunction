#> asset:sacred_treasure/0615.censored/trigger/3.6.attack
#
# 通常攻撃
#
...
# 演出
    execute positioned ~ ~1.5 ~ rotated 0 90 run function asset:sacred_treasure/0615.censored/trigger/particle.1
