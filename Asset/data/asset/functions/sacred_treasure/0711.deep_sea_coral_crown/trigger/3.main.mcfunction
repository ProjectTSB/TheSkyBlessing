...
# メモ 各部位 水耐性+10％ 水攻撃+5％ 体力回復量+5％ 火攻撃-20%
...
# 演出
    ...
    execute unless data storage asset:context id.all{head:711,chest:712,legs:713,feet:714} positioned ~ ~1.7 ~ rotated ~ 0 run function asset:sacred_treasure/0711.deep_sea_coral_crown/trigger/vfx
