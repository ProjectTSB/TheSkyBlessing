#> asset:sacred_treasure/0917.flame_hunter_clothes/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0917.flame_hunter_clothes/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 917
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_leggings"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"炎を追う狩人の狩猟服(下)","color":"red"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"2部位装備:","color":"white"}]','[{"text":"炎耐性+10% 火攻撃+10% ","color":"red"},{"text":"水耐性-10% ","color":"aqua"},{"text":"移動速度+5%","color":"white"}]','[{"text":"4部位装備:","color":"white"}]','[{"text":"炎耐性+15% 火攻撃+15% ","color":"red"},{"text":"水耐性-10% ","color":"aqua"},{"text":"移動速度+10%","color":"white"}]','[{"text":"「その炎を辿り、緑が消えた場所を見つけ、","color":"white"}]','[{"text":"そこで狩人は炎の原因を悟った。」","color":"white"}]']
