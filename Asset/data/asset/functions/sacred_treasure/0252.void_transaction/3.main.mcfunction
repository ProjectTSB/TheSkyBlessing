#> asset:sacred_treasure/0252.void_transaction/3.main
#
# 神器のメイン処理部
#
...
# 使用中でなければ初期設定
    execute unless entity @s[scores={70.Timer=1..2400}] run function asset:sacred_treasure/0252.void_transaction/3.1.initiation
