...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0920.dal_i_thalion/trigger/2.check_condition
...
# 1tick後に動かす
    schedule function asset:sacred_treasure/0920.dal_i_thalion/trigger/4.schedule 1t
