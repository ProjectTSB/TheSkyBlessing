...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"3本","color":"gold"},{"text":"の超高速のナイフを放つ","color":"white"}]','[{"text":"近くの敵に使うと、"},{"text":"とっておきの処刑","color":"red"},{"text":"を発動する"}]','[{"text":"もっと恐ろしいものの片鱗を味わったぜ…","color":"gray","strikethrough":true}]']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value ["141*3"]
