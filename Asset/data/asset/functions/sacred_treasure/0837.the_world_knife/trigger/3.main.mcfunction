...
# 弾を召喚(敵がいない場合)
    execute anchored eyes positioned ^ ^ ^2 unless entity @e[type=#lib:living,tag=N9.Target,distance=..4,limit=1] positioned ^ ^ ^-2 positioned ~ ~-0.7 ~ run function asset:sacred_treasure/0837.the_world_knife/trigger/knife_summon_forward
