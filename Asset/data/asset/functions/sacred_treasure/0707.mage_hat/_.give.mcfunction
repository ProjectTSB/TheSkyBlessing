#> asset:sacred_treasure/0707.mage_hat/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"魔法ダメージ量+10% 魔法耐性+5% ","color":"dark_purple"},{"text":"MP回復量+10%","color":"green"}]']
...
data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:3542871},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:4,Operation:0,UUID:[I;1,1,707,6],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;1,1,707,6],Slot:"head"}]}
