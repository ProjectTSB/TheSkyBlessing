#> asset:sacred_treasure/0607.u_and_w_06/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0607.u_and_w_06/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 607
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"U&W-06","color":"gray","bold":true,"italic":false,"underlined":true}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"とある神が協力をして作り上げた神器 "}','{"text":"しかし、お互い馬が合わなかったのか "}','[{"text":"少し"},{"text":"歪な性能","color":"gray","italic":true},{"text":"をしている"}]','{"text":" "}','{"text":"再利用可能な工夫がされている","bold":true,"underlined":true}']
# MP以外の消費物 (TextComponentString) (オプション)
    # data modify storage asset:sacred_treasure CostText set value
# 使用回数 (int) (オプション)
    data modify storage asset:sacred_treasure RemainingCount set value 6
