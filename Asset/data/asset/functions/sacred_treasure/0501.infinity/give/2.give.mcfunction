#> asset:sacred_treasure/0501.infinity/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0501.infinity/give/1.trigger
...
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"無限増殖","color":"yellow"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"世界を埋め尽くすことも不可能ではない。","color":"white"}']
