#> asset:sacred_treasure/0224.onegai_muscle_1/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0224.onegai_muscle_1/trigger/2.check_condition
...
# ここから先は神器側の効果の処理を書く
    ...
    # 効果
        ...
        execute if predicate player_manager:is_believe/urban run effect give @s strength 10 7 true
    # 演出
