#> asset:sacred_treasure/0320.divine_thunder_sword/trigger/3.2.particle_line
#
# 神器のメイン処理部
#
# @within function
#    asset:sacred_treasure/0320.divine_thunder_sword/trigger/3.main
...
# 線を書く
    ...
    execute if score $Line Temporary matches ..12 rotated ~30 ~ run function asset:sacred_treasure/0320.divine_thunder_sword/trigger/3.2.particle_line