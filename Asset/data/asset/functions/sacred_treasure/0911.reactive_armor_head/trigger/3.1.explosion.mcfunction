#> asset:sacred_treasure/0911.reactive_armor_head/trigger/3.1.explosion
#
# 爆発で周囲にダメージを与える
#
# @within function asset:sacred_treasure/0911.reactive_armor_head/trigger/3.main
...
# mob敵へのダメージ
    ...
    execute as @e[type=#lib:living,distance=..3] run function lib:damage/
