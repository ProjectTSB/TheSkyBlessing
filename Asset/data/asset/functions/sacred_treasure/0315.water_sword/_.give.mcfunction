#> asset:sacred_treasure/0315.water_sword/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 攻撃に関する情報 (Component) (オプション)
    data modify storage asset:sacred_treasure AttackInfo set value {Damage:[7,9],AttackType:[Physical],ElementType:[Water],BypassResist:0b}
# MP消費量 (int)
