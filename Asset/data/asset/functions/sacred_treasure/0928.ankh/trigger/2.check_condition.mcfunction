#> asset:sacred_treasure/0928.ankh/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0928.ankh/trigger/1.trigger

# ID指定する
    data modify storage asset:sacred_treasure TargetID set value 928
