...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0370.burn_sorcery/2.check_condition
...
# 弾を進めるための再起開始
    execute anchored eyes positioned ^ ^ ^1.5 run function asset:sacred_treasure/0370.burn_sorcery/3.1.shoot
