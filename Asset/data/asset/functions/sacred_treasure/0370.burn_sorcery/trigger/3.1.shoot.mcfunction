#> asset:sacred_treasure/0370.burn_sorcery/trigger/3.1.shoot
#
# 神器のメイン処理部
#
# @within function
#   asset:sacred_treasure/0370.burn_sorcery/trigger/3.main
#   asset:sacred_treasure/0370.burn_sorcery/trigger/3.1.shoot
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:sacred_treasure/0370.burn_sorcery/trigger/3.2.damage

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:sacred_treasure/0370.burn_sorcery/trigger/3.1.shoot