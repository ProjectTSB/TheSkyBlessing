...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0370.burn_sorcery/trigger/2.check_condition
...
# 演出
    ...
    execute anchored eyes positioned ^ ^ ^1.5 rotated ~ ~90 run function asset:sacred_treasure/0370.burn_sorcery/trigger/particle.1
# タグを消す
