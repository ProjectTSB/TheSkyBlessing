...
# ダメージ判定
    execute if entity @e[type=#lib:living,type=!player,tag=!Uninterferable,distance=..1.5] run function asset:sacred_treasure/0687.soaring_wing/19.melee_recursion_attack
