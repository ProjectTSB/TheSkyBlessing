#> asset:sacred_treasure/0724.oblivious_snow/trigger/fullset/attack
#
# 攻撃
#
# @within function asset:sacred_treasure/0724.oblivious_snow/trigger/fullset/trigger

# 演出
    execute at @e[type=#lib:living,type=!player,tag=Victim,distance=..64] run particle snowflake ~ ~1.2 ~ 0.5 0.5 0.5 0.2 100 normal @a
