#> asset:sacred_treasure/0704.wizard_robe_upper/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"魔法ダメージ量+5% 魔法耐性+2.5% ","color":"dark_purple"},{"text":"MP回復量+5%","color":"green"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:6626723},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:6,Operation:0,UUID:[I;1,1,704,5],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;1,1,704,5],Slot:"chest"}]}
