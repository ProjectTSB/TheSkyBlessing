#> asset:sacred_treasure/0876.uni/trigger/3.1.bullet
#
# ビーム部
#
# @within function
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:sacred_treasure/0876.uni/trigger/3.2.hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:sacred_treasure/0876.uni/trigger/3.1.bullet