#> asset:sacred_treasure/0266.angel_ray_lv.5/effect/
#
#
#
# @within function asset:sacred_treasure/0266.angel_ray_lv.5/3.main
...
# 処理
    ...
    execute as @e[type=player,distance=..13] run function lib:heal/
# リセット
