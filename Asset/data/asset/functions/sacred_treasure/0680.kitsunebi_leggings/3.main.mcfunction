#> asset:sacred_treasure/0680.kitsunebi_leggings/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0680.kitsunebi_leggings/2.check_condition
...
# 演出
    particle flame ~ ~0.4 ~ 0.4 0.15 0.4 0 8 normal @s
    particle soul_fire_flame ~ ~0.4 ~ 0.4 0.15 0.4 0 8 normal @s
