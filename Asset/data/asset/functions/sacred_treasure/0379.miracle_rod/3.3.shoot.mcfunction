...
# 着弾
    execute if entity @s[tag=Landing] run function asset:sacred_treasure/0379.miracle_rod/3.4.damage

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:sacred_treasure/0379.miracle_rod/3.3.shoot