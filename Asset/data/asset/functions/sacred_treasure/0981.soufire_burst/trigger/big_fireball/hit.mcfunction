#> asset:sacred_treasure/0981.soufire_burst/trigger/big_fireball/hit
#
# 着弾したとき。周囲に範囲攻撃。
#
...
# 範囲3にダメージ。着弾地点から範囲3以内のモブが実行者になる。
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..3] at @s run function asset:sacred_treasure/0981.soufire_burst/trigger/big_fireball/damage
