...
# 飛距離の限界で炸裂する
#
# @within function asset:sacred_treasure/0981.soufire_burst/trigger/big_fireball/4.move
...
# 火の玉にInit処理
    execute as @e[type=armor_stand,tag=R9.SmallFireball,tag=R9.Init,distance=..10,sort=nearest,limit=5] run function asset:sacred_treasure/0981.soufire_burst/trigger/small_fireball/1.init

# スケジュールループ開始
    schedule function asset:sacred_treasure/0981.soufire_burst/trigger/small_fireball/2.tick 1t
