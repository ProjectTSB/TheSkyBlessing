#> asset:sacred_treasure/0952.lunatic_rod/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0952.lunatic_rod/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 952
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"狂月の杖","color":"white"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"ルナティックメイジの持っていた杖","color":"gray","italic":"true"}]','[{"text":"この杖の持つ強大な魔力をもってしても、","color":"gray","italic":"true"}]','[{"text":"彼の者にとっては枷でしかなかった。","color":"gray","italic":"true"}]','[{"text":"使用時、強力な魔法を放つと同時に、","color":"white"}]','[{"text":"ヒット時自身に","color":"white"},{"text":"魔法攻撃+10%","color":"dark_purple"},{"text":"を15秒間付与する。","color":"white"}]']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value [2000]
