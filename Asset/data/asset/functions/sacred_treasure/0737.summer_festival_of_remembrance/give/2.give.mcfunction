#> asset:sacred_treasure/0737.summer_festival_of_remembrance/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0737.summer_festival_of_remembrance/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 737
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"追憶の夏祭り","color":"red"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"あの日の夏祭りの思い出の詰まったお守り","color":"#FF962E","italic":"true"}]','[{"text":"手に握れば、かつての情景を再現できる。","color":"#FF962E","italic":"true"}]','[{"text":"※ 開けた場所で使用してください。","color":"gray"}]','[{"text":"  設置箇所の近くでスニークすると停止できます。","color":"gray"}]']
