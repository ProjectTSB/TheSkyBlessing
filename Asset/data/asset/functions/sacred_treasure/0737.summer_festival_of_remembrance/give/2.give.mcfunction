...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"あの日の夏祭りの思い出の詰まったお守り","color":"#FF962E","italic":"true"}]','[{"text":"手に握れば、かつての情景を再現できる。","color":"#FF962E","italic":"true"}]']
