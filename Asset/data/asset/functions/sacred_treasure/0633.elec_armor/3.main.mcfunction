#> asset:sacred_treasure/0633.elec_armor/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0633.elec_armor/2.check_condition
...
# 引数の設定
    # UUID
        data modify storage api: Argument.UUID set value [I;1,1,632,5]
    # 補正値
