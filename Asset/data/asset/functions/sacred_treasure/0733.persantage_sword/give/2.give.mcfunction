#> asset:sacred_treasure/0733.persantage_sword/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0733.persantage_sword/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 733
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"生ける者全てを平等に斬ることが出来る剣","color":"blue"}','{"text":"攻撃時、対象に","color":"blue"}','{"text":"最大体力の30%の割合ダメージを与える","color":"blue","bold":true}','{"text":"天使に対しては最大50ダメージになる","color":"blue"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value ["§9相手の最大体力の30%"]
