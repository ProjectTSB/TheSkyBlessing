...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"生ける者全てを平等に斬ることが出来る剣","color":"blue"}','{"text":"攻撃時、対象に","color":"blue"}','{"text":"最大体力の30%の割合ダメージを与える","color":"blue","bold":true}','{"text":"天使に対しては最大20ダメージ","color":"blue"}']
