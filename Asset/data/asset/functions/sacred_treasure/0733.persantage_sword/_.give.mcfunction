...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"生ける者全てを平等にに斬り裂くことが出来る剣","color":"blue"}','{"text":"攻撃時、対象に","color":"blue"}','{"text":"最大体力の30%分ダメージを与える(最大60)","color":"blue","bold":true}']
