...
# 対象が天使でダメージ量が21以上の場合強制的にダメージを20に
    ...
    execute if entity @e[type=#lib:living,type=!player,tag=Victim,tag=Enemy.Boss,distance=..6] if score $KD.DamageValue Temporary matches 21.. run data modify storage lib: Argument.Damage set value 20.0f
