...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0631.ice_boots/2.check_condition
...
#ちょっとした演出
    particle falling_dust diamond_block ~ ~0.3 ~ 0.4 0.1 0.4 0 5 normal @s
    particle falling_dust snow_block ~ ~0.3 ~ 0.4 0.1 0.4 0 5 normal @s
