#> asset:sacred_treasure/0948.ft_139_rifle/trigger/hit
#
#
#
# @within function asset:sacred_treasure/0948.ft_139_rifle/trigger/bullet

# 一定の距離から距離減衰するための距離(適正距離をメートル*2で指定)
    scoreboard players set $Appropriate_Distance Temporary 30
# 最低ダメージ保証
    scoreboard players set $MinDamage Temporary 30

# 演出
    execute at @e[tag=LandingTarget,limit=1] run particle minecraft:block redstone_block ~ ~1.2 ~ 0.4 0.4 0.4 0 4
# ダメージ設定
    # ダメージ
        scoreboard players add $Damage Temporary 20
    # 属性
