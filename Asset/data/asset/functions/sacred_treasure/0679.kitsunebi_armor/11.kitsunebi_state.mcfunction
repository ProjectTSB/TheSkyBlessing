...
# 一定時間ごとの火魔法属性ダメージと演出
    execute unless score @s IV.Kitsunebi matches 1..9 unless score @s IV.Kitsunebi matches 11..39 unless score @s IV.Kitsunebi matches 41..69 unless score @s IV.Kitsunebi matches 71..99 run function asset:sacred_treasure/0679.kitsunebi_armor/12.kitsunebi_damage