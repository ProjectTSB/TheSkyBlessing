...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"燃え盛る流星群を召喚し、広範囲の敵を攻撃する。","color":"white","italic":false}','{"text":"\\"Alea iacta est\\"","color":"gray","italic":false}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value ["1500×10"]
...
# グローバルクールダウン (int) (オプション)
    #data modify storage asset:sacred_treasure SpecialCooldown set value 180
