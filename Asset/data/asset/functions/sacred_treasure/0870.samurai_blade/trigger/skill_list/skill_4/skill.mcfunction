#> asset:sacred_treasure/0870.samurai_blade/trigger/skill_list/skill_4/skill
#
#
#
...
# 剣を振る
    execute if score @s O6.Time matches 2 anchored eyes run function asset:sacred_treasure/0870.samurai_blade/trigger/particle/particle4
    execute if score @s O6.Time matches 2 run function asset:sacred_treasure/0870.samurai_blade/trigger/slash
    execute if score @s O6.Time matches 4 anchored eyes run function asset:sacred_treasure/0870.samurai_blade/trigger/particle/particle6
