...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0369.fire_magic/trigger/2.check_condition
...
# Scheduleループ
    schedule function asset:sacred_treasure/0369.fire_magic/trigger/3.1.tick 1t replace