#> asset:sacred_treasure/0369.fire_magic/trigger/3.2.fireball
#
# 火の玉が実行
#
# @within function asset:sacred_treasure/0369.fire_magic/trigger/3.1.tick
...
# 着弾処理
    execute if entity @s[tag=A9.Landing] run function asset:sacred_treasure/0369.fire_magic/trigger/3.3.attack
