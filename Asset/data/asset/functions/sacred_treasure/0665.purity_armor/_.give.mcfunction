#> asset:sacred_treasure/0665.purity_armor/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 665
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"物理ダメージ量+7.5% ","color":"dark_green"},{"text":"物理耐性+7.5% ","color":"dark_green"}]','[{"text":"魔法ダメージ量+7.5% ","color":"dark_purple"},{"text":"魔法耐性+7.5%","color":"dark_purple"}]','[{"text":"一式装備時、","color":"white"}]','[{"text":"追加で","color":"white"},{"text":"火耐性+15%","color":"red"},{"text":"、","color":"white"},{"text":"水耐性+15%","color":"aqua"},{"text":"、","color":"white"},{"text":"雷耐性+15%","color":"yellow"}]','[{"text":"攻撃時に無属性","color":"white"},{"text":"物理","color":"dark_green"},{"text":"/","color":"white"},{"text":"魔法","color":"dark_purple"},{"text":"ダメージを10ずつ与える","color":"white"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:16777215},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:8,Operation:0,UUID:[I;1,1,665,5],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:3,Operation:0,UUID:[I;1,1,665,5],Slot:"chest"}]}
