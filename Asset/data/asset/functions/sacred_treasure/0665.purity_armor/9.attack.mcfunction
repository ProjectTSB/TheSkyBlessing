...
# 演出
    execute at @e[type=#lib:living,type=!player,tag=Victim,tag=!Uninterferable,distance=..100] run particle sweep_attack ~ ~1.2 ~ 0.2 0.2 0.2 0 8 force @a[distance=..50]
    execute at @e[type=#lib:living,type=!player,tag=Victim,tag=!Uninterferable,distance=..100] run playsound entity.player.attack.sweep master @a ~ ~1.2 ~ 0.6 1 0
