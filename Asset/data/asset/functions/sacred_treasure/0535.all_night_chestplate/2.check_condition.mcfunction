#> asset:sacred_treasure/0535.all_night_chestplate/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0535.all_night_chestplate/1.trigger
#> score
# @private
...
# 演出（使用できないときのメッセージだすとうるさいのでなし）
    ...
    execute unless entity @s[tag=CanUsed] run playsound minecraft:block.stone_button.click_off master @s ~ ~ ~ 1 2
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:sacred_treasure/0535.all_night_chestplate/3.main