...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"僅かに残ったジャック・オ・ランタンの魂","color":"#D900FF"}]','[{"text":"魂を吸収することで僅かに力を取り戻し幽かに輝く","color":"#D900FF"}]','[{"text":"効果発動時、移動速度上昇と暗視を30秒得る。","color":"#D900FF"}]']
