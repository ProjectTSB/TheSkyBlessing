...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"物理ダメージ量+5% ","color":"dark_green"},{"text":"水ダメージ量+7.5% 水耐性+5%","color":"aqua"}]','{"text":"どんなに穏やかな水でも時折鋼をも貫くだろう","color":"#087BFF"}']
