#> asset:sacred_treasure/0744.fierce_water_leggings/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 744
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"物理ダメージ量+5% ","color":"dark_green"},{"text":"水ダメージ量+7.5%","color":"aqua"}]','[{"text":"水耐性+5%","color":"aqua"}]','{"text":"どんなに穏やかな水でも時折鋼をも貫くだろう","color":"#087BFF"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:556031},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:6,Operation:0,UUID:[I;1,1,744,4],Slot:legs},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;1,1,744,4],Slot:"legs"}]}
