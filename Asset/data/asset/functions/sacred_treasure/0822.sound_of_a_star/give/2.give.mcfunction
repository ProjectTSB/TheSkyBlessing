#> asset:sacred_treasure/0822.sound_of_a_star/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0822.sound_of_a_star/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 822
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"「やがて星となって再会しよう。」","color":"gray"}]','[{"text":"前方に星を発射する","color":"gray"}]','[{"text":"使用時のMPの割合により、飛ばす星の数が変化する","color":"gray"}]']
...
# MP消費量 (int)
    data modify storage asset:sacred_treasure MPCost set value 70
# MP必要量 (int) (オプション)
