...
# 少しとどまってから発射 何個目かでズレ
    execute if entity @s[tag=!MU.2,tag=!MU.3] if score @s MU.Time matches 15.. run tp @s ^ ^ ^1
    execute if entity @s[tag=MU.2] if score @s MU.Time matches 20.. run tp @s ^ ^ ^1
    execute if entity @s[tag=MU.3] if score @s MU.Time matches 25.. run tp @s ^ ^ ^1
