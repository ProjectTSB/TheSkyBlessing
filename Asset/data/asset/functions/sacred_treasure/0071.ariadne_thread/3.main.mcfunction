#> asset:sacred_treasure/0071.ariadne_thread/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0071.ariadne_thread/2.check_condition

#> private
# @private
    #declare tag TeleportSchedule
