...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"魔法使いが普段身に着けている靴","color":"gray","italic":"true"}]','[{"text":"魔法耐性+2.5% 魔法攻撃+2.5%","color":"dark_purple"}]','[{"text":"MP回復量+2.5%","color":"green"}]','[{"text":"物理耐性-2.5% ","color":"dark_red"},{"text":"物理攻撃-2.5%","color":"dark_red"}]']
