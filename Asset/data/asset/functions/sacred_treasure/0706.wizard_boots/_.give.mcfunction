#> asset:sacred_treasure/0706.wizard_boots/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:6626723},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:2,Operation:0,UUID:[I;1,1,703,6],Slot:"feet"}]}
