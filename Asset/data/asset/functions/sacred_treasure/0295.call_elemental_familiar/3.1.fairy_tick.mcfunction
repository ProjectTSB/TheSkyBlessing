#> asset:sacred_treasure/0295.call_elemental_familiar/3.1.fairy_tick
#
...
# エンティティがいればループ
    execute if entity @e[type=bee,tag=295Fa.Main,limit=1] run schedule function asset:sacred_treasure/0295.call_elemental_familiar/3.1.fairy_tick 1t