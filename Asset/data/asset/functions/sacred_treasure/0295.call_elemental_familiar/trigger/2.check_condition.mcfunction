...
# 既に召喚済みなら使えない。タグ付与じゃないと残ってるファミリアの数だけコマンドが実行されてしまう
    ...
    execute if entity @s[tag=87.CannotUse] run function asset:sacred_treasure/0295.call_elemental_familiar/trigger/2.check_condition/3.cannot_use
