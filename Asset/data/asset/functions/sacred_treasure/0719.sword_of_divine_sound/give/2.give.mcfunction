...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"とある英雄が振るっていた、白き雷を纏う大太刀。","color":"gray"}','{"text":"振るえば悪しき者に裁きの雷を下す。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value [650,850]
