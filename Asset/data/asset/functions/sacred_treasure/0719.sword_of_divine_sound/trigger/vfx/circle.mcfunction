#> asset:sacred_treasure/0719.sword_of_divine_sound/trigger/vfx/circle
#
# 円状に広がるvfx
#
# @within function
...
# これを~357までやるのがだるいので回転する再帰を使用
    ...
    execute if score $RecursiveLimit Temporary matches ..11 rotated ~30 ~ run function asset:sacred_treasure/0719.sword_of_divine_sound/trigger/vfx/circle