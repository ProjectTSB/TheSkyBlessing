...
# 雷の演出の開始処理
    ...
    execute as @e[type=marker,tag=LightningMarker,distance=..0.01,limit=1] at @s run function asset:sacred_treasure/0719.sword_of_divine_sound/trigger/vfx/lightning
