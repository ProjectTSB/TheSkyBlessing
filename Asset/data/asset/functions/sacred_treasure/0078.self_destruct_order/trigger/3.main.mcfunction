...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0078.self_destruct_order/trigger/2.check_condition
...
#演出
    ...
    execute at @e[tag=26.GolemBomb] run playsound minecraft:entity.creeper.primed master @a[distance=..30] ~ ~ ~ 1 0.1
...
# カウントダウン開始
    ...
    schedule function asset:sacred_treasure/0078.self_destruct_order/trigger/count_down 1t replace