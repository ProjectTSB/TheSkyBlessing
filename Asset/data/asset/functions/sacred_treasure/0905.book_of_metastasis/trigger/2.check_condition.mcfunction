#> asset:sacred_treasure/0905.book_of_metastasis/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0905.book_of_metastasis/trigger/1.trigger
