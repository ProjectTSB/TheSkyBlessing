#> asset:sacred_treasure/0790.aurora_boots/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0790.aurora_boots/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 790
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_boots"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"オーロラブーツ","color":"#008bff"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"夜空に輝くオーロラを封じ込めた鎧。","color":"#0C64B0","italic":"true"}]','[{"text":"その蒼翠の光は進むべき道を照らす。","color":"#0C64B0","italic":"true"}]','[{"text":"魔法耐性+5% ","color":"dark_purple"},{"text":"雷耐性+10% 雷攻撃+5%","color":"yellow"}]','[{"text":"MP回復+5% ","color":"green"},{"text":"物理耐性-10%","color":"dark_red"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:35839},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;1,1,790,3],Slot:"feet"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2.5,Operation:0,UUID:[I;1,1,790,3],Slot:"feet"}]}
