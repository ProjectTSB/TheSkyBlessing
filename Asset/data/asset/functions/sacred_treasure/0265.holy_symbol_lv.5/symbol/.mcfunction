...
# プレイヤーにエフェクトの付与
    execute as @a[distance=..4.5] unless score @s 79.HolySymbol matches -2147483648..2147483647 run function asset:sacred_treasure/0265.holy_symbol_lv.5/effect/start
# 実行時間のインクリメント
