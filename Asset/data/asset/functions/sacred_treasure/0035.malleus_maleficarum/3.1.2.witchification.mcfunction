...
#効果音
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=MalleusMaleficarumSacrifice,dx=1,dy=1,dz=1,sort=nearest,limit=1] at @s run playsound entity.zombie_villager.converted player @a ~ ~ ~ 1 1 1

#particle
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=MalleusMaleficarumSacrifice,dx=1,dy=1,dz=1,sort=nearest,limit=1] at @s run particle landing_obsidian_tear ~ ~0.1 ~ 0.5 0 0.5 0 200 force
