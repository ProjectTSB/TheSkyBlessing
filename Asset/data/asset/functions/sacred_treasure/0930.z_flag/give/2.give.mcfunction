#> asset:sacred_treasure/0930.z_flag/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0930.z_flag/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 930
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"Z旗","color":"white"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"攻撃力が25%上がり、防御力が35%下がる。"}','{"text":"皇國ノ興廢此ノ一戰ニ在リ、","color":"dark_purple","italic":"true"}','{"text":"各員一層奮勵努力セヨ","color":"dark_purple","italic":"true"}']
