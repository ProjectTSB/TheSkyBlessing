...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0269.holy_symbol_lv.10/trigger/2.check_condition
...
# ここから先は神器側の効果の処理を書く
    ...
    function asset:sacred_treasure/0269.holy_symbol_lv.10/trigger/recursive