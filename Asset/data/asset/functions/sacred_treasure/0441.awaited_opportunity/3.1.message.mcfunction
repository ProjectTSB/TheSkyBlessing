#> asset:sacred_treasure/0441.awaited_opportunity/3.1.message
#
# メッセージを流す
#
...
# ランダムでメッセージを垂れ流す
    ...
    # プレイヤーが"不運"と"踊"っちまった時
        execute if score $Random Temporary matches 55..59 run function asset:sacred_treasure/0441.awaited_opportunity/3.2.hardluck
