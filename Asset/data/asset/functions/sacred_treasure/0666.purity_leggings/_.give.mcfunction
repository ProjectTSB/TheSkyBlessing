#> asset:sacred_treasure/0666.purity_leggings/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"物理属性攻撃力+7.5% ","color":"dark_green"},{"text":"物理耐性+7.5% ","color":"dark_green"}]','[{"text":"魔法属性攻撃力+7.5% ","color":"dark_purple"},{"text":"魔法耐性+7.5%","color":"dark_purple"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:16777215},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:7,Operation:0,UUID:[I;1,1,666,4],Slot:"legs"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:3,Operation:0,UUID:[I;1,1,666,4],Slot:"legs"}]}
