...
# 一定間隔での処理
    ...
    execute if score $Temp Temporary matches 6 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/8
    execute if score $Temp Temporary matches 7 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/9
    execute if score $Temp Temporary matches 7 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/10
    execute if score $Temp Temporary matches 8 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/11
    execute if score $Temp Temporary matches 8 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/12
    execute if score $Temp Temporary matches 9 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/13
    execute if score $Temp Temporary matches 9 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/14
    execute if score $Temp Temporary matches 10 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/15
    execute if score $Temp Temporary matches 10 run function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/lake/effect/circle/16
