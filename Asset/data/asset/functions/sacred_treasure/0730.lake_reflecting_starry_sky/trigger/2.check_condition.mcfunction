#> asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0730.lake_reflecting_starry_sky/trigger/1.trigger
