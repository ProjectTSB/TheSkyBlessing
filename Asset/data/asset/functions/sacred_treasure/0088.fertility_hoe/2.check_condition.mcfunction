#> asset:sacred_treasure/0088.fertility_hoe/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0088.fertility_hoe/1.trigger
...
# 他にアイテム等確認する場合はここに書く
    # ゲームモード確認
        ...
        execute if entity @s[gamemode=!survival,gamemode=!creative] run tellraw @s [{"text": "ここでは使えなさそうだ..."}]
    # アイテム確認
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:sacred_treasure/0088.fertility_hoe/3.main