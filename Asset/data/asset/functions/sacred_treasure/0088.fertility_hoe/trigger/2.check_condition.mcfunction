...
# 他にアイテム等確認する場合はここに書く
    ...
    # 周囲のブロック判定 //y座標によって場合分け //1層ずつ判定とっていくよ
        # 取得
            ...
            execute positioned ~ ~-4 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~-3 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~-2 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~-1 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~ ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~1 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~2 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~3 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
            execute positioned ~ ~4 ~ run function asset:sacred_treasure/0088.fertility_hoe/trigger/2.1.layer_check
