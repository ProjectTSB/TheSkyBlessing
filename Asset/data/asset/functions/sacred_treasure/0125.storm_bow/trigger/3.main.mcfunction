...
# 矢を降らす
    ...
    execute at @e[type=#lib:living,type=!player,tag=ArrowTarget,distance=..15,limit=1] run summon arrow ~-0.4 ~7 ~ {pickup:0b,damage:7d,crit:1b,Motion:[0.2,-1.0,0.0]}
...
# 2回目
    tag @e[type=#lib:living,type=!player,tag=!Uninterferable,distance=..15,sort=random,limit=1] add ArrowTarget
    execute at @e[type=#lib:living,type=!player,tag=ArrowTarget,distance=..15,limit=1] run summon arrow ~ ~6 ~1 {pickup:0b,damage:7d,crit:1b,Motion:[0.0,-1.0,-0.3]}
...
# 4回目
    tag @e[type=#lib:living,type=!player,tag=!Uninterferable,distance=..15,sort=random,limit=1] add ArrowTarget
    execute at @e[type=#lib:living,type=!player,tag=ArrowTarget,distance=..15,limit=1] run summon arrow ~0.4 ~4 ~1.6 {pickup:0b,damage:7d,crit:1b,Motion:[-0.2,-1.0,-0.8]}
