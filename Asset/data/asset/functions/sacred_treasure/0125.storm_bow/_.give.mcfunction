#> asset:sacred_treasure/0125.storm_bow/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"ストームボウ","color":"blue","underlined":true}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"敵の上空から矢を降らせる"}']
