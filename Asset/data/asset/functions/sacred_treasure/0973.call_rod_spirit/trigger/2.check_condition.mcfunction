...
# 既に召喚済みなら使えない
    execute at @e[type=armor_stand,tag=R1.Sprit] if score @s UserID = @e[type=armor_stand,tag=R1.Sprit,sort=nearest,limit=1] R1.UserID at @s run function asset:sacred_treasure/0973.call_rod_spirit/trigger/2.check_condition/3.cannot_use
