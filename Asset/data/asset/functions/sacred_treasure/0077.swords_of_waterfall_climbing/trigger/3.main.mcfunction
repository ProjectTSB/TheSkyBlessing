...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0077.swords_of_waterfall_climbing/trigger/2.check_condition
...
# 攻撃当てた処理
    execute as @e[type=#lib:living,type=!player,tag=Victim,distance=..10] at @s run function asset:sacred_treasure/0077.swords_of_waterfall_climbing/trigger/3.2.attack
...
# 着地後にエフェクトを消す処理
    schedule function asset:sacred_treasure/0077.swords_of_waterfall_climbing/trigger/3.1.effectclear 1t replace