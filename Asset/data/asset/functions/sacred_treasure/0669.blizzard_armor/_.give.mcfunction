#> asset:sacred_treasure/0669.blizzard_armor/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 669
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_chestplate"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"ブリザードアーマー","color":"#C4FFFD"}'
# 神器の説明文 (TextComponentString[]) ['[{"text":"あ"},{"text":"io"}]']
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"物理耐性+5%","color":"dark_green"},{"text":" "},{"text":"水耐性+5%","color":"aqua"}]','[{"text":"一式装備時、吹雪を呼ぶ","color":"#C4FFFD"}]']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value [9]
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:12910589},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:7,Operation:0,UUID:[I;1,1,669,5],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,1,669,5],Slot:"chest"}]}
