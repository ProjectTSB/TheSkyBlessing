...
# 演出
    execute unless data storage asset:context id.all{head:711,chest:712,legs:713,feet:714} run function asset:sacred_treasure/0712.deep_sea_coral_raiment/trigger/4.vfx
