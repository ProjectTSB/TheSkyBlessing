#> asset:sacred_treasure/0712.deep_sea_coral_raiment/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0712.deep_sea_coral_raiment/give/1.trigger
...
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"深海珊瑚の羽衣","color":"#c3c9ff"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"暗き底の水圧により耐えていたとされる","color":"white"}]','[{"text":"自然から賜った神秘の珊瑚の羽衣","color":"white"}]','[{"text":"水耐性+10% 水攻撃+5% ","color":"aqua"}]','[{"text":"回復量+5% ","color":"light_purple"},{"text":"火耐性-10%","color":"dark_red"}]','[{"text":"全て装備した時、追加で","color":"white"},{"text":"水攻撃+5%","color":"aqua"},{"text":"を得て","color":"white"}]','[{"text":"水に触れていると特殊な効果を得る","color":"aqua"}]']
