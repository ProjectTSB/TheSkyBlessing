#> asset:sacred_treasure/0740.flower_of_hazy_moon/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0740.flower_of_hazy_moon/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 740
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"朧月の妖花","color":"#FFFFA3"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"微かに月光が射す時のみに咲く花","color":"gray","italic":"true"}]','[{"text":"見た者の心を惑わし、狂わせる。","color":"gray","italic":"true"}]','[{"text":"魔法攻撃+15% ","color":"dark_purple"},{"text":"被回復量-25%","color":"dark_red"}]']
