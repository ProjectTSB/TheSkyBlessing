#> asset:sacred_treasure/0297.spirit_world_trance/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0297.spirit_world_trance/trigger/2.check_condition
...
# 秒数カウント開始
    schedule function asset:sacred_treasure/0297.spirit_world_trance/trigger/3.1.trance 1t