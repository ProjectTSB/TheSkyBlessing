...
# 帰還処理（一人ずつ処理する）
    execute as @a[tag=89.Player,scores={89.TickCount=0}] run function asset:sacred_treasure/0297.spirit_world_trance/3.2.reset

# 再帰処理
    execute if entity @a[tag=89.Player,scores={89.TickCount=0..}] run schedule function asset:sacred_treasure/0297.spirit_world_trance/3.1.trance 1t
