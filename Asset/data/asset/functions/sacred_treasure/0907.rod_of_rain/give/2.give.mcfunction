...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"鮮やかに彩られた降雨を模した杖。","color":"aqua"}','{"text":"ひとたび振るえば辺りに祝福の雨を降らすという。","color":"aqua"}','{"text":"雨は癒やしもたらし、時には罪を洗い流す。","color":"aqua"}']
