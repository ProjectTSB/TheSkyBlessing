...
# ここから先は神器側の効果の処理を書く
    ...
    # 演出
        execute at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run particle flame ~ ~0.3 ~ 0.4 0.4 0.4 0 150 force @a
        execute if score @s Temporary matches 0 at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run particle dust 1 0.533 0 1 ~ ~0.3 ~ 0.4 0.4 0.4 0 100 force @a
        execute if score @s Temporary matches 1 at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run particle dust 1 0 0 1 ~ ~-.3 ~ 0.4 0.4 0.4 0 100 force @a
        execute if score @s Temporary matches 2 at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run particle dust 0.969 0 1 1 ~ ~0.3 ~ 0.4 0.4 0.4 0 100 force @a
        execute at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run playsound item.firecharge.use master @a ~ ~ ~ 10 1 1
        execute at @e[type=#lib:living,tag=Hit,distance=..100,limit=1] run playsound item.firecharge.use master @a ~ ~ ~ 10 1 1
    # だめーーじ
