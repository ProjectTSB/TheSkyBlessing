#> asset:sacred_treasure/0250.phoenix/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 攻撃に関する情報 (オプション)
    data modify storage asset:sacred_treasure AttackInfo set value {Damage:[50,60],AttackType:[Magic],ElementType:[Thunder],BypassResist:0b}
# MP消費量 (int)
