...
# 攻撃
    execute if entity @s[scores={SG.Combo=0}] anchored eyes positioned ^ ^ ^ run function asset:sacred_treasure/1024.brave_rod/trigger/combo/beam1
    execute if entity @s[scores={SG.Combo=1}] anchored eyes positioned ^ ^ ^ run function asset:sacred_treasure/1024.brave_rod/trigger/combo/beam1
    execute if entity @s[scores={SG.Combo=2}] run function asset:sacred_treasure/1024.brave_rod/trigger/combo/beam3
