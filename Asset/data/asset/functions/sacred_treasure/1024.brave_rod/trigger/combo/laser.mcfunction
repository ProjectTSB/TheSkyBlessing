...
# 再帰で前に飛ばす。ヒットしてたら移動停止
    execute if entity @s[tag=!SD.Hit,distance=..20] positioned ^ ^ ^1 if block ~ ~ ~ #lib:no_collision run function asset:sacred_treasure/1024.brave_rod/trigger/combo/laser
