#> asset:sacred_treasure/0010.attack_order/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0010.attack_order/1.trigger
...
# プレイヤーのゲームモードがサバイバル・クリエイティブの時にのみ使用可能
    ...
    execute if entity @s[tag=!CanUsed] run function lib:message/sacred_treasure/can_not_use_here
