...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"水耐性+5% ","color":"blue"},{"text":"雷耐性+5%","color":"gold"}]','{"text":"フルセット効果でMPを10消費する","color":"white"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:2454317},Unbreakable:1b,Enchantments:[{id:"thorns",lvl:5},{id:"protection",lvl:3}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;1,1,648,4],Slot:"head"}]}
