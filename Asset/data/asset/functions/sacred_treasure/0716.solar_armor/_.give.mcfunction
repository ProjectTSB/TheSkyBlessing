#> asset:sacred_treasure/0716.solar_armor/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 716
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"雷ダメージ量+7.5%","color":"yellow"}]','[{"text":"火耐性+5% ","color":"red"},{"text":"雷耐性+5%","color":"yellow"}]','{"text":"光を吸収し、電気へと変換できる防具","color":"#198CFF"}','{"text":"フルセット時に","color":"#198CFF"}','{"text":"近接攻撃時に明るさにより変動する雷ダメージを与え","color":"#198CFF"}','{"text":"明るければ移動速度上昇を得て、暗所で暗視を得る","color":"#198CFF"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value [8,14]
...
# 攻撃に関する情報 -攻撃範囲 (literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.AttackRange set value 3.5
# MP消費量 (int)
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:7,Operation:0,UUID:[I;1,1,716,5],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,1,716,5],Slot:"chest"}]}
