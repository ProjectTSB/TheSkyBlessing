#> asset:sacred_treasure/0716.solar_armor/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0716.solar_armor/2.check_condition
...
# 演出
    particle end_rod ~ ~1.3 ~ 0.4 0.3 0.4 0 20 normal @a
