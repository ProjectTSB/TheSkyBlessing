...
# ダメージ
    ...
    execute at @e[type=#lib:living,type=!player,tag=Victim,tag=!Uninterferable,distance=..6] as @e[type=#lib:living,type=!player,tag=!Uninterferable,distance=..3] run function lib:damage/
