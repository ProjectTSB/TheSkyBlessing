...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"魂炎を纏う者に代償を。","color":"aqua"}','{"text":"代償背負いし者へ力を。","color":"aqua"}','[{"text":"物理耐性+5% ","color":"dark_green"},{"text":"火耐性+10% 火攻撃+8% ","color":"red"}]','[{"text":"MP回復量+8% ","color":"green"},{"text":"最大体力-10% 魔法耐性-5%","color":"dark_red"}]']
