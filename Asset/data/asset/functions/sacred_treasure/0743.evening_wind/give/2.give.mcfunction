...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"黄昏の輝きを秘めた羽。","color":"gray","italic":"true"}]','[{"text":"淡い茜色の光を放っている。","color":"gray","italic":"true"}]','[{"text":"火攻撃+15% ","color":"red"},{"text":"移動速度+15%","color":"white"}]','[{"text":"水攻撃-25%","color":"dark_red"}]']
