...
# 演出
    execute rotated ~ 0 positioned ^ ^1.7 ^0.4 run function asset:sacred_treasure/0715.world_tree_crown/trigger/leaf_vfx
    execute rotated ~90 0 positioned ^ ^1.7 ^0.4 run function asset:sacred_treasure/0715.world_tree_crown/trigger/leaf_vfx
    execute rotated ~180 0 positioned ^ ^1.7 ^0.4 run function asset:sacred_treasure/0715.world_tree_crown/trigger/leaf_vfx
    execute rotated ~270 0 positioned ^ ^1.7 ^0.4 run function asset:sacred_treasure/0715.world_tree_crown/trigger/leaf_vfx
    execute positioned ~ ~1.7 ~ run function asset:sacred_treasure/0715.world_tree_crown/trigger/circle_vfx
