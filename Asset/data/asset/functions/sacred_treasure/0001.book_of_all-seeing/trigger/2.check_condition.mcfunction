...
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0001.book_of_all-seeing/trigger/1.trigger
...
# 他にアイテム等確認する場合はここに書く
    ...
    execute if entity @s[tag=CanUsed] unless entity @e[type=#lib:living,type=!player,tag=01.Target,distance=..30] run tellraw @s {"text":"敵を視界に捉えてか、敵が遠すぎます","color":"red"}
