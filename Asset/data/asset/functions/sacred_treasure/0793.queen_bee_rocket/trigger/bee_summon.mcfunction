...
# 弾を召喚
    summon vex ~ ~ ~ {NoAI:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:20054}}],Tags:["M1.First","M1.Bee","Projectile"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}]}
# 弾を前方拡散に向ける
