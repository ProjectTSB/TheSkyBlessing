...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"水耐性+5% 水攻撃+5%","color":"aqua"},{"text":" 雷耐性","color":"yellow"},{"text":"-5%","color":"dark_red"}]','[{"text":"MP回復量+4% ","color":"green"}]','{"text":"美しい渓流で取れた翡翠で作られた鎧","color":"#38B48B"}','{"text":"装着者は水の加護を得る","color":"#38B48B"}']
