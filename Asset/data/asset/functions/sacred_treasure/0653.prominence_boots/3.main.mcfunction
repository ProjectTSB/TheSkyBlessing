...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0653.prominence_boots/2.check_condition
...
# 演出
    ...
    particle lava ~ ~0.3 ~ 0.4 0.1 0.4 0 10 normal @a
    particle flame ~ ~0.3 ~ 0.4 0.1 0.4 0 10 normal @a
