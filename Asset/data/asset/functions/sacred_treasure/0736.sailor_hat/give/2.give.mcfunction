#> asset:sacred_treasure/0736.sailor_hat/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0736.sailor_hat/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 736
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_helmet"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"水兵の帽子","color":"#3DFFF2"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"どこからか潮の香りと紅茶の香りがする。","color":"#A3F9FF","italic":"true"}]','[{"text":"物理攻撃+7.5% ","color":"dark_green"},{"text":"水攻撃+7.5%","color":"aqua"}]','[{"text":"移動速度+7.5% ","color":"white"},{"text":"魔法攻撃-15%","color":"dark_red"}]']
