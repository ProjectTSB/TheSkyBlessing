#> asset:sacred_treasure/0735.defensive_attack_sword/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0735.defensive_attack_sword/2.check_condition
...
# 計算結果がKF.Armorに入るのでArgument.Damageに代入
