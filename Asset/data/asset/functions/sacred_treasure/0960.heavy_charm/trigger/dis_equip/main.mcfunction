...
# 補正を追加
    execute unless entity @s[tag=!DevPrivilege,predicate=!player_manager:is_believe/urban,predicate=!player_manager:is_believe/rumor] run function asset:sacred_treasure/0960.heavy_charm/trigger/add_modifier
