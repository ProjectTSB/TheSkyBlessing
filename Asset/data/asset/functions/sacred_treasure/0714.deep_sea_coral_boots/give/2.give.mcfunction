#> asset:sacred_treasure/0714.deep_sea_coral_boots/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0714.deep_sea_coral_boots/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 714
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_boots"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"深海珊瑚の靴","color":"#FFD1FF"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"かつて光無き深海の奥底の秘境にて自生し","color":"white","italic":"true"}]','{"text":"暗き底の水圧により耐えていたとされる","color":"white","italic":"true"}]','[{"text":"自然から賜った神秘の珊瑚の靴","color":"white","italic":"true"}]','[{"text":"水耐性+10% 水攻撃+5% ","color":"aqua"}]','[{"text":"体力回復量+5% ","color":"light_purple"},{"text":"火攻撃-10%","color":"dark_red"}]']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {HideFlags:68,display:{color:16765439},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;1,1,714,3],Slot:"feet"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2.5,Operation:0,UUID:[I;1,1,714,3],Slot:"feet"}]}
