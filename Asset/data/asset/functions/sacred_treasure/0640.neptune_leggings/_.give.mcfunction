...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"水ダメージ量+10％ ","color":"aqua"},{"text":"物理耐性+5％ ","color":"dark_green"},{"text":"魔法耐性+5％ ","color":"dark_purple"},{"text":"水耐性+10％ ","color":"aqua"}]','{"text":"嘗テ海ノ神ト呼バレシ者ノ袴","color":"dark_blue"}','{"text":"其ノ総テヲ身ニ纏イシ時嘗テノ姿ヲ現ス","color":"dark_blue"}']
