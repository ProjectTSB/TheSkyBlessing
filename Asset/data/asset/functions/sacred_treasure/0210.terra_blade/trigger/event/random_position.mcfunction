...
#declare tag SpreadMarker
    ...
    execute at @e[type=marker,tag=SpreadMarker,limit=1] run summon armor_stand ^-0.35 ^-0.25 ^ {Marker:1b,Invisible:1b,Tags:["ChuzTerraShotInit","Projectile","Uninterferable"]}
    execute at @e[tag=SpreadMarker] run particle end_rod