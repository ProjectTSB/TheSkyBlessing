...
# ビームが存在していれば、このfunctionをループさせるよ
    execute if entity @e[type=armor_stand,tag=ChuzTerraShot,limit=1] run schedule function asset:sacred_treasure/0210.terra_blade/3.1.terra_shot_tick 1t append