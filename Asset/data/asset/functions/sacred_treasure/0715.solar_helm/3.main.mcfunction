#> asset:sacred_treasure/0715.solar_helm/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0715.solar_helm/2.check_condition
...
# 演出
    particle end_rod ~ ~1.7 ~ 0.4 0.1 0.4 0 20 normal @a
