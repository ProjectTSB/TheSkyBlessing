#> asset:sacred_treasure/0718.solar_boots/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0718.solar_boots/2.check_condition
...
# 演出
    particle end_rod ~ ~0.3 ~ 0.4 0.1 0.4 0 20 normal @a
