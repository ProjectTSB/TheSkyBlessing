#> asset:sacred_treasure/1014.sharpened_golded_sword/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/1014.sharpened_golded_sword/trigger/2.check_condition
