#> asset:sacred_treasure/0260.heal_lv.1/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0260.heal_lv.1/2.check_condition
...
# 回復
    data modify storage lib: Argument.Heal set value 6.4f
