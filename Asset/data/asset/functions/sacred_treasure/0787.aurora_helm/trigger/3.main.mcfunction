...
# 演出
    execute unless data storage asset:context id.all{head:787,chest:788,legs:789,feet:790} rotated ~ 0 positioned ~ ~1.7 ~ run function asset:sacred_treasure/0787.aurora_helm/trigger/4.vfx
