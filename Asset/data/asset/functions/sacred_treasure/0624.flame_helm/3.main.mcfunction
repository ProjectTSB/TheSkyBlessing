#> asset:sacred_treasure/0624.flame_helm/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0624.flame_helm/2.check_condition
...
#ちょっとした演出
    particle flame ~ ~1.6 ~ 0.4 0.2 0.4 0 10 normal @s
