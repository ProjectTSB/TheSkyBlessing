#> asset:sacred_treasure/0188.reverse_transcription_magic/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0188.reverse_transcription_magic/trigger/2.check_condition
