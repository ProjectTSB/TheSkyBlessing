#> asset:sacred_treasure/0188.reverse_transcription_magic/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0188.reverse_transcription_magic/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 188
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '[{"text":"esrever ","color":"blue","obfuscated":true},{"text":"逆","color":"dark_aqua","obfuscated":false},{"text":"転","color":"aqua","obfuscated":false},{"text":"写","color":"dark_aqua","obfuscated":false},{"text":"魔","color":"aqua","obfuscated":false},{"text":"素","color":"dark_aqua","obfuscated":false},{"text":" reverse","color":"blue","obfuscated":true}]'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['[{"text":"オフハンドの神器の対価を自らの魔力にする"}]']
