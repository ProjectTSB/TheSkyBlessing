...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"暗き底の水圧により耐えていたとされる","color":"white"}]','[{"text":"自然から賜った神秘の珊瑚の袴","color":"white"}]','[{"text":"水耐性+10% 水攻撃+5% ","color":"aqua"}]','[{"text":"回復量+5% ","color":"light_purple"},{"text":"火耐性-10%","color":"dark_red"}]']
