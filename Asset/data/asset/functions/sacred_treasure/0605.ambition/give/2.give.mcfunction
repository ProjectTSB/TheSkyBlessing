#> asset:sacred_treasure/0605.ambition/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0605.ambition/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 605
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:iron_axe"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"下克上", "color":"dark_red"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"失ったものが多ければ多いほど","color":"white"}','[{"text":"強さ","color":"red"},{"text":"を増すと伝えられている斧","color":"white"}]','[{"text":"偉業","color":"yellow"},{"text":"を成し遂げ、失ったものを再び","color":"white"}]','[{"text":"手に入れた時、この力は弱まる","color":"white"}]']
