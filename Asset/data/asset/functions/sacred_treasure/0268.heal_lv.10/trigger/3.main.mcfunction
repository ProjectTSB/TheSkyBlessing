#> asset:sacred_treasure/0268.heal_lv.10/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0268.heal_lv.10/trigger/2.check_condition
...
# 回復
    data modify storage lib: Argument.Heal set value 20.6f
