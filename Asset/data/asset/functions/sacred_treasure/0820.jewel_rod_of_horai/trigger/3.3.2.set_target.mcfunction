#> asset:sacred_treasure/0820.jewel_rod_of_horai/trigger/3.3.2.set_target
#
# 神器の攻撃対象を決定する
# @output
...
execute positioned ^ ^ ^6.4 as @e[type=#lib:living,tag=!Friend,distance=..6.4] positioned as @s positioned ^ ^ ^1000 facing entity @p eyes positioned ^ ^ ^1000 positioned ~-0.1 ~-0.1 ~-0.1 if entity @s[dx=0.2,dy=0.2,dz=0.2] run tag @s add MS.TargetCandidate
