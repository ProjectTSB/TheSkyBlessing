#> asset:sacred_treasure/0820.jewel_rod_of_horai/trigger/3.3.5.attack_effect
#
...
#
# @within function asset:sacred_treasure/0820.jewel_rod_of_horai/trigger/3.3.4.attack_effect_loop
