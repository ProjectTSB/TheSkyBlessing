#> asset:sacred_treasure/0820.jewel_rod_of_horai/trigger/3.3.1.particle_2
#
# @within function
...
# 線 2
    ...
    particle electric_spark ^0 ^-0.77778 ^ 0 0 0 0 1
    particle electric_spark ^0 ^-0.55556 ^ 0 0 0 0 1
    particle electric_spark ^0 ^-0.33333 ^ 0 0 0 0 1
    particle electric_spark ^0 ^-0.11111 ^ 0 0 0 0 1
    particle electric_spark ^0 ^0.11111 ^ 0 0 0 0 1
    particle electric_spark ^0 ^0.33333 ^ 0 0 0 0 1
    particle electric_spark ^0 ^0.55556 ^ 0 0 0 0 1
    particle electric_spark ^0 ^0.77778 ^ 0 0 0 0 1
