#> asset:sacred_treasure/0334.abunai_kine/_.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 334
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"あぶないキネ","color":"#FFDD00"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"周囲のランダムな対象1体に、超強力な一撃を放つ。","color":"white"}','{"text":"敵と味方を区別しない。","color":"white"}']
