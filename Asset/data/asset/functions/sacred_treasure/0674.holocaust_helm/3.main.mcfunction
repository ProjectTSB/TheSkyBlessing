#> asset:sacred_treasure/0674.holocaust_helm/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0674.holocaust_helm/2.check_condition
...
# 演出
    particle explosion ~ ~1.7 ~ 0.4 0.1 0.4 0 2 normal @a
    particle cloud ~ ~1.7 ~ 0 0.1 0.1 0.1 20 normal @a
    particle smoke ~ ~1.7 ~ 0.4 0.1 0.4 0.1 20 normal @a
    particle dripping_dripstone_lava ~ ~1.7 ~ 0.4 0.1 0.4 0 20 normal @a
