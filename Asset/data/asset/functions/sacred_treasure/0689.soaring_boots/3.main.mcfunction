#> asset:sacred_treasure/0689.soaring_boots/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0689.soaring_boots/2.check_condition
...
# 演出
    particle cloud ~ ~0.3 ~ 0.4 0.1 0.4 0.05 10 normal @a
