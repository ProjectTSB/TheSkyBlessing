#> asset:sacred_treasure/0660.rainbow_helm/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0660.rainbow_helm/2.check_condition
...
# 演出
    ...
    particle dust 0.953 0.596 0.000 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
    particle dust 1.000 0.945 0.000 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
    particle dust 0.000 0.600 0.267 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
    particle dust 0.000 0.408 0.718 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
    particle dust 0.114 0.125 0.533 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
    particle dust 0.573 0.027 0.514 1 ~ ~1.75 ~ 0.4 0.2 0.4 0 4 normal
