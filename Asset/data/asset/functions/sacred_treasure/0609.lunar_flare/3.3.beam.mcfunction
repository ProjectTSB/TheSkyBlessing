...
# 攻撃する
    execute as @e[tag=GX.Laser] at @s positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=#lib:living,type=!player,tag=!Uninterferable,dx=0] positioned ~0.5 ~0.5 ~0.5 run function asset:sacred_treasure/0609.lunar_flare/3.4.hit
    execute as @e[tag=GX.Laser,scores={GX.BulletTime=16}] at @s run function asset:sacred_treasure/0609.lunar_flare/3.4.hit
