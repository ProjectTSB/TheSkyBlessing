...
# またファンクション分岐
    execute as @e[type=marker,tag=GX.LaserPos,scores={GX.BeamTime=1..}] at @s positioned ~ ~ ~ rotated ~ 90 run function asset:sacred_treasure/0609.lunar_flare/trigger/projectile/summon_laser
