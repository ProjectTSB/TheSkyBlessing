...
# 再帰
    execute unless entity @s[tag=GX.RecursiveEnd] positioned ^ ^ ^0.15 if entity @s[distance=..25] if block ~ ~ ~ #lib:no_collision run function asset:sacred_treasure/0609.lunar_flare/trigger/find_target_entity