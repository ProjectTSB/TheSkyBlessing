...
# パーティクル
    particle composter ~ ~ ~ 0 0 0 0 1 force @s[distance=19.7..20]
...
# 限界距離なら
    execute unless entity @s[tag=GX.RecursiveEnd] if entity @s[distance=19.7..20] run function asset:sacred_treasure/0609.lunar_flare/trigger/summon_laser_pos
