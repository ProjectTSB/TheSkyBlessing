#> asset:sacred_treasure/0290.carefully_collector/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:sacred_treasure/0290.carefully_collector/1.trigger
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:sacred_treasure/0290.carefully_collector/3.main