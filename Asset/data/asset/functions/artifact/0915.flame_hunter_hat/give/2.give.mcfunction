#> asset:artifact/0915.flame_hunter_hat/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0915.flame_hunter_hat/give/1.trigger
...
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"炎を追う狩人の帽子","color":"red"}'
