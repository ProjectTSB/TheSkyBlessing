...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0087.sheep_blessing/trigger/2.check_condition
...
# カウントダウン開始
    function asset:sacred_treasure/0087.sheep_blessing/trigger/count_down