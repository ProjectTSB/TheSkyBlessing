...
# 演出や効果時間の処理など
#
# @within function asset:sacred_treasure/0952.lunatic_rod/trigger/effect/loop
...
# リセット
    execute if entity @s[scores={QG.EffectTime=..0}] run function asset:sacred_treasure/0952.lunatic_rod/trigger/effect/reset
