...
# 神器のメイン処理部
#
# @within function asset:artifact/0788.aurora_armor/trigger/2.check_condition
...
# 演出
    execute unless data storage asset:context id.all{head:787,chest:788,legs:789,feet:790} rotated ~ 0 positioned ~ ~1.1 ~ run function asset:artifact/0788.aurora_armor/trigger/4.vfx
