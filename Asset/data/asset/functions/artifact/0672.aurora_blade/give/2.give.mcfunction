#> asset:sacred_treasure/0672.aurora_blade/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/0672.aurora_blade/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 672
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"オーロラブレード","color":"#00ffe2"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"オーロラの刃を持つ剣","color":"#00cedd"}','{"text":"天使に対して攻撃したとき、","color":"#00acf6"}','{"text":"ダメージが1.5倍になる","color":"#008bff"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:sacred_treasure AttackInfo.Damage set value [150,450]
...
# MP消費量 (int)
    data modify storage asset:sacred_treasure MPCost set value 11
# MP必要量 (int) (オプション)
