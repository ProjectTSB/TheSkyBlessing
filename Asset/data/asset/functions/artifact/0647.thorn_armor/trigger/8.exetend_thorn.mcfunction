...
# 再帰処理
    execute if entity @s[distance=..50] positioned ~-0.5 ~-0.5 ~-0.5 unless entity @e[type=#lib:living,tag=Attacker,dx=0] positioned ~0.5 ~0.5 ~0.5 positioned ^ ^ ^0.5 run function asset:sacred_treasure/0647.thorn_armor/trigger/8.exetend_thorn