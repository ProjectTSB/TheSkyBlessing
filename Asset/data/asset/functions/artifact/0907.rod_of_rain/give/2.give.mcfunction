#> asset:artifact/0907.rod_of_rain/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [1200]
