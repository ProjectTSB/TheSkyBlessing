#> asset:artifact/0978.fire_charm/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/0978.fire_charm/trigger/2.check_condition
...
# 補正を追加
    function asset:artifact/0978.fire_charm/trigger/add_modifier