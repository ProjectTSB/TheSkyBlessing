...
# 神器のメイン処理部
#
# @within function asset:artifact/0270.angel_ray_lv.10/trigger/2.check_condition
...
# レイ処理
    # 処理
        execute positioned ~ ~1.4 ~ as @e[type=area_effect_cloud,tag=Init,distance=..0.01] run function asset:artifact/0270.angel_ray_lv.10/trigger/ray
    # 次tick以降用にschedule予約
        schedule function asset:artifact/0270.angel_ray_lv.10/trigger/recursive 1t
# 効果処理
    execute positioned ~ ~1.4 ~ run function asset:artifact/0270.angel_ray_lv.10/trigger/effect/
# リセット
