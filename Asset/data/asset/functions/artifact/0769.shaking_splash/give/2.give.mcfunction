...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"使用時、炭酸弾を発射する。","color":"#7AF6FF"}','{"text":"スニークしながら使うと炭酸激流を発射する。","color":"#7AF6FF"}','{"text":"また、炭酸弾の着弾地点及び、","color":"#7AF6FF"}','{"text":"炭酸激流の通過地点周辺を消火する。","color":"#7AF6FF"}','{"text":"泡立つ蒼い液体が詰まった水鉄砲。","color":"#96DCFF"}','{"text":"中の液体は飲んでみると存外美味である。","color":"#96DCFF"}']
