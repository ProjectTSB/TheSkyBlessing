#> asset:artifact/0769.shaking_splash/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0769.shaking_splash/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 769
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"シェイキングスプラッシュ","color":"#00F7FF"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"使用時、炭酸弾を発射する。","color":"#00F7FF"}','{"text":"スニークしながら使うと炭酸激流を発射する。","color":"#00F7FF"}','{"text":"泡立つ蒼い液体が詰まった水鉄砲。","color":"#96DCFF"}','{"text":"中の液体は飲んでみると存外美味である。","color":"#96DCFF"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [450]
