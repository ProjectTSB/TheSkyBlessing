...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"泡立つ蒼い液体が詰まった水鉄砲。","color":"aqua"}','{"text":"中の液体は飲んでみると存外美味である。","color":"aqua"}','{"text":"使用時、炭酸弾を発射する。","color":"#00F7FF"}','{"text":"スニークしながら使うと炭酸激流を発射する。","color":"#00F7FF"}']
