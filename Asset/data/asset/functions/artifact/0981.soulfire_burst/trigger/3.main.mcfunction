...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0981.soulfire_burst/trigger/2.check_condition
...
# 火の玉にInit処理
    execute as @e[type=armor_stand,tag=R9.BigFireball,tag=R9.Init,distance=..3,sort=nearest,limit=1] run function asset:sacred_treasure/0981.soulfire_burst/trigger/big_fireball/1.init

# 火の玉を動かすShcheduleループ開始
    schedule function asset:sacred_treasure/0981.soulfire_burst/trigger/big_fireball/2.tick 1t
