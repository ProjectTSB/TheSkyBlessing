...
# 弾を召喚（敵がいる場合）
    execute anchored eyes positioned ^ ^ ^2 unless entity @e[type=#lib:living,tag=N9.Target,distance=..4,limit=1] positioned ^ ^ ^-2 run function asset:artifact/0837.the_world_knife/trigger/knife_summon_forward
