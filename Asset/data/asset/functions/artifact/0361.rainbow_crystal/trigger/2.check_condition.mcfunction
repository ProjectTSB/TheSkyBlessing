#> asset:artifact/0361.rainbow_crystal/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:artifact/0361.rainbow_crystal/trigger/3.main