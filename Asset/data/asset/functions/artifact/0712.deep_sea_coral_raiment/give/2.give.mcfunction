#> asset:artifact/0712.deep_sea_coral_raiment/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0712.deep_sea_coral_raiment/give/1.trigger
