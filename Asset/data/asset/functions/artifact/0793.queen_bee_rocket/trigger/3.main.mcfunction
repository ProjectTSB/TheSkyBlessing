...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0793.queen_bee_rocket/trigger/2.check_condition
...
# Scheduleループ
    schedule function asset:sacred_treasure/0793.queen_bee_rocket/trigger/schedule_loop 1t replace