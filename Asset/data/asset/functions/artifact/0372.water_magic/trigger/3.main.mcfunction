...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0372.water_magic/trigger/2.check_condition
...
# Scheduleセット
    schedule function asset:sacred_treasure/0372.water_magic/trigger/3.1.loop 1t replace