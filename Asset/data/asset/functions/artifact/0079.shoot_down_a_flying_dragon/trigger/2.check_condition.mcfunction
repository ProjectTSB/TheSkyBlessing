#> asset:sacred_treasure/0079.shoot_down_a_flying_dragon/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:sacred_treasure/0079.shoot_down_a_flying_dragon/trigger/3.main