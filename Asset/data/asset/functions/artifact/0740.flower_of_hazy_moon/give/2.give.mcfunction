...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"微かに月光が射す時のみに咲く花","color":"gray"}]','[{"text":"見た者の心を惑わし、狂わせる。","color":"gray"}]','[{"text":"魔法攻撃+15% ","color":"dark_purple"},{"text":"被回復量-25%","color":"dark_red"}]']
