#> asset:artifact/0771.milk_pack/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0771.milk_pack/give/1.trigger
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"おいしい牛乳"}]','[{"text":"何回かに分けて使える"}]']
