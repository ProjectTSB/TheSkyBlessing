#> asset:artifact/0731.mouse_feet/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0731.mouse_feet/give/1.trigger
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"被ダメージ時に3秒間移動速度上昇を得る","color":"gray"}','{"text":"臆病なネズミの足 叩かないで！","color":"gray"}']
