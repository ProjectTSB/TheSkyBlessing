...
# プレイヤーにエフェクトの付与
    execute as @a[distance=..4.5] unless score @s 7D.HolySymbol matches -2147483648..2147483647 run function asset:artifact/0265.holy_symbol_lv.5/trigger/effect/start
# 実行時間のインクリメント
