#> asset:spawner/331/register
#
# スポナーの定義データ
#
# @within function asset:spawner/331/


# 重複防止レジストリへの登録
    data modify storage asset:spawner DPR append value {D:overworld,X:-147,Y:147,Z:112}

# ID (int)
    data modify storage asset:spawner ID set value 331
