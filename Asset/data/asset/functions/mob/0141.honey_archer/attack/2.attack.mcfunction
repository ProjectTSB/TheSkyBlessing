#> asset:mob/0141.honey_archer/attack/2.attack
#
# Mobの攻撃時の処理
#
# @within function asset:mob/0141.honey_archer/attack/1.trigger
...
# デスログ
    data modify storage lib: Argument.DeathMessage set value ['{"translate": "%1$sは%2$sによってべとべとに射抜かれた","with":[{"selector":"@s"},{"nbt":"Return.AttackerName","storage":"lib:","interpret":true}]}','{"translate": "%2$sによって%1$sはハチの巣の材料にされた","with":[{"selector":"@s"},{"nbt":"Return.AttackerName","storage":"lib:","interpret":true}]}']
# 補正functionを実行
