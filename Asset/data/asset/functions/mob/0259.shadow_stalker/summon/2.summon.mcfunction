#> asset:mob/0259.shadow_stalker/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0259.shadow_stalker/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible","77.Dark"],Silent:1b,DeathLootTable:"asset:mob/death/0259.shadow_stalker"}
# ID (int)
