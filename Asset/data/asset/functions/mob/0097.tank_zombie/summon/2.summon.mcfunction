...
# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0097.tank_zombie"}
# ID (int)
...
# 防具
    ...
    # 胴 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Chest set value {id:"iron_helmet",Count:1b,tag:{Unbreakable:1b}}
    # 脚 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Legs set value {id:"iron_helmet",Count:1b,tag:{Unbreakable:1b}}
    # 足 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Feet set value {id:"iron_helmet",Count:1b,tag:{Unbreakable:1b}}
