...
# 体力300以下の時に1回だけ行う技
    execute if entity @s[tag=!6L.AlreadyElement] if score @s 6L.Health matches ..27000 run scoreboard players set $Random Temporary 10
...
# 技用Tagを付与
    ...
    execute if score $Random Temporary matches 10 run tag @s add 6L.ElementalKill
