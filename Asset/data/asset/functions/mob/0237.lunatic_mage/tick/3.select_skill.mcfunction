...
# ほしい範囲に剰余算
    ...
    execute if predicate api:global_vars/difficulty/min/hard run scoreboard players operation $Random Temporary %= $9 Const
...
# 技用Tagを付与
    ...
    execute if score $Random Temporary matches 8 run tag @s add 6L.Magic2
