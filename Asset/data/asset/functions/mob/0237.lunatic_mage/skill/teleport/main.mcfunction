...
# 実行座標を中心として-x方向に1、+x方向に1、-y方向に0.2、+y方向に0.8、-z方向に1、+z方向に1の立方体内のランダムな位置にmarkerを移動
    data modify storage lib: Argument.Bounds set value [[20d,20d],[0.0d,0.0d],[20d,20d]]
    execute at @r[distance=..40,sort=nearest,limit=1] run function lib:spread_entity/
