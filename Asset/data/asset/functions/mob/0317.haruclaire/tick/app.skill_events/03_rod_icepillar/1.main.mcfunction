...
# 杖振り演出
    ...
    execute if score @s 8T.AnimationTimer matches 10 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 18 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 26 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 34 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 42 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 50 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 58 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
    execute if score @s 8T.AnimationTimer matches 66 run playsound entity.player.attack.sweep hostile @a ~ ~ ~ 0.5 0.7
# 上昇
