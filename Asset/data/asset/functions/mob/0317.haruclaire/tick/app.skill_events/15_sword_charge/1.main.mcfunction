...
# 溜め中は耐性付与
    ...
    execute if score @s 8T.AnimationTimer matches 15..80 run effect give @s resistance 1 8 true
...
# 攻撃
    execute if score @s 8T.AnimationTimer matches 145 positioned ^ ^ ^2 rotated ~90 30 run function asset:mob/0317.haruclaire/tick/app.skill_events/15_sword_charge/4.1.attack_charge_slash
# 演出
    execute if score @s 8T.AnimationTimer matches 145 positioned ~ ~1.6 ~ rotated ~90 ~60 run function asset:mob/0317.haruclaire/tick/app.skill_events/15_sword_charge/5.4.effect_slash
...
# 終了
    execute if score @s 8T.AnimationTimer matches 157.. run function asset:mob/0317.haruclaire/tick/app.skill_events/15_sword_charge/2.end
