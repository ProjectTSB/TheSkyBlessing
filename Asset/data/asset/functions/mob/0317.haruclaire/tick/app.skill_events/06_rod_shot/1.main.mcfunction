...
# 移動
    execute if score @s 8T.AnimationTimer matches 1..5 if entity @p[distance=..8] at @s rotated ~ 0 run tp @s ^ ^ ^-1
    execute if score @s 8T.AnimationTimer matches 1..5 at @s rotated ~ 0 positioned ^ ^ ^-0.1 rotated as @s run tp @s ~ ~0.2 ~ ~ ~
    execute if score @s 8T.AnimationTimer matches 6..15 at @s rotated ~ 0 positioned ^ ^ ^-0.1 rotated as @s run tp @s ~ ~0.05 ~ ~ ~
    execute if score @s 8T.AnimationTimer matches 35..40 at @s run tp @s ~ ~0.1 ~ ~ ~
    execute if score @s 8T.AnimationTimer matches 41..55 at @s run tp @s ~ ~-0.15 ~ ~ ~
    execute if score @s 8T.AnimationTimer matches 56..65 at @s run tp @s ~ ~0.02 ~ ~ ~
# プレイヤーの方を向く
