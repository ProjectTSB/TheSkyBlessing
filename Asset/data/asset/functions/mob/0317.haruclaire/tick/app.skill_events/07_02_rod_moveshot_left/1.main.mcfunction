...
# 移動
    execute if score @s 8T.AnimationTimer matches 1..5 if entity @p[distance=..8] at @s rotated ~ 0 positioned ^ ^ ^-0.5 rotated ~ ~ run function asset:mob/0317.haruclaire/tick/app.general/2.teleport
    ...
    execute if score @s 8T.AnimationTimer matches 61..73 rotated ~ 0 positioned ^0.2 ^0.1 ^ rotated ~2 ~ run function asset:mob/0317.haruclaire/tick/app.general/2.teleport
    execute if score @s 8T.AnimationTimer matches 74..85 rotated ~ 0 positioned ^0.05 ^-0.05 ^ rotated ~ ~ run function asset:mob/0317.haruclaire/tick/app.general/2.teleport
    execute if score @s 8T.AnimationTimer matches 86..105 rotated ~ 0 positioned ^0.05 ^-0.05 ^ rotated ~ ~ run function asset:mob/0317.haruclaire/tick/app.general/2.teleport
# プレイヤーの方を向く
