...
# 再生
    execute as @e[type=item_display,tag=8T.ModelRoot,sort=nearest,limit=1] run function animated_java:haruclaire/animations/12_02_sword_slash_move_to_slash/play