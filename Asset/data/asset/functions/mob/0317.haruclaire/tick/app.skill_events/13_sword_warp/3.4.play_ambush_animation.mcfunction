...
# 再生
    execute as @e[type=item_display,tag=8T.ModelRoot,sort=nearest,limit=1] run function animated_java:haruclaire/animations/13_04_sword_warp_slash_finish/play