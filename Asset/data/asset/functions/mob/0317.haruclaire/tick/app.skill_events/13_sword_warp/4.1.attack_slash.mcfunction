#> asset:mob/0317.haruclaire/tick/app.skill_events/13_sword_warp/4.1.attack_slash
#
# アニメーションのイベントハンドラ 剣モード・ワープ斬りコンボ 斬撃攻撃判定
#
...
# 演出
    ...
    execute positioned ^ ^ ^1.5 positioned ~ ~1 ~ rotated ~90 -90 positioned ^ ^ ^0.5 run function asset:mob/0317.haruclaire/tick/app.skill_events/13_sword_warp/5.3.effect_slash_r
    execute positioned ^ ^ ^2.2 positioned ~ ~1 ~ rotated ~90 -90 positioned ^ ^ ^1 run function asset:mob/0317.haruclaire/tick/app.skill_events/13_sword_warp/5.3.effect_slash_r
