...
# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible","AntiDrown","AlwaysBurn"],Silent:1b,ActiveEffects:[{Id:12b,Amplifier:0b,Duration:2147483647}],DeathLootTable:"asset:mob/death/0092.red_rose"}
# ID (int)
