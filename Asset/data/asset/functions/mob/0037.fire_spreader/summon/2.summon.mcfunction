...
# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Silent:1b,ActiveEffects:[{Id:12b,Amplifier:0b,Duration:200000,ShowParticles:0b}],Tags:["MobInit","AlwaysInvisible","AntiFrozen"],DeathLootTable:"asset:mob/death/0037.fire_spreader",}
# ID (int)
...
# 特殊防御力 (double) (オプション) // 4pointにつきダメージを大きく減らす
    data modify storage asset:mob SpecialDefense set value 3
# 移動速度 (double) (オプション)
