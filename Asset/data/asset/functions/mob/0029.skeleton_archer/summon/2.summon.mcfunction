#> asset:mob/0029.skeleton_archer/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0029.skeleton_archer/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0029.skeleton_archer"}
# ID (int)
    data modify storage asset:mob ID set value 29
# Type (string) Wikiを参照
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 120.0
# 攻撃力 (double) (オプション)
