#> asset:mob/0059.none_fighter_bow/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0059.none_fighter_bow/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Silent:1b,Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0059.none_fighter_bow"}
# ID (int)
