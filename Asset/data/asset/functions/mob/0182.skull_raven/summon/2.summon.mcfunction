#> asset:mob/0182.skull_raven/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon wither_skeleton ~ ~ ~ {Tags:["MobInit","AntiFrozen"],NoGravity:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],DeathLootTable:"asset:mob/death/0182.skull_raven"}
# ID (int)
...
# 防具
    ...
    # 胴 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Chest set value {id:"elytra",Count:1b}
