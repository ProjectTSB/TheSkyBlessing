#> asset:mob/1006.green_star/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon vex ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/1006.green_star"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"翠の星","color":"green"}'
# 武器
