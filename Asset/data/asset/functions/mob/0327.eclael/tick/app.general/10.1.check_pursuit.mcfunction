...
# ハードのみ，追撃が当たる範囲にプレイヤーがいそうな場合，追撃を開始
    execute if predicate api:global_vars/difficulty/min/hard if entity @a[distance=..5] run function asset:mob/0327.eclael/tick/app.general/10.2.start_pursuit_animation
