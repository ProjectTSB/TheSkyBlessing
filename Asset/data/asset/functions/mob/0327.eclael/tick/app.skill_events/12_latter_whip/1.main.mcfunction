...
# animated javaアニメーション再生 (長さ：35tick)
    execute if score @s 93.AnimationTimer matches 1 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/3.0.play_backstep_animation
# プレイヤーの方を向く
...
# 移動
    execute if score @s 93.AnimationTimer matches 8 at @s positioned ^ ^1 ^-12 run tp @s ~ ~ ~ ~ ~
...
# animated javaアニメーション再生 (長さ：20tick)
    execute if score @s 93.AnimationTimer matches 35 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/3.1.play_move2right_animation
# 移動
...
## 左
# animated javaアニメーション再生 (長さ：20tick)
    execute if score @s 93.AnimationTimer matches 55 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/3.2.play_move2left_animation
# 移動
...
## 右
# animated javaアニメーション再生 (長さ：20tick)
    execute if score @s 93.AnimationTimer matches 75 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/3.1.play_move2right_animation
# 移動
...
## 左
# animated javaアニメーション再生 (長さ：20tick)
    execute if score @s 93.AnimationTimer matches 95 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/3.2.play_move2left_animation
# 移動
