#> asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.1.2.attack_1
#
...
# 対象に
    execute as @a[tag=!PlayerShouldInvulnerable,distance=..2.4] run function lib:damage/
# リセット
