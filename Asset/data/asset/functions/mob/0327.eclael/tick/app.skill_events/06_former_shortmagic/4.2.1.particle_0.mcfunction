#> asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.2.1.particle_0
#
...
# [ImportKey]: NobwRALgngDgpmAXGAxgSwE4oDYIDRgCuhaAJkmAIYBmALAEbUDsAzHALQBs1ATJe7VIBGAKzsAHJRGd2IoaXHURpavRHVKYAgDtKAWwTJAYYoACIVrAxKGfQGck4FAHtC2iEh4AGAijhu4GA5gAG6U2ISG4AAeSN5gULEAvokENqRohPaIQgB0PAS2ENbuiHFw2NhoMLaGQp5xGE5FEIZxaLYAohVVNR0AjoRh2FAAyla+5Iga2DXJALpAA_3
# 円 1
