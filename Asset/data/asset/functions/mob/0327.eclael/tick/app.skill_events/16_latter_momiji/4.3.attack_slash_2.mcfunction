...
# 演出
    ...
    execute positioned ~ ~1.5 ~ rotated ~-20 ~25 positioned ^ ^ ^1.5 run function asset:mob/0327.eclael/tick/app.skill_events/16_latter_momiji/5.1.particle_slash_0
    execute positioned ~ ~1 ~ rotated ~20 ~15 positioned ^ ^ ^1.5 run function asset:mob/0327.eclael/tick/app.skill_events/16_latter_momiji/5.1.particle_slash_0
