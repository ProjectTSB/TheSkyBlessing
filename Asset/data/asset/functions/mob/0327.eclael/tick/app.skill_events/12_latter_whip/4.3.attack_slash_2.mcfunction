#> asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/4.3.attack_slash_2
#
...
# 演出
    ...
    execute positioned ^ ^1 ^7 rotated ~70 ~60 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/5.2.particle_slash_0
    execute positioned ^ ^1 ^6 rotated ~90 ~60 run function asset:mob/0327.eclael/tick/app.skill_events/12_latter_whip/5.2.particle_slash_0
