#> asset:mob/0315.high_blaze/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0315.high_blaze/summon/1.trigger

# 元となるMobを召喚する
    summon blaze ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0315.high_blaze"}
# ID (int)
    data modify storage asset:mob ID set value 315
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"ハイ・ブレイズ","color":"#FF6F00","bold":false,"italic":false}'
# 武器
