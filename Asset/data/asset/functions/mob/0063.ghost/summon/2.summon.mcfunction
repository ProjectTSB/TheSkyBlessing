#> asset:mob/0063.ghost/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0063.ghost/summon/1.trigger

# 元となるMobを召喚する
    summon stray ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0063.ghost"}
# ID (int)
    data modify storage asset:mob ID set value 63
# Type (string) Wikiを参照
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:bedrock",Count:1b}
    # 胴 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Chest set value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:3881787}}}
