...
# ワープ
    ...
    execute at 0-0-0-0-0 if block ~ ~ ~ #asset:mob/0056.thunder_trifler/no_collision unless block ~ ~-1 ~ #asset:mob/0056.thunder_trifler/no_collision run tp @s 0-0-0-0-0
