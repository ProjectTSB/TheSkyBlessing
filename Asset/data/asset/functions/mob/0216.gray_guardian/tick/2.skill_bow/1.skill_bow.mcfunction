...
# プレイヤーを追尾
    execute if score @s 60.Tick matches 30.. facing entity @p[gamemode=!spectator,distance=..30] eyes positioned ^ ^ ^-100 rotated as @s positioned ^ ^ ^-500 facing entity @s feet positioned as @s positioned ^ ^ ^ run function asset:mob/0216.gray_guardian/tick/move/tereport
# 発射モデル
