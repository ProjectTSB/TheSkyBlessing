#> asset:mob/0077.golden_watermelon/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0077.golden_watermelon/summon/1.trigger

# 元となるMobを召喚する
    summon armor_stand ~ ~ ~ {Silent:1b,Marker:1b,NoGravity:1b,Invisible:1b,Tags:["MobInit"]}
# ID (int)
