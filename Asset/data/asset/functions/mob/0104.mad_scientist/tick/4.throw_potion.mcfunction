...
# ポーションにタグ付け
    execute if entity @s[tag=2W.Poison] run tag @e[tag=2X.This,sort=nearest,limit=1] add 2X.Poison
    execute if entity @s[tag=2W.Fire] run tag @e[tag=2X.This,sort=nearest,limit=1] add 2X.Fire
    execute if entity @s[tag=2W.Water] run tag @e[tag=2X.This,sort=nearest,limit=1] add 2X.Water
    execute if entity @s[tag=2W.Thunder] run tag @e[tag=2X.This,sort=nearest,limit=1] add 2X.Thunder
