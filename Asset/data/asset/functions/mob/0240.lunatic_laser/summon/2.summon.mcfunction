#> asset:mob/0240.lunatic_laser/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0240.lunatic_laser/summon/1.trigger

# 元となるMobを召喚する
    summon marker ~ ~ ~ {Tags:["MobInit"]}
# ID (int)
    data modify storage asset:mob ID set value 240
# Type (string) Wikiを参照
