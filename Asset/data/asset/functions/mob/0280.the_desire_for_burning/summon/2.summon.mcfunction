#> asset:mob/0280.the_desire_for_burning/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0280.the_desire_for_burning/summon/1.trigger

# 元となるMobを召喚する
    summon blaze ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0280.the_desire_for_burning"}
# ID (int)
    data modify storage asset:mob ID set value 280
# Type (string) Wikiを参照
