#> asset:mob/0149.giant_swinger/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0149.giant_swinger/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit","45.NoPair"],Silent:1b,DeathLootTable:"asset:mob/death/0149.giant_swinger"}
# ID (int)
    data modify storage asset:mob ID set value 149
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy.Boss"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"ジャイアントスインガー"}'
# 武器
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"barrier",Count:1b}
