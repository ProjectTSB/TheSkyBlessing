#> asset:mob/0264.dark_summoner/tick/event/prepare_magic
#
#
#
...
# SFX
    particle minecraft:witch ~ ~0.5 ~ 0.2 0.5 0.2 0 1
...
# 実行
    execute if score @s 7C.Attack matches 80.. run function asset:mob/0264.dark_summoner/tick/event/summon_minions