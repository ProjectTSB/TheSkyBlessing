...
# Killerがいた場合Killerとその周囲のFriendにデバフとダメージ
    ...
    execute as @e[gamemode=!creative,tag=Friend,distance=..5] run function lib:damage/
    effect give @e[type=!player,tag=Friend,distance=..5] blindness 10 1
    effect give @e[gamemode=!creative,tag=Friend,distance=..5] blindness 10 1
    effect give @e[type=!player,tag=Friend,distance=..5] slowness 10 3
    effect give @e[gamemode=!creative,tag=Friend,distance=..5] slowness 10 3
