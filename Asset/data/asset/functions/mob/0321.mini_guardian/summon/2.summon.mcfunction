#> asset:mob/0321.mini_guardian/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0321.mini_guardian/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Silent:1b,IsBaby:1b,NoAI:1b,Tags:["MobInit","AlwaysInvisible","AlwaysSlowFall"],DeathLootTable:"asset:mob/death/0321.mini_guardian"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"ミニガーディアン","color":"white","italic":false}'
# 武器
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:stick",Count:1b,tag:{CustomModelData:20333}}
