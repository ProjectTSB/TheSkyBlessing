...
# 演出
    execute positioned ^ ^0.5 ^ run particle splash ~ ~ ~ 0.4 0.4 0.4 0 200 normal @a
    execute positioned ^ ^0.5 ^ run playsound entity.player.splash.high_speed master @a ~ ~ ~ 0.6 1.5
