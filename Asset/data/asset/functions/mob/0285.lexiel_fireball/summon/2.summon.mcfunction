#> asset:mob/0285.lexiel_fireball/summon/2.summon
#
# Mobの召喚時の処理
#
...
# テレポート
    tp @e[type=endermite,tag=MobInit,distance=..0.01] ~ ~ ~ ~ ~

# MobInitタグ持ちを対象にして召喚関数呼び出し
    execute as @e[type=endermite,tag=MobInit,distance=..0.01] run function asset:mob/common/summon