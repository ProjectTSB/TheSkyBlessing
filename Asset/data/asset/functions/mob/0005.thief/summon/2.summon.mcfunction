#> asset:mob/0005.thief/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0005.thief/summon/1.trigger

# 元となるMobを召喚する
    summon vindicator ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0005.thief"}
# ID (int)
