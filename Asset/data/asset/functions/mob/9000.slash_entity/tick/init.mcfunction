#> asset:mob/9000.slash_entity/tick/init
#
...
# 向き
    execute facing entity @e[type=marker,tag=6Y0.FacingMarker,sort=nearest,limit=1] feet run tp @s ~ ~ ~ ~ ~

# マーカーキル
    kill @e[type=marker,tag=6Y0.FacingMarker,sort=nearest,limit=1]
