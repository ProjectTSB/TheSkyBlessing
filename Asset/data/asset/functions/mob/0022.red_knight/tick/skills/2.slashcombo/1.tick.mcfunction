...
# 前進
    execute if score @s M.Tick matches 10..20 if block ^ ^ ^1 #lib:no_collision run tp @s ^ ^ ^0.2 ~ ~
    execute if score @s M.Tick matches 21..30 if block ^ ^ ^1 #lib:no_collision run tp @s ^ ^ ^0.1 ~ ~
    execute if score @s M.Tick matches 31..35 if block ^ ^ ^1 #lib:no_collision run tp @s ^ ^ ^0.05 ~ ~
