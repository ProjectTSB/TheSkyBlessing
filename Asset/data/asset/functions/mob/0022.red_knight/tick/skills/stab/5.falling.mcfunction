#> asset:mob/0022.red_knight/tick/skills/stab/5.falling
#
# 落下中
#
...
# 演出
    ...
    execute rotated ~ 0 run particle flame ^ ^0.5 ^1.2 0 0 0 0.01 2
    execute rotated ~ 0 run particle flame ^ ^1 ^1.2 0 0 0 0.01 2