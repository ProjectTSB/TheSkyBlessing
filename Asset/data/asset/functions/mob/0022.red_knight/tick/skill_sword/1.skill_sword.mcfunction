...
# テレポート
    execute if score @s M.Tick matches 15 positioned ^ ^ ^4 run function asset:mob/0022.red_knight/tick/move/teleport
...
# テレポート
    execute if score @s M.Tick matches 20 positioned ^ ^ ^4 run function asset:mob/0022.red_knight/tick/move/teleport
