#> asset:mob/0022.red_knight/death/death_tick
#
#
#
# @within  function
...
# メイン処理ファンクション
    execute as @e[type=snowball,tag=M.DeathAnimation] at @s run function asset:mob/0022.red_knight/death/death_animation
