...
# アイスピラー用のパーティクル
    execute if entity @s[tag=3N.SkillIcePillar] if entity @e[type=area_effect_cloud,tag=3N.SkillPillarMaker] run schedule function asset:mob/0131.haruclaire/tick/particle_pillar 1t replace
