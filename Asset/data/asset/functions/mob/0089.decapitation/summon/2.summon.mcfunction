#> asset:mob/0089.decapitation/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0089.decapitation/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0089.decapitation"}
# ID (int)
