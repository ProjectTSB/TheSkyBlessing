#> asset:mob/0178.vindicator/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0178.vindicator/summon/1.trigger

# 元となるMobを召喚する
    summon vindicator ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0178.vindicator"}
# ID (int)
    data modify storage asset:mob ID set value 178
# Type (string) Wikiを参照
