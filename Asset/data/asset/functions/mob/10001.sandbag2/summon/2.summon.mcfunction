#> asset:mob/10001.sandbag2/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/10001.sandbag2/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/10001.sandbag2"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"雑魚サンドバッグ1"}'
# 武器
