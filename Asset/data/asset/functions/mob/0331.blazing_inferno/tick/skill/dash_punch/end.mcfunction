#> asset:mob/0331.blazing_inferno/tick/skill/dash_punch/end
#
#
#
...
# 攻撃判定と演出を目の前に出す
    execute anchored eyes positioned ^ ^-1 ^3 rotated 0 ~ run function asset:mob/0331.blazing_inferno/tick/skill/dash_punch/explosion