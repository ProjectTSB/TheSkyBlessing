#> asset:mob/10011.sandbag_angel2/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/10011.sandbag_angel2/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/10011.sandbag_angel2"}
# ID (int)
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 440
# 攻撃力 (double) (オプション)
