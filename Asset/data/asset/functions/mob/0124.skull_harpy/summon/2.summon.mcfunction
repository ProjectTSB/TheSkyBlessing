#> asset:mob/0124.skull_harpy/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit","AntiFrozen"],NoGravity:1b,ActiveEffects:[{Id:28b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],DeathLootTable:"asset:mob/death/0124.skull_harpy"}
# ID (int)
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 火倍率 (float) (オプション)
        data modify storage asset:mob Resist.Fire set value 0.80
    # 水倍率 (float) (オプション)
        data modify storage asset:mob Resist.Water set value 0.80
    # 雷倍率 (float) (オプション)
