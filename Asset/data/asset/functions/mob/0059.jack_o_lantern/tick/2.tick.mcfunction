...
# 演出
    ...
    execute if entity @a[gamemode=!creative,gamemode=!spectator,distance=3..15] if score @s 1N.Tick matches 60.. run function asset:mob/0059.jack_o_lantern/tick/8.tick_sound
