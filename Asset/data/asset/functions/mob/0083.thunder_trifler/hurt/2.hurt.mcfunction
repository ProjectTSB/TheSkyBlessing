...
# 武器が剣の場合弓に切替
   execute if entity @s[tag=2B.Sword] run item replace entity @s weapon.mainhand with bow{Enchantments:[{id:"punch",lvl:2s}]}

# 剣Tag削除
    execute if entity @s[tag=2B.Sword] run tag @s remove 2B.Sword
