#> asset:mob/1007.red_star/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/1007.red_star/summon/1.trigger

# 元となるMobを召喚する
    summon vex ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],LifeTicks:1,Silent:1b,DeathLootTable:"asset:mob/death/1007.red_star"}
# ID (int)
