#> asset:mob/0254.no_torso/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0254.no_torso/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0254.no_torso"}
# ID (int)
