...
# 数回に一回の行動は固定
    execute if score @s 8N.MoveCount matches 4.. run tag @s add 8N.Skill.Summon
    execute if score @s 8N.MoveCount matches 4.. run scoreboard players reset $Random Temporary
