...
# 攻撃
    ...
    # 召喚1
        execute if score @s 8N.Tick matches 10 rotated ~ 0 positioned ^ ^ ^5 run function asset:mob/0311.blazing_inferno/tick/skill/summon/summon_minion
    # 予備動作
    ...
    # 召喚2
        execute if score @s 8N.Tick matches 20 rotated ~ 0 positioned ^ ^ ^5 run function asset:mob/0311.blazing_inferno/tick/skill/summon/summon_minion
    # マッスルポーズ
