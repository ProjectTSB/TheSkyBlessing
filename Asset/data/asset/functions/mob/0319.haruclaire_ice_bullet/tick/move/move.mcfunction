#> asset:mob/0319.haruclaire_ice_bullet/tick/move
#
# Mobのtick時の処理
#
...
# 以下キル処理
    ...
    # 生存時間
        execute if entity @s[scores={8V.Range=..0}] positioned ~ ~0.9 ~ run function asset:mob/0319.haruclaire_ice_bullet/tick/move/kill