#> asset:mob/0158.sin/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0158.sin/summon/1.trigger

# 元となるMobを召喚する
    summon area_effect_cloud ~ ~ ~ {Tags:["MobInit"],Particle:"block air",Duration:20}
# ID (int)
    data modify storage asset:mob ID set value 158
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Object"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value false
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"罪"}'
# 武器
