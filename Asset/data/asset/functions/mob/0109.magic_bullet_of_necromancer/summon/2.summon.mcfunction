#> asset:mob/0109.magic_bullet_of_necromancer/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0109.magic_bullet_of_necromancer/summon/1.trigger

# 元となるMobを召喚する
    summon marker ~ ~ ~ {Tags:["MobInit"]}
# ID (int)
    data modify storage asset:mob ID set value 109
# Type (string) Wikiを参照
