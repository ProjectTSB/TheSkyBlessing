#> asset:mob/0053.executioners/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0053.executioners/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0053.executioners"}
# ID (int)
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:20045}}
