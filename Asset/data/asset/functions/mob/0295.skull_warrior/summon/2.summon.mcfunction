#> asset:mob/0295.skull_warrior/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0295.skull_warrior/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit","5P.Melee"],DeathLootTable:"asset:mob/death/0295.skull_warrior"}
# ID (int)
    data modify storage asset:mob ID set value 295
# Type (string) Wikiを参照
