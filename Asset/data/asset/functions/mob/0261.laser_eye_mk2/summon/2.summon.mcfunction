#> asset:mob/0261.laser_eye_mk2/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0261.laser_eye_mk2/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],Silent:1b,NoAI:1b,DeathLootTable:"asset:mob/death/0261.laser_eye_mk2"}
# ID (int)
