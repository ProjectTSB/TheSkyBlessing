...
# 召喚
    ...
    execute at @e[type=marker,tag=26.SkillThunderMarker,distance=..9,limit=1] run function api:mob/summon

# リセット
    data remove storage lib: Argument
    kill @e[type=marker,tag=26.SkillThunderMarker,distance=..9,limit=1]