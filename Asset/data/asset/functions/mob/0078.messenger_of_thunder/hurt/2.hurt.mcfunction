...
# 体力半分以下でTagを付与と武器を強化
    ...
    execute if entity @s[tag=!26.HalfHP] if score $Health Temporary matches ..12500 run item replace entity @s weapon.mainhand with bow{Enchantments:[{id:"punch",lvl:3s}]}
