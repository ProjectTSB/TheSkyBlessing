...
# バックステップ、フロントステップ
    ...
    execute facing entity @p[distance=..20] eyes rotated ~ 0 unless block ^ ^-1 ^3 #lib:no_collision if score @s 5Q.MoveTime matches 40.. run function asset:mob/0206.skull_knight/tick/event/step
