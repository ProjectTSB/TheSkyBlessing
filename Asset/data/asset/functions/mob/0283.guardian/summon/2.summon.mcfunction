#> asset:mob/0283.guardian/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0283.guardian/summon/1.trigger

# 元となるMobを召喚する
    summon guardian ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0283.guardian"}
# ID (int)
    data modify storage asset:mob ID set value 283
# Type (string) Wikiを参照
