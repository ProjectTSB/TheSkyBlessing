#> asset:mob/0031.tomb_robbing/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0031.tomb_robbing/summon/1.trigger

# 元となるMobを召喚する
    summon vindicator ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0031.tomb_robbing"}
# ID (int)
