#> asset:mob/0080.lightning/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0080.lightning/summon/1.trigger

# 元となるMobを召喚する
    summon marker ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0080.lightning"}
# ID (int)
