...
# 付近にプレイヤーがいるならスコア加算 Predicateなどが完成したらそれに移行したい
    execute if entity @p[distance=..20] run scoreboard players add @s 57.Attack 1

# 実行
    execute if score @s 57.Attack matches 40.. run function asset:mob/0187.flame_mage/event/shoot_magic
