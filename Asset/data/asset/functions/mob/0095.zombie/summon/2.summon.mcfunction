#> asset:mob/0095.zombie/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0095.zombie/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AntiDrown"],DeathLootTable:"asset:mob/death/0095.zombie"}
# ID (int)
    data modify storage asset:mob ID set value 95
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"ゾンビ","color":"#3b622f"}'
# 武器
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"leather_helmet",Count:1b,tag:{Unbreakable:1b}}
