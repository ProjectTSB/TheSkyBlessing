...
# 一定間隔毎にMP回復と魔法陣の表示
    ...
    execute if score $Temp Temporary matches 0 run function asset:mob/0214.water_magic/tick/03.damage_and_vfx
...
# 25tick目でkill
    execute if score @s 5Y.Tick matches 25.. run kill @s