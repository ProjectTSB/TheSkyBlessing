...
# 演出
    ...
    execute rotated ~90 ~ run particle scrape ^ ^0.2 ^2.25 0 0 0 0 1 normal @a
    execute rotated ~180 ~ run particle scrape ^ ^0.2 ^2.25 0 0 0 0 1 normal @a
    execute rotated ~270 ~ run particle scrape ^ ^0.2 ^2.25 0 0 0 0 1 normal @a
