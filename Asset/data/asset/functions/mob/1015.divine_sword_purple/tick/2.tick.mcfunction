...
# 刺さった後の動作
    execute if entity @s[tag=S7.Landed] run function asset:mob/1015.divine_sword_purple/tick/6.tick_landed

# トゥルの技の終わりに反応して消える
    execute if entity @s[tag=S7.Death] run function asset:mob/1015.divine_sword_purple/tick/7.death
