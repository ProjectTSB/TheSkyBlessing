...
# どっかいったアマスタを殺す
    execute as @e[type=armor_stand,tag=4V.ArmorStand] at @s unless entity @e[type=ravager,tag=4V.Angel,distance=0] run kill @s
# 見た目用のアマスタを召喚
...
# スコアも一応戻す
    scoreboard players set @s 4V.Tick 0
