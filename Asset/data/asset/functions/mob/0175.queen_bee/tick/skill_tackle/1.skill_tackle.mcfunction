...
# 一定時間後ずさり
    execute if score @s 4V.Tick matches 10..24 at @s positioned ^ ^ ^-0.4 run function asset:mob/0175.queen_bee/tick/move/teleport
...
# 突進2回目
# プレイヤーを見る
    execute if score @s 4V.Tick matches 41 at @s facing entity @p[gamemode=!spectator] eyes rotated ~180 ~ run function asset:mob/0175.queen_bee/tick/move/teleport
    execute if score @s 4V.Tick matches 41..58 at @s rotated ~10 ~ run function asset:mob/0175.queen_bee/tick/move/teleport
    execute if score @s 4V.Tick matches 58 at @s facing entity @p[gamemode=!spectator] eyes run function asset:mob/0175.queen_bee/tick/move/teleport
# 突進
...
# テレポする
    execute if score @s 4V.Tick matches 79 run function asset:mob/0175.queen_bee/tick/teleport
# リセット
    execute if score @s 4V.Tick matches 80.. run function asset:mob/0175.queen_bee/tick/reset
