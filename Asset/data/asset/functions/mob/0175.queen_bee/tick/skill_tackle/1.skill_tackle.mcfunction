...
# 突進2回目
# プレイヤーを見る
    execute if score @s 4V.Tick matches 50 at @s facing entity @p[gamemode=!spectator] eyes rotated ~180 ~ run function asset:mob/0175.queen_bee/tick/rotated
    execute if score @s 4V.Tick matches 50..68 at @s rotated ~10 ~ run function asset:mob/0175.queen_bee/tick/rotated
    execute if score @s 4V.Tick matches 68 at @s facing entity @p[gamemode=!spectator] eyes run function asset:mob/0175.queen_bee/tick/rotated
# 突進
    execute if score @s 4V.Tick matches 50..79 at @s run function asset:mob/0175.queen_bee/tick/skill_tackle/2.skill_tackle_tp
...
# 突進の加速
    execute if score @s 4V.Tick matches 68..79 at @s run function asset:mob/0175.queen_bee/tick/skill_tackle/2.skill_tackle_tp
