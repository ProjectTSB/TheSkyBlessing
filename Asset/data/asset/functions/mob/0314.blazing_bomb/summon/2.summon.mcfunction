...
# 元となるMobを召喚する
    summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Tags:["MobInit"],Passengers:[{id:"minecraft:item_display",width:0f,height:0f,billboard:"center",Tags:["Uninterferable","AutoKillWhenDieVehicle","AllowProcessingCommonTag"],brightness:{sky:15,block:15},item:{id:"minecraft:fire_charge",Count:1b}}]}
# ID (int)
