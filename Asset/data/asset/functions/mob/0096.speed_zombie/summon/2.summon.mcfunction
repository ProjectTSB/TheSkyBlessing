#> asset:mob/0096.speed_zombie/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"スピードゾンビ","color":"#3b622f"}'
# 武器
    # メインハンド (Compound(Item)) (オプション)
        data modify storage asset:mob Weapon.Mainhand set value {id:iron_sword,Count:1b,tag:{Enchantments:[{id:"knockback",lvl:2}]}}
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"leather_helmet",Count:1b,tag:{display:{color:6422506},Unbreakable:1b}}
