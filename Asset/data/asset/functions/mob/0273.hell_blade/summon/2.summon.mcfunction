#> asset:mob/0273.hell_blade/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:stick",Count:1b,tag:{CustomModelData:20160}}
...
# 移動速度 (double) (オプション)
    data modify storage asset:mob Speed set value 0.0
# 索敵範囲 (double) (オプション)
...
# MobInitタグ持ちを対象にしてinit処理を行う
    execute as @e[type=zombie,tag=MobInit,distance=..0.01] run function asset:mob/0273.hell_blade/summon/init
