#> asset:mob/0263.orange/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0263.orange/summon/1.trigger

# 元となるMobを召喚する
    summon item ~ ~ ~ {Age:5950s,PickupDelay:-1s,Tags:["MobInit"],Item:{id:"player_head",Count:1b,tag:{SkullOwner:{Id:[I;463153349,-1660531863,-1823714981,703784498],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjViMWRiNTQ3ZDFiNzk1NmQ0NTExYWNjYjE1MzNlMjE3NTZkN2NiYzM4ZWI2NDM1NWEyNjI2NDEyMjEyIn19fQ=="}]}}}}}
# ID (int)
    data modify storage asset:mob ID set value 263
# Type (string) Wikiを参照
...
# MobInitタグ持ちを対象にして召喚関数呼び出し
    execute as @e[type=item,tag=MobInit,distance=..0.01] run function asset:mob/common/summon