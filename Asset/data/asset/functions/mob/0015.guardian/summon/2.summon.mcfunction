...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    # 物理倍率 (float) (オプション)
        data modify storage asset:mob Resist.Physical set value 80
    # 魔法倍率 (float) (オプション)
        data modify storage asset:mob Resist.Magic set value 80
    # 火倍率 (float) (オプション)
        data modify storage asset:mob Resist.Fire set value 25
    # 水倍率 (float) (オプション)
        data modify storage asset:mob Resist.Water set value 80
    # 雷倍率 (float) (オプション)
        data modify storage asset:mob Resist.Thunder set value 100
