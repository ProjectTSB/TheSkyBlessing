...
# 雷を落とすAECを5個呼ぶ
    ...
    execute if score @s 3L.Tick matches 85 run function asset:mob/0129.lexiel/tick/2.15.skill_thunder_summon
# 攻撃
    execute if score @s 3L.Tick matches 104 as @e[type=area_effect_cloud,tag=3L.SkillThunderMaker,sort=random,limit=1] at @s run function asset:mob/0129.lexiel/tick/2.16.skill_thunder_damage
    execute if score @s 3L.Tick matches 106 as @e[type=area_effect_cloud,tag=3L.SkillThunderMaker,sort=random,limit=1] at @s run function asset:mob/0129.lexiel/tick/2.16.skill_thunder_damage
    execute if score @s 3L.Tick matches 108 as @e[type=area_effect_cloud,tag=3L.SkillThunderMaker,sort=random,limit=1] at @s run function asset:mob/0129.lexiel/tick/2.16.skill_thunder_damage
    execute if score @s 3L.Tick matches 110 as @e[type=area_effect_cloud,tag=3L.SkillThunderMaker,sort=random,limit=1] at @s run function asset:mob/0129.lexiel/tick/2.16.skill_thunder_damage
    execute if score @s 3L.Tick matches 112 as @e[type=area_effect_cloud,tag=3L.SkillThunderMaker,sort=random,limit=1] at @s run function asset:mob/0129.lexiel/tick/2.16.skill_thunder_damage
