...
# 元となるMobを召喚する
    summon wither_skeleton ~ ~ ~ {Tags:["MobInit","3L.Angel"],NoAI:1b,DeathLootTable:"asset:mob/death/0129.lexiel"}
# ID (int)
    data modify storage asset:mob ID set value 129
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "EnemyBoss"
# 干渉可能か否か (boolean)
...
# 見た目用のアマスタを召喚
    summon armor_stand ~ ~ ~ {Marker:1b,Tags:["3L.ArmorStand","3L.ArmorStandThis"]}
# 位置をあわせる
