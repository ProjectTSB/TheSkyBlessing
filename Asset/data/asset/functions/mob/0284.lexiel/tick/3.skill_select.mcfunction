...
# スキル選択
    ...
    execute if score $Random Temporary matches 1 run tag @s add 7W.SkillBow
    execute if score $Random Temporary matches 2 run tag @s add 7W.SkillAxe
    execute if score $Random Temporary matches 3 run tag @s add 7W.SkillImpact
