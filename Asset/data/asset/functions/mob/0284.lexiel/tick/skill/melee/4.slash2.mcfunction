#> asset:mob/0284.lexiel/tick/skill/melee/4.slash2
#
#
#
...
# 攻撃モーション
    item replace entity @e[type=armor_stand,tag=7W.ModelChangeTarget,tag=7W.ModelBody,distance=..0.5,sort=nearest,limit=1] weapon.mainhand with stick{CustomModelData:20297}
