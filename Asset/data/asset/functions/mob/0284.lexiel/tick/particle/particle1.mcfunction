#> asset:mob/0284.lexiel/tick/particle/particle1
#
#
#
...
particle scrape ^0.58779 ^ ^-0.80902 0 0 0 0 1
particle scrape ^0.80902 ^ ^-0.58779 0 0 0 0 1
particle scrape ^0.95106 ^ ^-0.30902 0 0 0 0 1
particle scrape ^1 ^ ^0 0 0 0 0 1
particle scrape ^0.95106 ^ ^0.30902 0 0 0 0 1
particle scrape ^0.80902 ^ ^0.58779 0 0 0 0 1
particle scrape ^0.58779 ^ ^0.80902 0 0 0 0 1
particle scrape ^0.30902 ^ ^0.95106 0 0 0 0 1
