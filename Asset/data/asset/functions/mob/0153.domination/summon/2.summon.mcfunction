#> asset:mob/0153.domination/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0153.domination/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],Silent:1b,DeathLootTable:"asset:mob/death/0153.domination"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"支配","color":"#614FFF","underlined":true}'
# 武器
