#> asset:mob/0150.contamination/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0150.contamination/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0150.contamination"}
# ID (int)
