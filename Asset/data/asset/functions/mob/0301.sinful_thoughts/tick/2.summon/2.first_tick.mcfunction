#> asset:mob/0301.sinful_thoughts/tick/2.summon/2.first_tick
#
#
#
# @within function asset:mob/0301.sinful_thoughts/tick/2.summon/1.summon
...
# 頭を変える
    data modify entity @e[type=armor_stand,tag=8D.ArmorStand,distance=..0.01,sort=nearest,limit=1] Pose.Head set value [0f,0f,0f]
