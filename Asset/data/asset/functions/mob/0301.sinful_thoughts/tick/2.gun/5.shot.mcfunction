#> asset:mob/0301.sinful_thoughts/tick/2.gun/5.shot
#
#
#
# @within function
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:mob/0301.sinful_thoughts/tick/2.gun/6.hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:mob/0301.sinful_thoughts/tick/2.gun/5.shot