...
# 弱化を付与
    execute at @p[tag=Victim] run effect give @a[gamemode=!creative,gamemode=!spectator,distance=..2.5] weakness 4 2 true

# 演出
    playsound minecraft:block.note_block.basedrum master @a ~ ~ ~ 2 1.7 0
