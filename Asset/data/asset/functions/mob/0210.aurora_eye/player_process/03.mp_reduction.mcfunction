...
# MPを4%減らす
    execute store result storage asset:temp MP4Per double -0.04 run function lib:mp/get_max
    execute store result score $Fluctuation Lib run data get storage asset:temp MP4Per 1.0
