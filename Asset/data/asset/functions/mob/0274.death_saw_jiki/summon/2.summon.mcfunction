#> asset:mob/0274.death_saw_jiki/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0274.death_saw_jiki/summon/1.trigger

# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],IsBaby:1b,NoAI:1b,Silent:1b,DeathLootTable:"asset:mob/death/0274.death_saw_jiki"}
# ID (int)
