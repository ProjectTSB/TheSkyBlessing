...
# ダメージ
    execute if score @s 7M.CoolTime matches ..0 if entity @e[type=#lib:living,tag=Friend,distance=..1] run function asset:mob/0274.death_saw_jiki/tick/3.damage