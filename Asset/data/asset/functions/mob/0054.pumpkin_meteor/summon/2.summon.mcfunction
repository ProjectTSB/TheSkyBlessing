#> asset:mob/0054.pumpkin_meteor/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],IsBaby:1b,DeathLootTable:"asset:mob/death/0054.pumpkin_meteor"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"かぼちゃめてお"}'
# 武器
