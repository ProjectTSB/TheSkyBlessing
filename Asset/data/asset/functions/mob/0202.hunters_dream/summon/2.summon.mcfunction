#> asset:mob/0202.hunters_dream/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0202.hunters_dream/summon/1.trigger
...
# スコアを与える
    scoreboard players set @e[type=skeleton,tag=MobInit,distance=..0.01] 5M.Tick -60
