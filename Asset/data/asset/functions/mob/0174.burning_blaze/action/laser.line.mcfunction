...
execute positioned ~-0.5 ~ ~-0.5 if entity @p[dx=1,dy=1] run playsound minecraft:block.note_block.bell hostile @p[gamemode=!creative,gamemode=!spectator,distance=..32] ~ ~ ~ 1 2 1
