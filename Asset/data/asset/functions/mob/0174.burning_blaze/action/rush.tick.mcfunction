...
execute positioned ^ ^ ^0.5 positioned ~-0.5 ~ ~-0.5 run tag @a[gamemode=!creative,gamemode=!spectator,dx=1,dz=1] add Hit
execute positioned ^ ^ ^0.5 run particle dripping_lava ~ ~0.5 ~ 0.2 0.2 0.2 0 10 normal
execute positioned ^ ^ ^1.0 positioned ~-0.5 ~ ~-0.5 run tag @a[gamemode=!creative,gamemode=!spectator,dx=1,dz=1] add Hit
