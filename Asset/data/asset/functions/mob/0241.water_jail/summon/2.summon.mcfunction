#> asset:mob/0241.water_jail/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0241.water_jail/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0241.water_jail"}
# ID (int)
