#> asset:mob/0185.tutankhamen/tick/magic_square/4.3rd_vfx
#
#
#
...
# 演出
    playsound entity.evoker.prepare_summon master @a ~ ~ ~ 0.6 1 0

# ダメージ
    execute if score @s 55.Tick matches 160 if entity @a[gamemode=!creative,gamemode=!spectator,distance=..4] run function asset:mob/0185.tutankhamen/tick/magic_square/9.3rd_damage
# 中円
