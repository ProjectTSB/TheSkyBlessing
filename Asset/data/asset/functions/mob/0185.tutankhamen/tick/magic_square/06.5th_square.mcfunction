...
# ダメージ
    execute if score @s 55.Tick matches 170 if entity @a[gamemode=!creative,gamemode=!spectator,distance=..8] run function asset:mob/0185.tutankhamen/tick/magic_square/11.5th_damage
