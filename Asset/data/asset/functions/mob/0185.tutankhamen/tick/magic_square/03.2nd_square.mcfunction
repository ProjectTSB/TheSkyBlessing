...
# ダメージ
    execute if entity @s[scores={55.Tick=45}] if entity @a[tag=!PlayerShouldInvulnerable,distance=..3] run function asset:mob/0185.tutankhamen/tick/magic_square/08.2nd_damage
# 最内三角
