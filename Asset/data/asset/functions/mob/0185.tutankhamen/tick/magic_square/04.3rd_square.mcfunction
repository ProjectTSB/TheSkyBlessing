...
# ダメージ
    execute if entity @s[scores={55.Tick=60}] if entity @a[gamemode=!creative,gamemode=!spectator,distance=..4] run function asset:mob/0185.tutankhamen/tick/magic_square/09.3rd_damage
# 中円
