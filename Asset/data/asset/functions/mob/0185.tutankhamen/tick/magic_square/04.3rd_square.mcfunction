...
# ダメージ
    execute if score @s 55.Tick matches 140 if entity @a[gamemode=!creative,gamemode=!spectator,distance=..4] run function asset:mob/0185.tutankhamen/tick/magic_square/09.3rd_damage
# 中円
