...
# ダメージ
    execute if score @s 55.Tick matches 155 if entity @a[gamemode=!creative,gamemode=!spectator,distance=..7] run function asset:mob/0185.tutankhamen/tick/magic_square/10.4th_damage
