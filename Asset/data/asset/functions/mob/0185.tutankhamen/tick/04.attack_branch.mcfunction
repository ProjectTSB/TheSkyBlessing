...
# 炎レーザー
    execute if entity @s[tag=55.BurnLazer] run function asset:mob/0185.tutankhamen/tick/burn_lazer/01.main
...
# ワープからの魔方陣展開
    execute if entity @s[tag=55.WarpAtack] run function asset:mob/0185.tutankhamen/tick/warp_attack/01.main