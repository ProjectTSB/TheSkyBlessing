...
# 交互に放つ
    execute if score @s 1J.Tick matches 30 anchored eyes positioned ^1 ^ ^ run function asset:mob/0055.hetukedah/tick/skill/otete_beam/shoot
    execute if score @s 1J.Tick matches 35 anchored eyes positioned ^-1 ^ ^ run function asset:mob/0055.hetukedah/tick/skill/otete_beam/shoot
