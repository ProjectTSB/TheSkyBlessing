#> asset:mob/0055.hetukedah/tick/skill/summon/call_26
#
#
#
...
# ID26番を呼び出す
    data modify storage api: Argument.ID set value 26
    function api:mob/summon

# こっちに向かせる
    execute as @e[type=zombie,scores={MobID=26},sort=nearest,limit=1] at @s facing entity @r[distance=..30] eyes run tp @s ~ ~ ~ ~ ~
