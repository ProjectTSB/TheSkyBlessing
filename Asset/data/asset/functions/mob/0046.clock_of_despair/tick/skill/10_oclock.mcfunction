...
# RE:RE: 歯車の恐怖
    ...
    execute if score @s 1A.LifeTime matches 2000 positioned ~ ~0.1 ~ run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/spread_summon/
    execute if score @s 1A.LifeTime matches 2030 positioned ~ ~0.1 ~ run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/spread_summon/
    execute if score @s 1A.LifeTime matches 2060 positioned ~ ~0.1 ~ run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/spread_summon/
