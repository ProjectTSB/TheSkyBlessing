#> asset:mob/0046.clock_of_despair/tick/skill/7_oclock/7_oclock
#
#
#
...
# 追尾弾召喚
    execute if score @s 1A.LifeTime matches 760 facing entity @a[sort=random,limit=1] eyes positioned ^ ^ ^2 run function asset:mob/0046.clock_of_despair/tick/skill/common/ball/ball_summon