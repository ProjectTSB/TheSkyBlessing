...
execute if score @s 1A.LifeTime matches 01 run item replace entity @s armor.head with stick{CustomModelData:20223}
...
execute if score @s 1A.LifeTime matches 30 run item replace entity @s armor.head with air

execute if score @s 1A.LifeTime matches 286..300 run tp @s ~ ~ ~ ~3.5 ~
execute if score @s 1A.LifeTime matches 286 run item replace entity @s armor.head with stick{CustomModelData:20223}
