#> asset:mob/0046.clock_of_despair/tick/skill/common/gear_gold/spread_summon/spread
#
#
#
# @within function asset:mob/0046.clock_of_despair/tick/skill/common/gear_gold/spread_summon/*
...
# 半径14m以内ではない 又は 他の歯車と重なっている場合再拡散する
    ...
    execute if score $Continuation Temporary matches 1 run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_gold/spread_summon/spread