...
execute if score @s 1A.LifeTime matches 01..06 run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/vfx/gear/3
execute if score @s 1A.LifeTime matches 07..12 run tp @s ~ ~ ~ ~3.5 ~
execute if score @s 1A.LifeTime matches 07..12 run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/vfx/gear/3
execute if score @s 1A.LifeTime matches 13..18 run tp @s ~ ~ ~ ~2.5 ~
execute if score @s 1A.LifeTime matches 13..18 run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/vfx/gear/2
...
execute if score @s 1A.LifeTime matches 126..140 run function asset:mob/0046.clock_of_despair/tick/skill/common/gear_silver/damage
