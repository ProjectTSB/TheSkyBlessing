#> asset:mob/10003.sandbag4/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/10003.sandbag4/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/10003.sandbag4"}
# ID (int)
