#> asset:mob/0186.ferocious_bee/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],NoAI:1b,Silent:1b,IsBaby:1b,DeathLootTable:"asset:mob/death/0186.ferocious_bee"}
# ID (int)
