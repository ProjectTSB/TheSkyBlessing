#> asset:mob/0232.honey_leader/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Silent:1b,Tags:["MobInit","AlwaysInvisible"],ActiveEffects:[{Id:24b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],DeathLootTable:"asset:mob/death/0232.honey_leader"}
# ID (int)
