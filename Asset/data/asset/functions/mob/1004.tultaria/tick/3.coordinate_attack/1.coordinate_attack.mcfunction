...
# ダメージの雷
    execute if score @s RW.Tick matches 24..28 at @e[tag=RW.CoordinateMarker,distance=..100] run function asset:mob/1004.tultaria/tick/3.coordinate_attack/4.thunder
