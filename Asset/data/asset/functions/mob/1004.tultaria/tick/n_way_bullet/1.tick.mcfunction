...
# 構える
    execute if score @s RW.Tick matches 15 run function asset:mob/1004.tultaria/tick/n_way_bullet/2.windup

# 放つ
    execute if score @s RW.Tick matches 25 run function asset:mob/1004.tultaria/tick/n_way_bullet/4.shoot

# 構える
    execute if score @s RW.Tick matches 30 run function asset:mob/1004.tultaria/tick/n_way_bullet/2.windup

# 放つ
    execute if score @s RW.Tick matches 40 run function asset:mob/1004.tultaria/tick/n_way_bullet/4.shoot
