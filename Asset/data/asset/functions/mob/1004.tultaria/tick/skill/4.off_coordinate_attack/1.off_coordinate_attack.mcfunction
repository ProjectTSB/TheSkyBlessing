#> asset:mob/1004.tultaria/tick/skill/4.off_coordinate_attack/1.off_coordinate_attack
#
#
#
...
# 最初に実行するの
    execute if score @s RW.Tick matches 0 run function asset:mob/1004.tultaria/tick/skill/4.off_coordinate_attack/2.first_tick
