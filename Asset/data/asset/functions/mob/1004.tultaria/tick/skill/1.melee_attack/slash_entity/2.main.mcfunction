#> asset:mob/1004.tultaria/tick/skill/1.melee_attack/slash_entity/2.main
#
#
#
# @within function asset:mob/1004.tultaria/tick/skill/1.melee_attack/slash_entity/1.tick
