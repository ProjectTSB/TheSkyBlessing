...
# 再帰
    ...
    execute if entity @s[tag=RW.ChainLightning4,distance=..60] unless entity @e[type=marker,tag=RW.ChainLightning5,distance=..0.5] positioned ^ ^ ^1 run function asset:mob/1004.tultaria/tick/skill/lightning_stab/chain_lightning/laser_prepare
    execute if entity @s[tag=RW.ChainLightning5,distance=..60] unless entity @e[type=marker,tag=RW.ChainLightning.Last,distance=..0.5] positioned ^ ^ ^1 run function asset:mob/1004.tultaria/tick/skill/lightning_stab/chain_lightning/laser_prepare
    execute if entity @s[tag=RW.ChainLightning.Last,distance=..60] unless entity @e[type=marker,tag=RW.ChainLightning1,distance=..0.5] positioned ^ ^ ^1 run function asset:mob/1004.tultaria/tick/skill/lightning_stab/chain_lightning/laser_prepare