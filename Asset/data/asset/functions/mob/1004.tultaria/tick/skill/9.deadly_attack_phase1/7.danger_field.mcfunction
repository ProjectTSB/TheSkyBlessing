...
# ダメージ設定
    # 与えるダメージ
        ...
        execute at @s as @a[tag=!PlayerShouldInvulnerable,distance=10..15] positioned ^ ^ ^5 rotated ~ 0 run function asset:mob/1004.tultaria/tick/skill/9.deadly_attack_phase1/8.player_pull
