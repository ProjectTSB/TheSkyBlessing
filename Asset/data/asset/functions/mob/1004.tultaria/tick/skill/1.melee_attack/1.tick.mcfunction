...
# リセット
    execute if score @s[scores={RW.Phase=1}] RW.Tick matches 60.. run function asset:mob/1004.tultaria/tick/base_move/reset
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 80.. run function asset:mob/1004.tultaria/tick/base_move/reset