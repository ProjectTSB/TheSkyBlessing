#> asset:mob/1004.tultaria/tick/skill/3.coordinate_attack/4.thunder
#
# 拡散する雷のparticleの準備
#
...
# マーカーにparticleを放つ
    execute at @e[type=marker,tag=RW.This,distance=..100] run function asset:mob/1004.tultaria/tick/skill/3.coordinate_attack/5.vfx
