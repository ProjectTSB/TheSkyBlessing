#> asset:mob/1004.tultaria/tick/skill/1.melee_attack/4.slash
#
#
#
...
# ポーズ
    execute positioned ~ ~0.29 ~ run data modify entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] Pose.LeftArm set value [30f,0f,-45f]
    execute positioned ~ ~0.29 ~ run data modify entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] Pose.RightArm set value [20f,0f,75f]

# モデル全体の向き
    execute at @s positioned ~ ~0.29 ~ run tp @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] ~ ~ ~ ~25 ~

# 体変える
    execute positioned ~ ~0.29 ~ run item replace entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] armor.head with stick{CustomModelData:20079}

# 腕を変える
    execute positioned ~ ~0.29 ~ run item replace entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] weapon.mainhand with stick{CustomModelData:20073}
    execute positioned ~ ~0.29 ~ run item replace entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] weapon.offhand with stick{CustomModelData:20069}

# 頭のモデル、向き
    execute positioned ~ ~0.29 ~ run data modify entity @e[type=armor_stand,tag=RW.ModelHead,distance=..0.01,sort=nearest,limit=1] Pose.Head set value [0.1f,0.1f,0.1f]
    execute positioned ~ ~0.29 ~ run item replace entity @e[type=armor_stand,tag=RW.ModelHead,distance=..0.01,sort=nearest,limit=1] armor.head with stick{CustomModelData:20086}
    execute positioned ~ ~0.29 ~ as @e[type=armor_stand,tag=RW.ModelHead,distance=..0.01,sort=nearest,limit=1] run tp @s ~ ~ ~ ~5 ~
