...
# 左
    execute if score @s[tag=RW.Skill.Mini.MoveShotLeft] RW.Tick matches 1..10 run tp @s ^1 ^ ^ ~ ~
    execute if score @s[tag=RW.Skill.Mini.MoveShotLeft] RW.Tick matches 13 run tp @s ^0.8 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotLeft] RW.Tick matches 12..15 run tp @s ^0.5 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotLeft] RW.Tick matches 15..18 run tp @s ^0.3 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotLeft] RW.Tick matches 18..22 run tp @s ^0.1 ^ ^
# 右
    execute if score @s[tag=RW.Skill.Mini.MoveShotRight] RW.Tick matches 1..10 run tp @s ^-1 ^ ^ ~ ~
    execute if score @s[tag=RW.Skill.Mini.MoveShotRight] RW.Tick matches 13 run tp @s ^-0.8 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotRight] RW.Tick matches 12..15 run tp @s ^-0.5 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotRight] RW.Tick matches 15..18 run tp @s ^-0.3 ^ ^
    execute if score @s[tag=RW.Skill.Mini.MoveShotRight] RW.Tick matches 18..22 run tp @s ^-0.1 ^ ^
