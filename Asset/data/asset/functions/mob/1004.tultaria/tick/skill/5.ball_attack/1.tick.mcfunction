...
# 弾を放つ。フェイズによって撃つ数が変わる
    ...
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ^ ^ ^10 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ^2 ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ^-2 ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ^2 ^ ^ run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ^-2 ^ ^ run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon

    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ^ ^ ^10 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ^2 ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ^-2 ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ^2 ^ ^ run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ^-2 ^ ^ run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/5.summon

    #execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 31
    #execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 31
...
# サウンド
    ...
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 30 positioned ~ ~1 ~ positioned ^ ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/6.sound
    execute if score @s[scores={RW.Phase=2..}] RW.Tick matches 35 positioned ~ ~1 ~ positioned ^ ^ ^2 run function asset:mob/1004.tultaria/tick/skill/5.ball_attack/6.sound
