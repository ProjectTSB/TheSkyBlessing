#> asset:mob/1004.tultaria/tick/2.meteor_attack/5.summon
#
#
#
# @within function
...
# スコア残ってるようなら再帰
    execute if score $AttackAmount Temporary matches 0.. run function asset:mob/1004.tultaria/tick/2.meteor_attack/5.summon
