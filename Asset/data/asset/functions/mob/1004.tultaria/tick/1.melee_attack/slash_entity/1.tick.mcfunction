#> asset:mob/1004.tultaria/tick/1.melee_attack/slash_entity/1.tick
#
#
#
# @within function
...
# エンティティに実行させる
    execute as @e[type=armor_stand,tag=RW.SlashSweep] at @s run function asset:mob/1004.tultaria/tick/1.melee_attack/slash_entity/2.main
