...
# 攻撃
   execute if score @s RW.Tick matches 15 run function asset:mob/1004.tultaria/tick/1.melee_attack/4.slash
...
# リセット
    execute if score @s[tag=!RW.HPless50per] RW.Tick matches 30 run function asset:mob/1004.tultaria/tick/reset
