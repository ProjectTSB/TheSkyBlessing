...
# 頭のモデル
    execute if entity @s[tag=!RW.InAction,scores={RW.FakeInertia=0}] run item replace entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] armor.head with stick{CustomModelData:20077}
