#> asset:mob/1004.tultaria/tick/move/teleport/move_to_ground/1.search_ground
#
# 地面を探す
#
...
# ブロックだったら移動終了する
    execute unless block ~ ~0.5 ~ #lib:no_collision run function asset:mob/1004.tultaria/tick/move/teleport/move_to_ground/2.detect_ground
