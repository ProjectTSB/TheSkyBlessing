...
# 腕を戻す
    ...
    data modify entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] Pose.RightArm set value [10f,0f,20f]
...
# アイテムも戻す
    ...
    item replace entity @e[type=armor_stand,tag=RW.ModelBody,distance=..0.01,sort=nearest,limit=1] weapon.offhand with stick{CustomModelData:20068}
