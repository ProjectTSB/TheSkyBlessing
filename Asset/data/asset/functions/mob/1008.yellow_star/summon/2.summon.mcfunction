#> asset:mob/1008.yellow_star/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/1008.yellow_star/summon/1.trigger

# 元となるMobを召喚する
    summon vex ~ ~ ~ {Tags:["MobInit","AlwaysInvisible"],LifeTicks:1,Silent:1b,DeathLootTable:"asset:mob/death/1008.yellow_star"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"黈の星","color":"yellow"}'
# 武器
