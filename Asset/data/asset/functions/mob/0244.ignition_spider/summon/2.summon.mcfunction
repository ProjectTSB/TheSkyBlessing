#> asset:mob/0244.ignition_spider/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0244.ignition_spider/summon/1.trigger

# 元となるMobを召喚する
    summon spider ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0244.ignition_spider"}
# ID (int)
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 32
# 攻撃力 (double) (オプション)
