...
# アイテムも戻す
    item replace entity @s weapon.mainhand with stick{CustomModelData:20144}
    item replace entity @s weapon.offhand with stick{CustomModelData:20143}
    item replace entity @s armor.head with stick{CustomModelData:20147}
